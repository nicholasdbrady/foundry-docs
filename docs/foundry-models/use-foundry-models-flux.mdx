...
For more details about model capabilities, see [Foundry Models sold by Azure](/foundry-models/models-sold-directly-by-azure).
...
- [Models sold by Azure](/foundry-models/models-sold-directly-by-azure)
