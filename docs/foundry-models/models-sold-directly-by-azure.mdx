...
This article lists a selection of Foundry Models sold by Azure, along with their capabilities, [deployment types](/foundry-models/deployment-types), and regions of availability, excluding deprecated and retired models. Foundry Models sold by Azure are also referred to as *Direct from Azure Models* or *Azure Direct Models*. 
...
- To see **region availability for Azure OpenAI in Microsoft Foundry models grouped by deployment category**, see [Region availability for Foundry Models sold by Azure](/foundry-models/models-sold-directly-by-azure-region-availability). 
...
For model availability across all regions, grouped by deployment category, see [Region availability for Foundry Models sold by Azure](/foundry-models/models-sold-directly-by-azure-region-availability).
...
| Model  | Type | Capabilities | Deployment type (region availability) |
| ------ | ---- | ------------ | ------------------------------------- |
| `DeepSeek-V4-Pro` <br /> **Preview** | chat-completion <br /> [(with reasoning content)](/foundry-models/use-chat-reasoning) | - **Input:** text (1,000,000 tokens) <br /> - **Output:** text (384,000 tokens) <br /> - **Languages:** `en` and `zh` <br />  - **Tool calling:** No <br /> - **Response formats:** Text, JSON | - Global standard (all regions) |
