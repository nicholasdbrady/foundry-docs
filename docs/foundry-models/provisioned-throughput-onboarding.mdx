...
Microsoft Foundry [Regional Provisioned Throughput](/foundry-models/deployment-types#regional-provisioned), [Data Zone Provisioned Throughput](/foundry-models/deployment-types#data-zone-provisioned), and [Global Provisioned Throughput](/foundry-models/deployment-types#global-provisioned) are billed hourly based on the number of deployed PTUs, with substantial term discount available via the purchase of Azure reservations.  
...
Quota for provisioned deployments shows up in Foundry as the following deployment types: [global provisioned](/foundry-models/deployment-types#global-provisioned), [data zone provisioned](/foundry-models/deployment-types#data-zone-provisioned) and [regional provisioned](/foundry-models/deployment-types#regional-provisioned).
...
|---------|---------|
|[Regional Provisioned](/foundry-models/deployment-types#regional-provisioned)     |  Regional Provisioned Throughput Unit       |
|[Global Provisioned](/foundry-models/deployment-types#global-provisioned)     | Global Provisioned Throughput Unit        |
|[Data zone Provisioned](/foundry-models/deployment-types#data-zone-provisioned)    | Data Zone Provisioned Throughput Unit        |
...
- [Provisioned Throughput Units (PTU) concepts](/foundry-models/provisioned-throughput)
