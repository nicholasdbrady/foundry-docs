...
* [Foundry Provisioned Throughput Onboarding Guide](/foundry-models/provisioned-throughput-onboarding)
* [Foundry Provisioned Throughput Concepts](/foundry-models/provisioned-throughput) 
...
* [Foundry provisioned throughput onboarding guide](/foundry-models/provisioned-throughput-onboarding) 
* [Guide for Foundry provisioned throughput reservations](/foundry-models/provisioned-throughput) 
...
The inferencing code for provisioned deployments is the same as a standard deployment type. The following code snippet shows a chat completions call to a GPT-4 model. For your first time using these models programmatically, we recommend starting with our [quickstart guide](/foundry-models/responses). Our recommendation is to use the OpenAI library with version 1.0 or greater since this includes retry logic within the library.
...
* For more information on provisioned deployments, check out [What is provisioned throughput?](/foundry-models/provisioned-throughput)
