...
For information on the model upgrade process, see [How to upgrade to a new model or version](https://learn.microsoft.com/en-us/azure/foundry-classic/openai/concepts/model-versions).

For more information on how to manage model upgrades and migrations for provisioned deployments, see [Managing models on provisioned deployment types](/foundry-models/working-with-models#managing-models-on-provisioned-deployment-types).
...
For a list of retired models, refer to the [retired models page](/foundry-models/legacy-models).
