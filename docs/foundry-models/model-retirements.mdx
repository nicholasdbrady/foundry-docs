...
- The upgrade schedule is published in advance in the [Model Retirement Schedule](/foundry-models/model-retirement-schedule).
...
- [Model retirement schedule](/foundry-models/model-retirement-schedule) for specific dates for all current, deprecated, and retired models
