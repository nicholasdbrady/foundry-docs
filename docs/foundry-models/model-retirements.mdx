...
- **Foundry Models (catalog)**: Some model providers define a shorter GA lifecycle—for example, 12 months instead of 18. When a shorter lifecycle applies, it is noted directly on the model in the [Model Retirement Schedule](/foundry-models/model-retirement-schedule).
...
For a full comparison of deployment types, see [Deployment type comparison](/foundry-models/deployment-types).
...
- The upgrade schedule is published in advance in the [Model Retirement Schedule](/foundry-models/model-retirements).
...
- [Model Retirement Schedule](/foundry-models/model-retirements) for specific dates for all current, deprecated, and retired models
...
- [Model versions in Microsoft Foundry Models](/foundry-models/model-versions) for how version upgrades work
