...
- [Foundry Models from partners and community](/foundry-models/models-from-partners) require access to **Azure Marketplace** to create subscriptions. Ensure you have the [permissions required to subscribe to model offerings](configure-marketplace). [Foundry Models sold directly by Azure](/foundry-models/models-sold-directly-by-azure) don't have this requirement.
