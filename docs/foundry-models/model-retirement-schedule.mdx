...
This article lists the retirement schedule for Foundry Models — their current lifecycle stage, retirement date, and suggested replacement. Use it to plan migrations before a model is deprecated or retired. For details on what each lifecycle stage means and how notifications work, see [Microsoft Foundry Models lifecycle and support policy](/foundry-models/model-retirements).
...
- [Microsoft Foundry Models lifecycle and support policy](/foundry-models/model-retirements)
