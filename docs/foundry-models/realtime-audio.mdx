...
- [Realtime API via WebRTC](/foundry-models/realtime-audio-webrtc)
- [Realtime API via SIP](/foundry-models/realtime-audio-sip)
- [Realtime API via WebSockets](/foundry-models/realtime-audio-websockets)
...
- For steps to deploy and use a GPT realtime model, see [the real-time audio quickstart](/foundry-models/realtime-audio#quickstart).
- Try the [WebRTC via HTML and JavaScript example](/foundry-models/realtime-audio-webrtc#step-3-optional-create-a-websocket-observercontroller) to get started with the Realtime API via WebRTC.
...
The Realtime API has specific rate limits for audio tokens and concurrent sessions. Before deploying to production, review [Azure OpenAI quotas and limits](/foundry-models/quotas-limits) for your deployment type.
...
| 429 Too Many Requests | Rate limit exceeded | Implement exponential backoff retry logic. Check your [quota and limits](/foundry-models/quotas-limits). |
...
For more information about quotas, see [Azure OpenAI quotas and limits](/foundry-models/quotas-limits).
