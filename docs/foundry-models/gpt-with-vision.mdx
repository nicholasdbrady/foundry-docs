...
---
Vision-enabled chat models are large multimodal models (LMM) developed by OpenAI that can analyze images and provide textual responses to questions about them. They incorporate both natural language processing and visual understanding. The current vision-enabled models are the [o-series reasoning models](/foundry-models/reasoning), GPT-5 series, GPT-4.1 series, GPT-4.5, GPT-4o series.
...
- An Azure OpenAI in Microsoft Foundry Models resource with a vision-enabled model deployed. See [Model availability](/foundry-models/models-sold-directly-by-azure) for available regions. For more information about resource creation, see the [resource deployment guide](https://learn.microsoft.com/azure/ai-foundry/openai/how-to/create-resource).
...
<Tip>
You can also use a base 64 encoded image data instead of a URL. For more information, see the [Vision chats how-to guide](/foundry-models/gpt-with-vision#use-a-local-image).
</Tip>
...
- An Azure subscription. [Create one for free](https://azure.microsoft.com/pricing/purchase-options/azure-account?cid=msft_learn).
- <a href="https://www.python.org/" target="_blank">Python 3.8 or later version</a>.
- An Azure OpenAI in Microsoft Foundry Models resource with a vision-enabled chat model deployed. See [Model availability](/foundry-models/models-sold-directly-by-azure) for available regions. For more information about resource creation, see the [resource deployment guide](https://learn.microsoft.com/azure/ai-foundry/openai/how-to/create-resource).
...
For details on how the image parameters impact tokens used and pricing please see - [What is Azure OpenAI? Image Tokens](/foundry-models/models-sold-directly-by-azure)
