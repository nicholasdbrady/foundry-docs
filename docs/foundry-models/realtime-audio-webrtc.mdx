...
You can access the GPT real-time models for global deployments in the [East US 2 and Sweden Central regions](/foundry-models/models-sold-directly-by-azure-region-availability).
...
For the complete list of Realtime API events, see the [API reference](/api-sdk/realtime-audio-reference).
