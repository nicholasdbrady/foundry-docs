...
For more information about creating deployments, see [Add and configure model deployments](/foundry-models/create-model-deployments).
...
For more information about how to use the **Azure OpenAI endpoint**, see [Azure OpenAI in Foundry Models documentation](/foundry-models/models-sold-directly-by-azure).
...
- [Foundry Models and capabilities](/foundry-models/models-sold-directly-by-azure)
...
- [What is Azure OpenAI in Foundry Models?](/foundry-models/models-sold-directly-by-azure)
