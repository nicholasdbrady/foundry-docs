...
sidebarTitle: "How to use batch synthesis for text to speech avatar - Speech service"
---
...
<Frame>
  <img src="/images/batch-synthesis-workflow.png" alt="Screenshot that shows a high-level overview of the batch synthesis workflow." />
</Frame>
...
* [Use batch synthesis for text to speech avatar](/foundry-models/batch-synthesis-avatar)
