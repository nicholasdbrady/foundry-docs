...
To deploy an MAI image model, follow the instructions in [Deploy Microsoft Foundry Models in the Foundry portal](/foundry-models/deploy-foundry-models).
...
For more details about the model capabilities, see capabilities of Microsoft models in [Foundry Models sold by Azure](/foundry-models/models-sold-directly-by-azure).
