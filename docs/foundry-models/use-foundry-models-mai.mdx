...
- A [Microsoft Foundry project](/setup/create-projects). MAI-Image-2 is available for **global standard deployment** (West Central US, East US, West US, West Europe, Sweden Central, and South India).
