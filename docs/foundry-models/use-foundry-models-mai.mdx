...
- A [Microsoft Foundry project](/setup/create-projects). MAI-Image-2 is available for **global standard deployment in all regions**.
...
MAI-Image-2 is available for [global standard deployment](/foundry-models/deployment-types#global-standard) in all regions. To deploy the model, follow the instructions in [Deploy Microsoft Foundry Models in the Foundry portal](/foundry-models/deploy-foundry-models).
