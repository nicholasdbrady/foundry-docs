...
Sora 2 uses the Azure OpenAI [v1 API](/api-sdk/api-version-lifecycle), aligning with OpenAI's native Sora 2 schema.

| Aspect | **Sora 2** |
|--------|------------|
| **Model type** | Adapts OpenAI's latest Sora 2 API using [v1 API](/api-sdk/api-version-lifecycle)|
...
- [Image generation quickstart](/foundry-models/dall-e)
