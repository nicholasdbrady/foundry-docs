...
Not all models support all deployment types. Check [Foundry Models sold directly by Azure](/foundry-models/models-sold-directly-by-azure) for model availability by deployment type and region.
...
Learn more in the "Model region availability by deployment type" section of [Foundry Models sold directly by Azure](/foundry-models/models-sold-directly-by-azure).
