...
The following upgrade guidance only applies to Standard deployment types. For guidance on updating or migrating provisioned deployment types, review the [model management documentation](/foundry-models/working-with-models).
...
* Read [what's new](https://learn.microsoft.com/en-us/azure/foundry-classic/openai/whats-new) and [models](/foundry-models/models-sold-directly-by-azure) to understand the changes and new features.
* Read the documentation on [Deploy Foundry Models](/foundry-models/deploy-foundry-models) and [version upgrades](/foundry-models/working-with-models) to understand how to work with model versions.
...
Azure notifies you of upcoming retirements through email to subscription owners and contributors, Azure Service Health alerts, and the upcoming retirement tables in [Model deprecation and retirement for Microsoft Foundry Models](/foundry-models/model-lifecycle-retirement).
...
- [Deploy Foundry Models](/foundry-models/deploy-foundry-models)
