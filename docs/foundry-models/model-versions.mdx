...
* Read [what's new](../../../foundry-classic/openai/whats-new.md) and [models](/foundry-models/models-sold-directly-by-azure) to understand the changes and new features.
