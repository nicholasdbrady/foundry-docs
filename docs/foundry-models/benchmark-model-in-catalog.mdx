...
---
This article shows you how to streamline model selection in the Foundry [model catalog](https://learn.microsoft.com/en-us/azure/foundry-classic/concepts/foundry-models-overview) by using the model leaderboards (preview) and side-by-side comparison features in Foundry portal. Evaluate model benchmark scores across quality, safety, cost, and throughput to choose the best model for your scenario.
...
1. Select **Discover** from the top navigation bar to browse the [model catalog](https://learn.microsoft.com/en-us/azure/foundry-classic/concepts/foundry-models-overview). The overview page shows a snapshot of the model leaderboard at the top.

1. Sort on different metrics — [quality](/foundry-models/model-benchmarks#quality-benchmarks-of-language-models), [safety](/foundry-models/model-benchmarks#safety-benchmarks-of-language-models), [estimated cost](/foundry-models/model-benchmarks#cost-benchmarks-of-language-models), and [throughput](/foundry-models/model-benchmarks#performance-benchmarks-of-language-models) — to view the top models for each criterion. Select any model to go to its detail page, or select **Go to leaderboard** to view the full list. The model detail page shows the model's overview, benchmarks, and deployment options.
...
- [Model leaderboards in Foundry portal](/foundry-models/model-benchmarks) - Learn about the benchmarks, datasets, and metrics behind the leaderboard scores.
