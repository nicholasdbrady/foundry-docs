...
Submit the [quota increase request form](https://aka.ms/oai/stuquotarequest) to request quota increases for [Foundry Models sold by Azure](/foundry-models/models-sold-directly-by-azure), Azure OpenAI models, and Anthropic models. Except for Anthropic models, [Models from partners and community](/foundry-models/models-from-partners) don't support quota increases.
...
| **API reference** | [Usages - List](https://learn.microsoft.com/rest/api/aiservices/accountmanagement/usages/list) | [Model Capacities - List](https://learn.microsoft.com/rest/api/aiservices/accountmanagement/model-capacities/list) |
...
Both APIs return information for all models associated with your subscription, including [retired models](/foundry-models/model-retirements) that are no longer available for new deployments.
