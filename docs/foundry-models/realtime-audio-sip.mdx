...
The GPT real-time models are available for global deployments in [East US 2 and Sweden Central regions](/foundry-models/models-sold-directly-by-azure-region-availability).
