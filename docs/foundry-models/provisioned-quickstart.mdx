...
**Currently viewing:** <img src="/images/yes-icon.svg" /> **New Foundry portal version** - [Switch to version for the classic Foundry portal](https://learn.microsoft.com/en-us/azure/foundry-classic/openai/provisioned-quickstart)
...
<Frame>
  <img src="/images/provisioned-managed-utilization-v2-metric.png" alt="Screenshot of Azure Metrics showing Provisioned-managed Utilization V2 chart filtered by deployment name." />
</Frame>
