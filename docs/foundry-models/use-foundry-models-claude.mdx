...
- A [Microsoft Foundry project](/setup/create-projects) created in one of the supported regions: **East US2**, **West Central US**, or **Sweden Central**.
...
|:------------------|:----------------|:--------------|:--------------|:-----------|:-----------|
| claude-mythos-preview     | [Global Standard](/foundry-models/deployment-types#global-standard)  |0        | 0    | 2,000      | 2,000,000  |
