...
To get started, [compare and select models using the model leaderboard](/foundry-models/benchmark-model-in-catalog) in Foundry portal.
...
- [Compare and select models using the model leaderboard in Foundry portal](/foundry-models/benchmark-model-in-catalog)
