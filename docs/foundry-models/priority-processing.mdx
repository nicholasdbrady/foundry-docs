...
<Frame>
  <img src="/images/azure-monitor-priority-processsing-utilization.png" alt="Screenshot of the priority processing utilization on the resource's metrics page in the Azure portal." />
</Frame>

For more information about monitoring your deployments, see [Monitor Azure OpenAI](https://learn.microsoft.com/en-us/azure/foundry-classic/openai/how-to/monitor-openai).
...
<Frame>
  <img src="/images/cost-analysis-priority-processing.png" alt="Screenshot of the priority processing utilization on the resource's cost analysis page in the Azure portal." />
</Frame>
...
- [Provisioned throughput](/foundry-models/provisioned-throughput)
- [Spillover traffic management](/foundry-models/spillover-traffic-management)
- [Deployment types](/foundry-models/deployment-types)
- [Monitoring Azure OpenAI](https://learn.microsoft.com/en-us/azure/foundry-classic/openai/how-to/monitor-openai)
- [Understanding costs associated with PTU](/foundry-models/provisioned-throughput-onboarding)
