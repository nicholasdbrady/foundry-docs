...
<Tabs>
  <Tab title="Portal">
    ...
    <Frame>
  <img src="/images/deploy-dialogue.png" alt="Screenshot that shows how to deploy a custom model in Foundry portal." />
</Frame>
...
<Tabs>
  <Tab title="Portal">
    ...
    <Frame>
  <img src="/images/playground-load-new.png" alt="Screenshot of the Playground pane in Foundry portal, with sections highlighted." />
</Frame>
...
[Standard deployments](/foundry-models/deployment-types) provide a pay-per-token billing model with data residency confined to the deployed region.
...
[Global standard](/foundry-models/deployment-types) fine-tuned deployments offer [cost savings](https://azure.microsoft.com/pricing/details/cognitive-services/openai-service/), but custom model weights may temporarily be stored outside the geography of your Azure OpenAI resource.
...
<Frame>
  <img src="/images/global-standard.png" alt="Screenshot of the global standard deployment user experience with a fine-tuned model." />
</Frame>

### Developer Tier

[Developer](/foundry-models/deployment-types) fine-tuned deployments offer a similar experience as [Global Standard](#global-standard) without an hourly hosting fee, but do not offer an availability SLA. Developer deployments are designed for model candidate evaluation and not for production use.
...
- [Azure OpenAI deployment types](/foundry-models/deployment-types)
