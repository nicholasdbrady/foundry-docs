...
For a list of Foundry Models sold directly by Azure, see [Foundry Models sold directly by Azure](/foundry-models/models-sold-directly-by-azure), and for a list of Foundry Models that are supported by the Foundry Agent Service, see [Models supported by Agent Service](/agent-service/limits-quotas-regions).

Foundry Models support several [deployment types](/foundry-models/deployment-types) to a Foundry resource. Some models in the model catalog require a hub-based project hosted by a Foundry hub for deployment. Selecting those models in the catalog opens them up in the [Foundry (classic) portal experience](https://learn.microsoft.com/en-us/azure/foundry-classic/what-is-foundry).
...
To deploy TimeGEN-1 in Foundry, see [Deploy Microsoft Foundry Models in the Foundry portal](/foundry-models/deploy-foundry-models).
...
For more details on pricing for Nixtla models, see [Nixtla](https://learn.microsoft.com/en-us/azure/foundry-classic/concepts/models-inference-examples#nixtla).
...
To deploy tsuzumi-7b in Foundry, see [Deploy Microsoft Foundry Models in the Foundry portal](/foundry-models/deploy-foundry-models).
