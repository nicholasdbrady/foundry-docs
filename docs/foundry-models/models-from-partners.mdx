...
For a list of Foundry Models sold by Azure, see [Foundry Models sold by Azure](/foundry-models/models-sold-directly-by-azure), and for a list of Foundry Models that are supported by the Foundry Agent Service, see [Models supported by Agent Service](/agent-service/limits-quotas-regions).
