...
<Frame>
  <img src="/images/models-deploy-deployment-type-gov.png" alt="Screenshot of the Foundry portal deployment dialog showing the deployment type selection box with Global Standard selected." />
</Frame>
...
Not all models support all deployment types. Check [Foundry Models sold directly by Azure](/foundry-models/models-sold-directly-by-azure-gov) for model availability by deployment type and region.
...
Learn more in the "Model region availability by deployment type" section of [Foundry Models sold directly by Azure](/foundry-models/models-sold-directly-by-azure-gov).

<Note>

With Data Zone Standard deployment types, if the primary region experiences an interruption in service, all traffic initially routed to this region is affected. To learn more, see the [business continuity and disaster recovery guide](https://learn.microsoft.com/en-us/azure/foundry-classic/openai/how-to/business-continuity-disaster-recovery).
...
Customers with high consistent volume might experience greater latency variability. The threshold is set per model. To learn more about Azure OpenAI quotas in Azure Government, see the [Quotas and limits in Azure OpenAI](/foundry-models/quotas-limits). For workloads that require low latency variance at large volume, consider provisioned deployment types.
...
|-------|-------|------------|
| Deployment type unavailable | Model doesn't support the selected type | Check [model availability by deployment type](/foundry-models/models-sold-directly-by-azure-gov) |
...
For Azure OpenAI quota limits by deployment type in Azure Government, see [Quotas and limits in Azure OpenAI](/foundry-models/quotas-limits).
...
- [Foundry Models sold directly by Azure in Azure Government](/foundry-models/models-sold-directly-by-azure-gov)
- [Model region availability by deployment type  in Azure Government](/foundry-models/models-sold-directly-by-azure-gov)
- [Azure OpenAI in Azure Government quotas and limits](/foundry-models/quotas-limits)
