...
Not every model is available in the regions supported by the responses API. Check the [models page](/foundry-models/models-sold-directly-by-azure) for model region availability.
