...
- **Role-based access control (RBAC):** One or both of the following roles at the subscription or resource group scope:
  ...
  - [**Azure AI User**](/security/rbac-foundry#built-in-roles) – View Foundry resource data and usage context.
...
- **View Foundry resources and related usage context:** [Azure AI User](/security/rbac-foundry#built-in-roles).
...
This custom role example doesn't grant access to Foundry resources by itself. Assign an additional role such as [Azure AI User](/security/rbac-foundry#built-in-roles) if users also need Foundry resource visibility.
