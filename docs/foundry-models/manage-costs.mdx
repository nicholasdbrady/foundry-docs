...
<Frame>
  <img src="/images/agent-build-cost.png" alt="Screenshot of the Build page showing the Models pane with a selected model highlighted." />
</Frame>
