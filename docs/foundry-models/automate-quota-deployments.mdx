---
title: "Automate Azure OpenAI deployments with quota in Microsoft Foundry"
description: "Programmatically create Azure OpenAI deployments and set tokens-per-minute (TPM) rate limits with REST, Azure CLI, Azure PowerShell, ARM, Bicep, and Terraform."
---
...
- An existing Azure OpenAI resource. To create one, see [Create a resource and deploy a model with Azure OpenAI](https://learn.microsoft.com/en-us/azure/foundry-classic/openai/how-to/create-resource).
- Quota available in the target region for the model you want to deploy. To check or request quota, see [Manage Azure OpenAI in Microsoft Foundry Models quota](/foundry-models/quota).
- Permissions to create deployments on the resource. The **Cognitive Services Contributor** role at the resource scope provides the required access. For details, see [Role-based access control for Azure OpenAI](https://learn.microsoft.com/en-us/azure/foundry-classic/openai/how-to/role-based-access-control).
- The model name and version that you want to deploy. For supported models, see [Azure OpenAI models](/foundry-models/models-sold-directly-by-azure).
...
There are multiple ways to generate an authorization token. The easiest method for initial testing is to launch the Cloud Shell from the [Azure portal](https://portal.azure.com). Then run [`az account get-access-token`](https://learn.microsoft.com/cli/azure/account). You can use this token as your temporary authorization token for API testing.
    ...
    For more information, see the REST API reference documentation for [usages](https://learn.microsoft.com/rest/api/aiservices/accountmanagement/usages/list) and [deployment](https://learn.microsoft.com/rest/api/aiservices/accountmanagement/deployments/create-or-update).
  ...
  <Tab title="Azure CLI">
    ...
    Install the [Azure CLI](https://learn.microsoft.com/cli/azure/install-azure-cli). Quota requires `Azure CLI version 2.51.0`. If you already have Azure CLI installed locally run `az upgrade` to update to the latest version.
    ...
    To sign into your local installation of the CLI, run the [`az login`](https://learn.microsoft.com/cli/azure/reference-index#az-login) command:
    ...
    To [query your quota usage](https://learn.microsoft.com/cli/azure/cognitiveservices/usage) in a given region, for a specific subscription
    ...
    This command runs in the context of the currently active subscription for Azure CLI. Use `az-account-set --subscription` to [modify the active subscription](https://learn.microsoft.com/cli/azure/manage-azure-subscriptions-azure-cli#change-the-active-subscription).

    For more information, see the [Azure CLI reference documentation](https://learn.microsoft.com/cli/azure/cognitiveservices/account/deployment)
  ...
  <Tab title="Azure Resource Manager">
    ...
    For more information, see the [full Azure Resource Manager reference documentation](https://learn.microsoft.com/azure/templates/microsoft.cognitiveservices/accounts/deployments).
  ...
  <Tab title="Bicep">
    ...
    For more information, see the [full Bicep reference documentation](https://learn.microsoft.com/azure/templates/microsoft.cognitiveservices/accounts/deployments).
  ...
  <Tab title="Terraform">
    ...
    For more information, see the [full Terraform reference documentation](https://learn.microsoft.com/azure/templates/microsoft.cognitiveservices/accounts/deployments).
...
- [Manage Azure OpenAI in Microsoft Foundry Models quota](/foundry-models/quota)
