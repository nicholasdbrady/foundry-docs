...
- At least one [deployed model](/foundry-models/deploy-models-managed) in your Foundry resource.
...
- [Deploy models in Microsoft Foundry](/foundry-models/deploy-models-managed)
