...
- A [Microsoft Foundry resource](https://learn.microsoft.com/en-us/azure/foundry-classic/how-to/create-azure-ai-resource).
- At least one [deployed model](https://learn.microsoft.com/en-us/azure/foundry-classic/how-to/deploy-models-managed) in your Foundry resource.
...
To get started with the agents playground, see [Understanding the agent development lifecycle](/agent-service/development-lifecycle).
...
| Issue | Resolution |
| ------- | ------------ |
| Content safety warning on generation | Refine your prompt to avoid flagged content. Review [Azure AI Content Safety](https://learn.microsoft.com/azure/ai-services/content-safety/overview) policies. |
| Model not available in deployment list | Check [model regional availability](/foundry-models/region-support) for your Foundry resource region. |
...
- [Understanding the agent development lifecycle](/agent-service/development-lifecycle)
- [Deploy models in Microsoft Foundry](https://learn.microsoft.com/en-us/azure/foundry-classic/how-to/deploy-models-managed)
- [Azure AI Content Safety overview](https://learn.microsoft.com/azure/ai-services/content-safety/overview)
- [Basic Foundry chat reference architecture](https://learn.microsoft.com/azure/architecture/ai-ml/architecture/basic-azure-ai-foundry-chat)
