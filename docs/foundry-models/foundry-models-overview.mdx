...
- [Model deprecation and retirement for Microsoft Foundry Models](/foundry-models/model-lifecycle-retirement)
 
## Related content

- [Data, privacy, and security for Azure Direct Models in Microsoft Foundry](/foundry-models/data-privacy)
