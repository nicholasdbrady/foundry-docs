...
- To deploy open models to managed compute, see [How to deploy and infer with a managed compute deployment (classic)](/foundry-models/deploy-models-managed).
- To deploy protected Foundry Models to managed compute with pay-as-you-go billing, see [Deploy Microsoft Foundry Models to managed compute with pay-as-you-go billing (classic)](/foundry-models/deploy-models-managed-pay-go).
