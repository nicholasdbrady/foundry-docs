...
This article lists the retirement schedule for Foundry Models in Azure Government — their current lifecycle stage, retirement date, and suggested replacement. Use it to plan migrations before a model is deprecated or retired. For details on what each lifecycle stage means and how notifications work, see [Microsoft Foundry Models lifecycle and support policy in Azure Government](/foundry-models/model-retirements-gov).
...
- [Retired Foundry Models](/foundry-models/retired-models)
- [Microsoft Foundry Models lifecycle and support policy in Azure Government](/foundry-models/model-retirements-gov)
