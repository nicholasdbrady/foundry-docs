...
- An Azure OpenAI resource with a speech to text model deployed in a [supported region](../../foundry-models/concepts/models-sold-directly-by-azure.md). For more information, see [Create a resource and deploy a model with Azure OpenAI](../../../foundry-classic/openai/how-to/create-resource.md).
...
<Note>
For information about other audio models that you can use with Azure OpenAI, see [Audio models](/foundry-models/models-sold-directly-by-azure).
</Note>
