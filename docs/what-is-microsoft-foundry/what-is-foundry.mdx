...
To find these other resources,  select the project name in the upper-left corner, then select **View all resources**.  A new browser tab opens the Foundry (classic) portal.  [Switch to Microsoft Foundry (classic) documentation](https://learn.microsoft.com/en-us/azure/foundry-classic/what-is-foundry) to work with these other resources in the Foundry (classic) portal.
