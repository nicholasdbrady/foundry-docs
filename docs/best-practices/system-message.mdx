...
For troubleshooting common issues with system messages, such as over-refusal or under-moderation, see the [troubleshooting section](/guardrails/safety-system-message-templates#troubleshooting) in the templates guide.
...
For more information on recommended safety components, visit our [Safety system message template guidance](/guardrails/safety-system-message-templates). 
...
- [Safety system message templates](/guardrails/safety-system-message-templates)
