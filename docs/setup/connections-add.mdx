...
* Make sure you have permissions to add connections to the project or resource. Adding connections requires the **Azure AI User**, **Azure AI Owner**, or Azure **Contributor** role (or higher). For details, see [Role-based access control](/security/rbac-foundry).
...
|Azure OpenAI|[Configure virtual networks for Azure AI services](https://learn.microsoft.com/azure/ai-services/cognitive-services-virtual-networks)|
