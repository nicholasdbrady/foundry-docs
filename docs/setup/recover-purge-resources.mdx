...
<Tabs>
  <Tab title="Azure portal">
    ...
    ![A screenshot showing deleted resources you can recover.](/images/managing-deleted-resource.png)
...
<Tabs>
  <Tab title="Azure portal">
    ...
    1. Select one or more deleted resources and select **Purge**. Purging permanently deletes a Foundry resource. 
        ...
        ![A screenshot showing a list of resources that can be purged.](/images/managing-deleted-resource.png)
