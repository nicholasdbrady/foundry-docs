...
Learn how to create and manage a Foundry resource. It's the [primary Azure resource type](https://learn.microsoft.com/en-us/azure/ai-foundry/concepts/resource-types) for building, deploying, and managing generative AI models and applications including agents in Azure.
...
A Foundry resource can organize the work for multiple use cases, and is [typically shared](https://learn.microsoft.com/en-us/azure/ai-foundry/concepts/planning) between a team of developers that work on use cases in a similar business or data domain. Projects act as folders to group related work. 

<Frame>
  <img src="/images/projects-multi-setup.png" alt="Diagram showing Foundry resource containing multiple projects, each with deployments and connections." />
</Frame>
...
Looking to configure Foundry with advanced security settings? See [advanced Foundry creation options](https://learn.microsoft.com/en-us/azure/ai-foundry/how-to/create-resource-template)
...
<ZonePivot group="azcli__azportal__azpowershell" options={[{"id": "azportal", "title": "Azure portal"}, {"id": "azcli", "title": "Azure CLI"}, {"id": "azpowershell", "title": "Azure PowerShell"}]} defaultValue="azportal" />

<ZoneContent group="azcli__azportal__azpowershell" value="azportal" options={[{"id": "azportal", "title": "Azure portal"}, {"id": "azcli", "title": "Azure CLI"}, {"id": "azpowershell", "title": "Azure PowerShell"}]} values={["azportal", "azcli", "azpowershell"]} defaultValue="azportal">
...
If your organization requires customized Azure configurations like alternative names, security controls or cost tags, you might need to use the [Azure portal](https://portal.azure.com) or [template options](https://learn.microsoft.com/en-us/azure/ai-foundry/how-to/create-resource-template) to comply with your organization's Azure Policy compliance.
...
<Frame>
  <img src="/images/ai-services-resource-portal.png" alt="Screenshot of the Foundry resource in the Azure portal." />
</Frame>
...
<ZoneContent group="azcli__azportal__azpowershell" value="azcli" options={[{"id": "azportal", "title": "Azure portal"}, {"id": "azcli", "title": "Azure CLI"}, {"id": "azpowershell", "title": "Azure PowerShell"}]} values={["azportal", "azcli", "azpowershell"]} defaultValue="azportal">
...
<ZoneContent group="azcli__azportal__azpowershell" value="azpowershell" options={[{"id": "azportal", "title": "Azure portal"}, {"id": "azcli", "title": "Azure CLI"}, {"id": "azpowershell", "title": "Azure PowerShell"}]} values={["azportal", "azcli", "azpowershell"]} defaultValue="azportal">
...
<Frame>
  <img src="/images/detailed-rbac-diagram.png" alt="Diagram of the built-in roles in Foundry." />
</Frame>
...
Only authorized users, typically the Azure subscription or resource group owner, can assign a role via either [Azure portal](link to Azure portal) or [Foundry portal via Admin](Link to Foundry portal). [Learn more about role-based access control](https://learn.microsoft.com/en-us/azure/ai-foundry/concepts/rbac-foundry).
...
With permissions set up, you're now ready to start building Foundry. In [Foundry portal](https://ai.azure.com/) open or [create your first project](https://learn.microsoft.com/en-us/azure/ai-foundry/how-to/create-projects). Projects organize your agent and model customization work in Foundry, and you can [create multiple under the same resource](https://learn.microsoft.com/en-us/azure/ai-foundry/how-to/create-projects#create-multiple-projects-on-the-same-resource).

Explore some of the services that come bundled with your resource:

| Service | Description | 
| --- | --- | 
| ![Foundry icon](/images/ai-services/ai-foundry.svg) [Foundry Agent Service](./agents/index.yml) | Combine the power of generative AI models with tools that allow agents to access and interact with real-world data sources. |
| ![Foundry icon](/images/ai-services/ai-foundry.svg) [Azure Model Inference](../ai-foundry/model-inference/index.yml) | Performs model inference for flagship models in the Foundry model catalog. |
| ![Azure OpenAI in Foundry Models icon](/images/ai-services/azure-openai.svg) [Azure OpenAI](../ai-foundry/openai/index.yml) | Perform a wide variety of natural language tasks. | 
| ![Content Safety icon](/images/ai-services/content-safety.svg) [Content Safety](./content-safety/index.yml) | A Foundry Tool that detects unwanted contents. | 
| ![Document Intelligence icon](/images/ai-services/document-intelligence.svg) [Document Intelligence](./document-intelligence/index.yml) | Turn documents into intelligent data-driven solutions. |
| ![Language icon](/images/ai-services/language.svg) [Language](./language-service/index.yml) | Build apps with industry-leading natural language understanding capabilities. |
| ![Speech icon](/images/ai-services/speech.svg) [Speech](./speech-service/index.yml) | Speech to text, text to speech, translation, and speaker recognition. |
| ![Translator icon](/images/ai-services/translator.svg) [Translator](./translator/index.yml) | Use AI-powered translation technology to translate more than 100 in-use, at-risk, and endangered languages and dialects. | 

## Next steps

- [Create a project](https://learn.microsoft.com/en-us/azure/ai-foundry/how-to/create-projects) to organize your work.
- [Connect tools](https://learn.microsoft.com/en-us/azure/ai-foundry/how-to/connections-add) to build more rich applications.
- Learn about [access control in Foundry](https://learn.microsoft.com/en-us/azure/ai-foundry/concepts/rbac-foundry) to invite others to your working environment.
- [Secure your resource using private networking](https://learn.microsoft.com/en-us/azure/ai-foundry/how-to/configure-private-link)
