...
You can disable the web search tool for all accounts in a subscription. For more information, see [Disable Web Search](/agent-service/web-search#disable-web-search).
