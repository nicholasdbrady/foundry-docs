...
See [Capability hosts](/agent-service/capability-hosts) for conceptual details.
...
- [Connect storage for Speech/Language](../../ai-services/speech-service/bring-your-own-storage-speech-resource)
