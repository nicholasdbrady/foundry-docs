...
sidebarTitle: "Connect to your own storage"
---
...
1. An [Azure Storage account](https://learn.microsoft.com/azure/storage/common/storage-account-create) in the same subscription (Blob Storage supported).
...
</Note>   > As described in the previous section, select the **Catalog** tab and look for **Azure Blob Storage**.
