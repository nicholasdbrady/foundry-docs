...
The templates only support deployment of Azure OpenAI models. See which Azure OpenAI models are supported in the [model support](/agents/development/limits-quotas-regions) article.
</Info>
...
| Model not available | Model not deployed in your region | Check [model region support](/agents/development/limits-quotas-regions) and select an available region |
