...
Projects are currently the unit of sharing and isolation in Foundry. See the [what is AI foundry](https://learn.microsoft.com/en-us/azure/ai-foundry/what-is-foundry) article for more information on Foundry projects.
...
The templates only support deployment of Azure OpenAI models. See which Azure OpenAI models are supported in the [model support](/agent-service/limits-quotas-regions) article.
</Info>
...
| Model not available | Model not deployed in your region | Check [model region support](/agent-service/limits-quotas-regions) and select an available region |
