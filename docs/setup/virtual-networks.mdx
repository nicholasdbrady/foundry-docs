...
- **Region availability**:
  - For supported regions for model deployments, see: [Azure OpenAI model region support](/foundry-models/models-sold-directly-by-azure).
...
You've now successfully configured a network-secure account and project. Use the [quickstart](/agent-service/quickstart-hosted-agent) to create your first agent.
