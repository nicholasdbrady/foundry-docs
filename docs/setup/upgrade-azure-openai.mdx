...
* Foundry model and feature availability [differs by region](/foundry-models/region-support). For example, Agent service is [available](/agent-service/limits-quotas-regions) in select regions compared to Azure OpenAI service.
