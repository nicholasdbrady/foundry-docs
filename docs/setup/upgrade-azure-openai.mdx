...
<Tabs>
  ...
  <Tab title="Azure portal">
    ...
    ![Screenshot shows how to upgrade in Azure portal.](/images/azure-portal-upgrade.png)
...
<Tabs>
  <Tab title="Foundry portal">
    ...
    **Option 1: Use Foundry portal**
    ...
    ![Screenshot shows the rollback option in the Foundry portal.](/images/rollback.png)
  ...
  <Tab title="Azure portal">
    ...
    ![Screenshot shows how to roll back in Azure portal.](/images/rollback-azure-portal.png)
