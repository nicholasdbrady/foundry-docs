...
sidebarTitle: "Connect your own storage to Speech/Language (Preview)"
---
...
<Tip>
Use this article when you specifically need Speech and Language data to land in storage you own. For the broader approaches (connections, capability hosts), see [Connect to your own storage](/setup/bring-your-own-azure-storage-foundry).
</Tip>
...
| Deletion impact | If you delete or move the storage account (resource ID changes), Speech & Language stop functioning. Attempt [storage account recovery](https://learn.microsoft.com/azure/storage/common/storage-account-recover) first; otherwise you must recreate the Foundry resource. |
...
**Reference**: [az role assignment create](https://learn.microsoft.com/cli/azure/role/assignment#az-role-assignment-create) | [az resource show](https://learn.microsoft.com/cli/azure/resource#az-resource-show)
...
**Reference**: [Microsoft.CognitiveServices/accounts](https://learn.microsoft.com/azure/templates/microsoft.cognitiveservices/accounts) | [Microsoft.Storage/storageAccounts](https://learn.microsoft.com/azure/templates/microsoft.storage/storageaccounts)
...
**Reference**: [Microsoft.CognitiveServices/accounts](https://learn.microsoft.com/azure/templates/microsoft.cognitiveservices/accounts) | [ARM template functions](https://learn.microsoft.com/azure/azure-resource-manager/templates/template-functions)
...
| Issue | Mitigation |
|-------|------------|
| Accidental deletion of storage account | Attempt [recovering the account](https://learn.microsoft.com/azure/storage/common/storage-account-recover). If unsuccessful, recreate the Foundry resource. |
...
- [Connect to your own storage (overview)](/setup/bring-your-own-azure-storage-foundry)
...
- [Speech BYOS resource guidance](../../ai-services/speech-service/bring-your-own-storage-speech-resource.md)
