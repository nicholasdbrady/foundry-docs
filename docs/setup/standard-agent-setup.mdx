...
sidebarTitle: "Built-in enterprise readiness with standard agent setup"
---
...
## Capability hosts
**[Capability hosts](/agents/development/capability-hosts)** are sub-resources on both the Account and Project, enabling interaction with the Agent Service. 
