...
[Capability hosts](/agent-service/capability-hosts) are sub-resources on both the account and the project that enable interaction with Agent Service.
...
- [Capability hosts](/agent-service/capability-hosts)
