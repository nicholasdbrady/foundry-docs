...
<Tabs>
  <Tab title="Foundry portal">
    ...
    * **If you're in a project**: Select the project breadcrumb, then select **Create new resource**.
        ...
        <Frame>
  <img src="/images/create-new-resource.png" alt="Screenshot shows creating a new project from a breadcrumb." />
</Frame>

    * **If you're not in a project**: Select **Create new** in the top right to create a new Foundry project

        <Frame>
  <img src="/images/create-new.png" alt="Screenshot shows how to create a new project in Foundry." />
</Frame>
...
<img src="/images/new-foundry.png" />
    ...
    1. Select **New project** and provide a name.
        ...
        <Frame>
  <img src="/images/second-project.png" alt="Screenshot shows how to create a second project on an existing resource." />
</Frame>
