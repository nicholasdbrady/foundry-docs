...
<Frame>
<img src="/images/foundry-export-template-terraform.png" alt="Screenshot of the Foundry Export template page with the Terraform tab selected, showing the Download, Open in VS Code, and Copy buttons above the AzureRM and AzApi subtabs and the generated Terraform code." />
</Frame>
