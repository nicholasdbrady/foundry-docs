...
sidebarTitle: "Bring your own AI gateway to Azure AI Agent Service (preview)"
---
...
<Frame>
  <img src="/images/gateway.png" alt="A diagram explaining the AI gateway feature and potential gateways to use." />
</Frame>
...
- This feature is different from the AI Gateway in Foundry feature where a new, unique APIM instance is deployed with your Foundry resource. For more on this feature, see [Enforce token limits with AI Gateway](https://learn.microsoft.com/azure/ai-foundry/configuration/enable-ai-api-management-gateway-portal).
