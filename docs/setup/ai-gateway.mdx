...
- To manage connections through the command line:
    ...
    - The `azure-ai-projects` SDK package (version 2.0.0 or later). For installation steps, see the [quickstart](/get-started/get-started-code).
...
<ZonePivot group="azure-cli__foundry-portal" options={[{"id": "foundry-portal", "title": "Foundry Portal"}, {"id": "azure-cli", "title": "Azure CLI"}]} defaultValue="foundry-portal" />

<ZoneContent group="azure-cli__foundry-portal" value="foundry-portal" options={[{"id": "foundry-portal", "title": "Foundry Portal"}, {"id": "azure-cli", "title": "Azure CLI"}]} values={["foundry-portal", "azure-cli"]} defaultValue="foundry-portal">
...
<Frame>
<img src="/images/add-model-connection.png" alt="Screenshot of external models in the Foundry portal." />
</Frame>
...
<Frame>
<img src="/images/add-api-management-model.png" alt="Screenshot of selecting an API Management resource in the Foundry portal." />
</Frame>
    ...
    1. Validate the managed identity token in API Management.
        ...
        In your API Management inbound policy, use the [validate-azure-ad-token](https://learn.microsoft.com/azure/api-management/validate-azure-ad-token-policy) policy to enforce token validation for requests from Microsoft Foundry.
...
<Frame>
<img src="/images/add-other-model.png" alt="Screenshot of selecting another model source in the Foundry portal." />
</Frame>
...
<ZoneContent group="azure-cli__foundry-portal" value="azure-cli" options={[{"id": "foundry-portal", "title": "Foundry Portal"}, {"id": "azure-cli", "title": "Azure CLI"}]} values={["foundry-portal", "azure-cli"]} defaultValue="foundry-portal">
