...
For production scenarios, consider running evaluations as part of your CI/CD pipeline. See [How to run an evaluation in Azure DevOps](/observability/evaluation-azure-devops), and [Continuously evaluate your AI agents](/agent-service/how-to-monitor-agents-dashboard) for integration patterns.
...
- Implement advanced evaluation methods ([AI-assisted evaluation](/agent-service/evaluate-agent)).
...
- [Apply organization-wide governance policies and model comparison](/security/model-deployment-policy).
- [Configure fleet monitoring, CI/CD integration, and production deployment endpoints](/foundry-models/deployment-types).
