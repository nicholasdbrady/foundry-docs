...
<Tip>
For production scenarios, consider running evaluations as part of your CI/CD pipeline. See [How to run an evaluation in Azure DevOps](/observability/evaluation-azure-devops), and [Continuously evaluate your AI agents](../../foundry-classic/how-to/continuous-evaluation-agents.md) for integration patterns.
</Tip>
