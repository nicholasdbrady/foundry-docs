...
For detailed guidance on batch evaluations, see [Run evaluations in the cloud](../how-to/develop/cloud-evaluation). To find a comprehensive list of built-in evaluators available in Foundry, see [Observability in generative AI](/observability/observability).
...
For production scenarios, consider running evaluations as part of your CI/CD pipeline. See [How to run an evaluation in Azure DevOps](../how-to/evaluation-azure-devops), and [Continuously evaluate your AI agents](/observability/how-to-monitor-agents-dashboard) for integration patterns.
...
- Add more data sources ([Azure AI Search](/tools-and-knowledge/ai-search), [other sources](../how-to/connections-add)).
- Implement advanced evaluation methods ([AI-assisted evaluation](../observability/how-to/evaluate-agent)).
- Create [custom tools](/tools-and-knowledge/private-tool-catalog) for business-specific operations.
