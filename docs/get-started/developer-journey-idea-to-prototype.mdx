...
- A Foundry **project** with a deployed model (for example, `gpt-4o-mini`). If you don't have one: [Create a project](/setup/create-projects) and then deploy a model (see model overview: [Model catalog](/models/catalog/foundry-models-overview)).
...
- [Multi-agent patterns](/agents/tools/agent-to-agent)
