...
- SharePoint connection configured in your project ([SharePoint tool documentation](/toolboxes/sharepoint))

<Note>

To configure your Foundry project for SharePoint connectivity, see the [SharePoint tool documentation](/toolboxes/sharepoint).
