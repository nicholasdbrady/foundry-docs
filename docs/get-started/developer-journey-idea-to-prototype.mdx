...
- A Foundry **project** with a deployed model (for example, `gpt-4o-mini`). If you don't have one: [Create a project](/setup/create-projects) and then deploy a model (see model overview: [Model catalog](/foundry-models/foundry-models-overview)).
- Python 3.10 or later
- .NET SDK 8.0 or later (for the C# sample)
- SharePoint connection configured in your project ([SharePoint tool documentation](/agent-service/sharepoint))

<Note>
To configure your Foundry project for SharePoint connectivity, see the [SharePoint tool documentation](/agent-service/sharepoint).
</Note>
...
<Tip>
For detailed guidance on batch evaluations, see [Run evaluations in the cloud](/observability/cloud-evaluation). To find a comprehensive list of built-in evaluators available in Foundry, see [Observability in generative AI](/observability/observability).
</Tip>
...
<Tip>
For production scenarios, consider running evaluations as part of your CI/CD pipeline. See [How to run an evaluation in Azure DevOps](/observability/evaluation-azure-devops), and [Continuously evaluate your AI agents](https://learn.microsoft.com/en-us/azure/foundry-classic/how-to/continuous-evaluation-agents) for integration patterns.
</Tip>
...
- Add more data sources ([Azure AI Search](/agent-service/ai-search), [other sources](/setup/connections-add)).
- Implement advanced evaluation methods ([AI-assisted evaluation](https://learn.microsoft.com/en-us/azure/foundry-classic/how-to/develop/evaluate-sdk)).
- Create [custom tools](/agent-service/private-tool-catalog) for business-specific operations.
...
- [Create comprehensive evaluation datasets with quality metrics](/foundry-models/data-generation).
- [Apply organization-wide governance policies and model comparison](https://learn.microsoft.com/en-us/azure/foundry-classic/how-to/built-in-policy-model-deployment).
- [Configure fleet monitoring, CI/CD integration, and production deployment endpoints](/foundry-models/deployments-overview).

### Stage 3: Production to adoption

- [Collect trace data and user feedback from production deployments](/agent-service/trace-agent-framework).
- [Fine-tune models and generate evaluation insights for continuous improvement](/foundry-models/fine-tuning).
...
- [Foundry Agent Service overview](/agent-service/overview)
- [SharePoint tool documentation](/agent-service/sharepoint)
- [MCP tool integration](/agent-service/model-context-protocol)
- [Multi-agent patterns](/agent-service/agent-to-agent)
