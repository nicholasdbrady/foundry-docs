...
For a managed real-time voice experience, use a [voice-based prompt agent](/get-started/prompt-voice-agent). Voice-based prompt agents use Voice Live for spoken conversations and don't require you to host the voice orchestration code.
...
Copy [your project endpoint](/get-started/quickstart-create-foundry-resources#get-your-project-connection-details) from the welcome screen in the Foundry portal.
...
- [Use tools with agents](/toolboxes/model-context-protocol)
