...
- [Foundry User role](../../concepts/rbac-foundry) on the project, to create and invoke agents.
...
<ZonePivot group="azd__javascript__portal__python" options={[{"id": "portal", "title": "Foundry portal"}, {"id": "python", "title": "Python"}, {"id": "javascript", "title": "JavaScript"}, {"id": "azd", "title": "Azure Developer CLI"}]} defaultValue="portal" />

<ZoneContent group="azd__javascript__portal__python" value="portal" options={[{"id": "portal", "title": "Foundry portal"}, {"id": "python", "title": "Python"}, {"id": "javascript", "title": "JavaScript"}, {"id": "azd", "title": "Azure Developer CLI"}]} values={["portal", "python", "javascript", "azd"]} defaultValue="portal">

- A supported browser with microphone and speaker access.
- A microphone and speaker or headset for testing.

</ZoneContent>
<ZoneContent group="azd__javascript__portal__python" value="python" options={[{"id": "portal", "title": "Foundry portal"}, {"id": "python", "title": "Python"}, {"id": "javascript", "title": "JavaScript"}, {"id": "azd", "title": "Azure Developer CLI"}]} values={["portal", "python", "javascript", "azd"]} defaultValue="portal">

- Python 3.10 or later.
- The Azure CLI, signed in with `az login`.

</ZoneContent>
<ZoneContent group="azd__javascript__portal__python" value="javascript" options={[{"id": "portal", "title": "Foundry portal"}, {"id": "python", "title": "Python"}, {"id": "javascript", "title": "JavaScript"}, {"id": "azd", "title": "Azure Developer CLI"}]} values={["portal", "python", "javascript", "azd"]} defaultValue="portal">

- Node.js 22 or later.
- The Azure CLI, signed in with `az login`.

</ZoneContent>
<ZoneContent group="azd__javascript__portal__python" value="azd" options={[{"id": "portal", "title": "Foundry portal"}, {"id": "python", "title": "Python"}, {"id": "javascript", "title": "JavaScript"}, {"id": "azd", "title": "Azure Developer CLI"}]} values={["portal", "python", "javascript", "azd"]} defaultValue="portal">

- Azure Developer CLI version 1.32.0 or later and the Microsoft Foundry extensions. For the individual installation steps, see [Install the Azure Developer CLI Foundry extensions](/developer-tools-and-integrations/install-cli-foundry-extensions). To install the complete developer toolset, see [Prepare your development environment](/developer-tools-and-integrations/install-cli-sdk).
- An authenticated `azd` session. Run `azd auth login` after you install the extensions.
- The Azure permissions listed in [Install the Azure Developer CLI Foundry extensions](/developer-tools-and-integrations/install-cli-foundry-extensions#azure-permissions).
...
For detailed configuration guidance, see [Configure a voice agent](/agents/configure-voice-agent).
...
You can also download the merged call recording, with the caller on the left channel and the agent on the right. See [Voice agent tracing, monitoring, and evaluation](/agents/voice-agent-observability).
...
The CLI generates `kind: prompt-voice` for compatibility. `kind: voice` is also accepted; you don't need to rename the generated kind to use public preview. To use your own model deployment, see [Choose a managed or self-deployed model](/agents/configure-voice-agent#choose-a-managed-or-self-deployed-model).
...
- [Integrate telephony channels with a voice agent](/agents/voice-agent-telephony-channels)
...
- [Configure a voice agent](/agents/configure-voice-agent)
- [Build a voice agent with hosted agents](/agents/build-voice-agent)
- [Deploy a hosted voice agent with azd](/agents/deploy-hosted-voice-agent)
