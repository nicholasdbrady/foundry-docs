...
<Tabs>
  <Tab title="VS Code">
    ...
    The [Foundry Toolkit extension for VS Code](https://aka.ms/foundrytk) comes with the Foundry Skill. To install the extension, see [Work with the Microsoft Foundry for Visual Studio Code extension](/developer-tools-and-integrations/get-started-projects-vs-code).
    ...
    [Get started with the Azure MCP Server](https://learn.microsoft.com/azure/developer/azure-mcp-server/get-started/tools/visual-studio-code)
    and [Get started with Foundry MCP Server](/developer-tools-and-integrations/get-started).
...
- [Quickstart: Deploy your first hosted agent](../../agents/quickstarts/quickstart-hosted-agent)
