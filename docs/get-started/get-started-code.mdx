...
<Tabs>
  ...
  <Tab title="TypeScript">
    ...
    ```
    Follow along below or get the code:
    <Card title="Get the code" icon="arrow-right" href="https://github.com/microsoft-foundry/foundry-samples/tree/main/samples/typescript/quickstart/src" />
  ...
  <Tab title="Java">
    ...
    Follow along below or get the code:
    <Card title="Get the code" icon="arrow-right" href="https://github.com/microsoft-foundry/foundry-samples/tree/main/samples/java/quickstart/src/main/java/com/microsoft/foundry/samples/" />
