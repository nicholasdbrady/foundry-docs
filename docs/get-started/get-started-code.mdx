...
<Tabs>
  <Tab title="Python">
    ...
    1. Store [your project endpoint](/get-started/quickstart-create-foundry-resources#get-your-project-connection-details) and model name as environment variables. The `quickstart-responses.py` sample reads these values:
  ...
  <Tab title="C#">
    ...
    1. Store [your project endpoint](/get-started/quickstart-create-foundry-resources#get-your-project-connection-details) and model name as environment variables. The `quickstart-responses.cs` sample reads these values:
