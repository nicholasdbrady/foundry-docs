...
**You will:**
<Check>Generate a response from a model</Check>
<Check>Create an agent with a defined prompt</Check>
<Check>Have a multi-turn conversation with the agent</Check>
## Prerequisites
