...
![Screenshot shows the Ask AI button in the top right bar of the Foundry portal.](/images/ask-ai.png)
...
![Screenshot shows the Ask AI chat on the right side of Foundry portal. The Ask AI agent is responding a user query by proposing to run an action for the user to approve.](/images/ask-ai-approval-flow.png)
...
![Screenshot shows the Ask AI prompt chat box, showing the location of the approval settings.](/images/ask-ai-approval-settings.png)
