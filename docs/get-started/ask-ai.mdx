...
The actions come from the tools available under the [Foundry Model Context Protocol (MCP) Server](/developer-experience/available-tools).
...
The Ask AI experience relies on the [Foundry Model Context Protocol (MCP) Server](/developer-experience/get-started). By using this server, it implements the [same best practices and security guidance](/developer-experience/security-best-practices).
...
- [Get started with the Foundry MCP Server](/developer-experience/get-started)
- [Available MCP Server tools](/developer-experience/available-tools)
- [MCP Server security best practices](/developer-experience/security-best-practices)- [What is Microsoft Foundry?](/what-is-microsoft-foundry?/what-is-foundry)
