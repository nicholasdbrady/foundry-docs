...
<Frame>
  <img src="/images/ask-ai.png" alt="Screenshot shows the Ask AI button in the top right bar of the Foundry portal." />
</Frame>
...
<Frame>
  <img src="/images/ask-ai-approval-flow.png" alt="Screenshot shows the Ask AI chat on the right side of Foundry portal. The Ask AI agent is responding a user query by proposing to run an action for the user to approve." />
</Frame>

The actions come from the tools available under the [Foundry Model Context Protocol (MCP) Server](/developer-tools-and-integrations/available-tools).
...
<Frame>
  <img src="/images/ask-ai-approval-settings.png" alt="Screenshot shows the Ask AI prompt chat box, showing the location of the approval settings." />
</Frame>

## Best practices and security guidance

The Ask AI experience relies on the [Foundry Model Context Protocol (MCP) Server](/developer-tools-and-integrations/get-started). By using this server, it implements the [same best practices and security guidance](/developer-tools-and-integrations/security-best-practices).
...
- [Get started with the Foundry MCP Server](/developer-tools-and-integrations/get-started)
- [Available MCP Server tools](/developer-tools-and-integrations/available-tools)
- [MCP Server security best practices](/developer-tools-and-integrations/security-best-practices)
