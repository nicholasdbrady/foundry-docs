...
The rest of the article covers the new v1 preview API release of the Azure OpenAI data plane inference specification. For more information, see the [API lifecycle guide](../api-version-lifecycle#api-evolution).

If you're looking for documentation on the latest v1 GA API release, refer to the [latest GA data plane inference API](../latest).
