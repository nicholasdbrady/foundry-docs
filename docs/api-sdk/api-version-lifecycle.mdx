...
- A [Foundry resource](/setup/multi-service-resource) or [Azure OpenAI resource](https://learn.microsoft.com/azure/ai-foundry/openai/how-to/create-resource) deployed in a [supported region](https://azure.microsoft.com/explore/global-infrastructure/products-by-region/?products=cognitive-services)
- At least one [model deployment](/models/capabilities/deploy-foundry-models)
- For Microsoft Entra ID authentication: the `Cognitive Services OpenAI User` role assigned to your identity. For more information, see [Role-based access control for Azure OpenAI](https://learn.microsoft.com/azure/ai-foundry/openai/how-to/role-based-access-control)
...
<Tabs>
  <Tab title="Python">
    ...
    [Python v1 examples](/models/capabilities/supported-languages)
  ...
  <Tab title="C#">
    ...
    [C# v1 examples](/models/capabilities/supported-languages)
  ...
  <Tab title="Go">
    ...
    [Go v1 examples](/models/capabilities/supported-languages)
  ...
  <Tab title="Java">
    ...
    [Java v1 examples](/models/capabilities/supported-languages)
...
For Azure OpenAI models we recommend using the [Responses API](/models/capabilities/supported-languages), however, the v1 API also allows you to make chat completions calls with models from other providers like DeepSeek and Grok which support the OpenAI v1 chat completions syntax.
...
<Note>
Responses API also works with Foundry Models sold directly by Azure, such as Microsoft AI, DeepSeek, and Grok models. To learn how to use the Responses API with these models, see [How to generate text responses with Microsoft Foundry Models](/models/catalog/generate-responses).
</Note>
<Tabs>
  <Tab title="Python">
...
- [Video generation support](/models/capabilities/video-generation)
...
- [`GPT-image-1` support](https://learn.microsoft.com/azure/ai-foundry/openai/how-to/dall-e)
- [Reasoning summary for `o3` and `o4-mini`](https://learn.microsoft.com/azure/ai-foundry/openai/how-to/reasoning)
- [Evaluation API](https://learn.microsoft.com/azure/ai-foundry/openai/authoring-reference-preview#evaluation---create)

### Changes between 2025-03-01-preview and 2025-02-01-preview

- [Responses API](/models/capabilities/responses)
- Computer use
...
- `prediction` parameter added for [predicted outputs](/models/capabilities/predicted-outputs) support.
- `gpt-4o-audio-preview` [model support](/models/capabilities/audio-completions-quickstart).
...
- `reasoning_effort` added for latest [reasoning models](/models/capabilities/reasoning).
...
- [Structured outputs support](/models/capabilities/structured-outputs).
...
- [Batch API support added](/models/capabilities/batch)
- [Vector store chunking strategy parameters](https://learn.microsoft.com/azure/ai-foundry/openai/reference-preview)
...
- The `2025-04-01-preview` Azure OpenAI spec uses OpenAPI 3.1. It's a known issue that this version isn't fully supported by [Azure API Management](https://learn.microsoft.com/azure/api-management/api-management-key-concepts).

## Next steps

- [Supported programming languages for the v1 API](/models/capabilities/supported-languages)
- [Foundry Models sold directly by Azure](/models/catalog/models-sold-directly-by-azure)
- [Working with Azure OpenAI models](/models/catalog/working-with-models)
