...
- At least one [model deployment](/foundry-models/deploy-foundry-models)
...
<Tabs>
  <Tab title="Python">
    ...
    [Python v1 examples](/foundry-models/supported-languages)
...
Handling automatic token refresh was previously handled through use of the `AzureOpenAI()` client. The v1 API removes this dependency, by adding automatic token refresh support to the `OpenAI()` client.
  ...
  <Tab title="C#">
    ...
    [C# v1 examples](/foundry-models/supported-languages)
  ...
  <Tab title="JavaScript">
    ...
    [JavaScript v1 examples](/foundry-models/supported-languages)
  ...
  <Tab title="Go">
    ...
    [Go v1 examples](/foundry-models/supported-languages)
  ...
  <Tab title="Java">
    ...
    [Java v1 examples](/foundry-models/supported-languages)
...
For Azure OpenAI models we recommend using the [Responses API](/foundry-models/supported-languages), however, the v1 API also allows you to make chat completions calls with models from other providers like DeepSeek and Grok which support the OpenAI v1 chat completions syntax.
...
<Note>
Responses API also works with Foundry Models sold directly by Azure, such as Microsoft AI, DeepSeek, and Grok models. To learn how to use the Responses API with these models, see [How to generate text responses with Microsoft Foundry Models](/foundry-models/generate-responses).
</Note>
...
- [Video generation support](/foundry-models/video-generation)
...
- [Responses API](/foundry-models/responses)
- Computer use
...
- `prediction` parameter added for [predicted outputs](/foundry-models/predicted-outputs) support.
- `gpt-4o-audio-preview` [model support](/foundry-models/audio-completions-quickstart).
...
- `reasoning_effort` added for latest [reasoning models](/foundry-models/reasoning).
...
- [Structured outputs support](/foundry-models/structured-outputs).
...
- [Batch API support added](/foundry-models/batch)
...
- [Supported programming languages for the v1 API](/foundry-models/supported-languages)
- [Foundry Models sold directly by Azure](/foundry-models/models-sold-directly-by-azure)
- [Working with Azure OpenAI models](/foundry-models/working-with-models)
