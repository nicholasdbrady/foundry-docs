...
sidebarTitle: "Endpoints for Microsoft Foundry Models"
---
...
![An illustration showing how Azure OpenAI deployments contain a single URL for each deployment.](/images/endpoint-openai.png)
