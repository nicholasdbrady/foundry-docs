...
If you're looking for documentation on the latest GA API release, refer to the [latest GA data plane inference API](/api-sdk/latest)
...
Learn more about the [underlying models that power Azure OpenAI](/foundry-models/models-sold-directly-by-azure).
