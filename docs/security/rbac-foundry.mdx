...
sidebarTitle: "Role-based access control for Microsoft Foundry"
---
...
For more information about authentication and authorization in Microsoft Foundry, see [Authentication and Authorization](/security/authentication-authorization-foundry). This article mentions terminology explained in the previous article. 

## Getting started

For new users to Azure and Microsoft Foundry, use the following check-list to ensure all the correct roles are assigned to your user principal and your project's managed identity to get started in Foundry. You can check your roles by using the [Check access for a user to a single Azure resource](https://learn.microsoft.com/azure/role-based-access-control/check-access) guidelines.
...
For Foundry resources, use additional built-in roles to follow least privilege access principles. The following table lists the five key built-in roles for Foundry, a short description, and the link to the exact role definition in the [AI + Machine Learning built-in roles article](https://learn.microsoft.com/azure/role-based-access-control/built-in-roles/ai-machine-learning).
...
For more on built-in roles in Azure and Foundry, see [Azure built-in roles](https://learn.microsoft.com/azure/role-based-access-control/built-in-roles). To learn more about conditional delegation used in the Azure AI Account Owner and Azure AI Project Manager role, see [Delegate Azure role assignment management to others with conditions](https://learn.microsoft.com/azure/role-based-access-control/delegate-role-assignments-portal).
...
- [Disable Preview Features with Role-Based Access](/security/disable-preview-features-with-rbac). This article provides more details on specific permissions in Foundry across control and data plane which you can utilize when building custom roles.
...
- [Disable Preview Features with Role-Based Access](/security/disable-preview-features-with-rbac).
