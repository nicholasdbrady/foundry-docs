...
When you use a Foundry project, you can use a private endpoint to secure communication. This article describes how to establish a private connection to your Foundry account and projects using a private endpoint.
...
{/* <Frame>
  <img src="/images/plan-network-isolation-diagram.png" alt="Diagram of the plan for network isolation in Foundry." />
</Frame> 
*/}
...
If you're building agents or running evaluations and you want end-to-end network isolation, see [How to use a virtual network with the Azure AI Agent Service](https://learn.microsoft.com/azure/ai-services/agents/how-to/virtual-networks). That article provides details on required DNS zones, reference architecture, and known limitations.

{/* <Frame>
  <img src="/images/agent-eval-network-diagram.png" alt="Diagram of the recommended network isolation for Foundry." />
</Frame> 
*/}
...
{/* <Frame>
  <img src="/images/network-hub-spoke-diagram.png" alt="Diagram of the firewall configuration for egress traffic from Foundry projects and agents." />
</Frame> 
*/}
