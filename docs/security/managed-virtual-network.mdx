...
For more details on the parameters required for managed virtual network deployment, see [Microsoft.MachineLearningServices/workspaces/managedNetwork](https://learn.microsoft.com/azure/templates/microsoft.machinelearningservices/workspaces/managednetworks).
...
For more details on the parameters required for managed virtual network outbound rules, see [Microsoft.MachineLearningServices/workspaces/managedNetwork/outboundRules](https://learn.microsoft.com/azure/templates/microsoft.machinelearningservices/workspaces/managednetworks/outboundrules).
