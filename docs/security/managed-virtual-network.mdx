...
![Diagram of managed virtual network configuration.](/images/diagram-managed-network.png)
...
![Diagram of managed virtual network configuration in allow internet outbound mode.](/images/diagram-allow-internet-outbound-managed-network.png)

The following architecture diagram shows a managed network in `allow only approved outbound` mode. 

![Diagram of managed virtual network configuration in allow only approved outbound mode.](/images/diagram-allow-only-approved-outbound-managed-network.png)
