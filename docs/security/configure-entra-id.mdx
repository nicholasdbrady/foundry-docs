...
- An Azure subscription. If you're using GitHub Models, you can upgrade your experience and create an Azure subscription in the process. Read [Upgrade from GitHub Models to Microsoft Foundry Models](/foundry-models/quickstart-github-models) if that's your case.
...
<ZonePivot group="ai-foundry-portal__programming-language-bicep__programming-language-cli" options={[{"id": "ai-foundry-portal", "title": "Foundry portal"}, {"id": "programming-language-cli", "title": "Speech CLI"}, {"id": "programming-language-bicep", "title": "Bicep"}]} defaultValue="ai-foundry-portal" />

<ZoneContent group="ai-foundry-portal__programming-language-bicep__programming-language-cli" value="ai-foundry-portal" options={[{"id": "ai-foundry-portal", "title": "Foundry portal"}, {"id": "programming-language-cli", "title": "Speech CLI"}, {"id": "programming-language-bicep", "title": "Bicep"}]} values={["ai-foundry-portal", "programming-language-cli", "programming-language-bicep"]} defaultValue="ai-foundry-portal">
...
<ZoneContent group="ai-foundry-portal__programming-language-bicep__programming-language-cli" value="programming-language-cli" options={[{"id": "ai-foundry-portal", "title": "Foundry portal"}, {"id": "programming-language-cli", "title": "Speech CLI"}, {"id": "programming-language-bicep", "title": "Bicep"}]} values={["ai-foundry-portal", "programming-language-cli", "programming-language-bicep"]} defaultValue="ai-foundry-portal">
...
For more information about how to use the Azure CLI to disable or reenable local authentication and verify authentication status, see [Disable local authentication in Foundry Tools](../../../../ai-services/disable-local-auth).

</ZoneContent>
<ZoneContent group="ai-foundry-portal__programming-language-bicep__programming-language-cli" value="programming-language-bicep" options={[{"id": "ai-foundry-portal", "title": "Foundry portal"}, {"id": "programming-language-cli", "title": "Speech CLI"}, {"id": "programming-language-bicep", "title": "Bicep"}]} values={["ai-foundry-portal", "programming-language-cli", "programming-language-bicep"]} defaultValue="ai-foundry-portal">
...
For more information about how to disable local authentication when you're using a Bicep or ARM template, see [How to disable local authentication](../../../../ai-services/disable-local-auth#how-to-disable-local-authentication).
