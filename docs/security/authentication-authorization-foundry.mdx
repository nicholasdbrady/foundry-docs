...
![Diagram illustrating separation of control plane and data plane operations with associated RBAC surfaces.](/images/foundry-rbac-control-data-separation.png)
...
![Diagram mapping built-in roles to control plane actions and data plane actions in Foundry.](/images/role-mapping-diagram.png)
