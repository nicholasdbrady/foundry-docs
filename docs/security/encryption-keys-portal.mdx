...
sidebarTitle: "Customer-Managed Keys (CMKs) for Microsoft Foundry"
---
...
Before you configure a CMK, be sure to deploy your resources in a supported region. For more information on regional support for Foundry features, see [Microsoft Foundry feature availability across cloud regions](/operate/region-support).
...
- [Overview of Azure managed identities](https://learn.microsoft.com/azure/active-directory/managed-identities-azure-resources/overview)
