...
| --------------- | -------- | --------------- | ------- | -------- |
| [Instant (preview)](/models/instant-models) | N/A — no deployment needed | Any Azure region | Pay-per-token (global quota) | Getting started, prototyping, trying new models |
...
Learn more in the "Model region availability by deployment type" section of [Foundry Models sold by Azure](/models/models-sold-directly-by-azure).
...
Global Standard supports priority processing (preview) for faster response times on a pay-as-you-go basis. To learn more, see [Priority processing for Foundry models (preview)](/models/priority-processing).
...
Data Zone Standard supports priority processing (preview) for faster response times on a pay-as-you-go basis. To learn more, see [Priority processing for Foundry models (preview)](/models/priority-processing).
...
Data Zone Batch deployments provide the same functionality as [Global Batch](/models/batch), including 50% cost savings and 24-hour turnaround. Traffic is routed only to datacenters within the Microsoft-defined data zone (US or EU).
...
- [Data privacy and security for Foundry Models](/models/concept-data-privacy)
