...
To learn how data is processed when you use Claude models in Foundry, see [Data, privacy, and security for Claude models in Microsoft Foundry](../../responsible-ai/claude-models/data-privacy).

To learn how Claude consumption units (CCU) bill Claude models in Microsoft Foundry through Azure Marketplace, see [Claude Consumption Units (CCU) billing in Microsoft Foundry](../concepts/claude-models-billing).
...
| `claude-opus-4-7` | Hosted on Anthropic: GA  | 1M / 128K | - Adaptive thinking <br /> - Reasoning over entire codebases- High-resolution image input (up to 2576px / 3.75MP) | - Coding <br /> - Enterprise workflows <br /> - Long-running agents <br /> - Multimodal reasoning <br /> - Financial analysis <br /> - Cybersecurity |
...
| `claude-sonnet-5` | Hosted on Azure: GA | 1M / 128K | - Adaptive thinking <br /> - `xhigh` effort level <br /> - Reasoning over entire codebases and multi-day project context <br /> - High-res image input (up to 2576px / 3.75MP) are on by default- Mid-conversation<sup>4</sup> `role:"system"` - Token budgets<sup>4</sup> (`task_budget`)  | - Coding <br /> - Long-running agents <br /> - Financial analysis <br /> - Cybersecurity <br /> - Computer use |
| `claude-sonnet-5` | Hosted on Anthropic: GA | 1M / 128K | - Adaptive thinking <br /> - `xhigh` effort level <br /> - Reasoning over entire codebases and multi-day project context <br /> - High-res image input (up to 2576px / 3.75MP) are on by default- Mid-conversation<sup>4</sup> `role:"system"` - Token budgets<sup>4</sup> (`task_budget`)  | - Coding <br /> - Long-running agents <br /> - Financial analysis <br /> - Cybersecurity <br /> - Computer use |
