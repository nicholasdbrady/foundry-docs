...
---
This article lists a selection of Microsoft Foundry Models sold by Azure in Azure Government along with their capabilities and [deployment types, and regions of availability](/models/deployment-types-gov). 
...
To learn more about attributes of all Foundry Models sold by Azure across all clouds, see [Models sold by Azure](/models/models-sold-directly-by-azure).
...
| Models | Description |
|--|--|
| [GPT-5.6 series](/models/models-sold-directly-by-azure-gov#gpt-56) | **NEW** `gpt-5.6-sol`, `gpt-5.6-terra`, `gpt-5.6-luna` |
| [GPT-5.1 series](/models/models-sold-directly-by-azure-gov#gpt-51) | `gpt-5.1`|
| [GPT-4.1 series](/models/models-sold-directly-by-azure-gov#gpt-41-series) | gpt-4.1, gpt-4.1-mini |
| [o-series models](/models/models-sold-directly-by-azure-gov#o-series-models) |[Reasoning models](../how-to/reasoning) with advanced problem solving and increased focus and capability. |
| [GPT-4o](/models/models-sold-directly-by-azure-gov#gpt-4o) | Capable Azure OpenAI models with multimodal versions, which can accept both text and images as input. |
| [Embeddings](/models/models-sold-directly-by-azure-gov#embeddings) | A set of models that can convert text into numerical vector form to facilitate text similarity. |
...
All deployments can perform the exact same inference operations, but the billing, scale, and performance are substantially different. To learn more about Azure OpenAI deployment types, see our [Deployment types guide](/models/deployment-types-gov).
...
<Tabs>
  ...
  <Tab title="Provisioned managed">
    ...
    For more information about provisioned deployments, see [Provisioned throughput in Azure Government](../concepts/provisioned-throughput-gov).
...
In some cases, models are retired in Azure Government earlier or later than in the commercial cloud. For the latest information on model retirements, refer to the [model retirement guide](../concepts/model-retirements-gov). 

## Related content

- [Model retirement and deprecation](../concepts/model-retirements-gov)
- [Learn more about working with Azure OpenAI models](../how-to/working-with-models)
- [Learn more about Azure OpenAI](/models/models-sold-directly-by-azure-gov)
