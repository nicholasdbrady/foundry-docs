...
sidebarTitle: "Customize a premium healthcare AI model with fine-tuning"
---
...
project SDK. [Customize a model with fine-tuning](/models/fine-tuning)
...
- Access to a [premium healthcare model](/models/healthcare-ai-models) such as
  [MedImageInsight Premium (preview)](/models/deploy-medimageinsight-premium) or
  [CxrReportGen Premium (preview)](/models/deploy-cxrreportgen-premium) in the
...
- Control-plane permission to create and manage deployments, such as
  **Cognitive Services Contributor** or **Azure AI Account Owner**. For
  details, see
  [Role-based access control in Foundry portal](../../concepts/rbac-foundry).
...
sold by Azure](/models/data-privacy).
...
- [CxrReportGen Premium](/models/fine-tune-cxrreportgen-premium)
- [MedImageInsight Premium](/models/fine-tune-medimageinsight-premium)
...
[CxrReportGen Premium training data format](/models/fine-tune-cxrreportgen-premium#training-data-format)
and
[MedImageInsight Premium training data format](/models/fine-tune-medimageinsight-premium#training-data-format).
...
[Uploads API](https://learn.microsoft.com/azure/ai-foundry/openai/authoring-reference-preview#upload-file---start).

</Note>

For model-specific image requirements, see
[CxrReportGen Premium image preprocessing and requirements](/models/fine-tune-cxrreportgen-premium#image-preprocessing-and-requirements)
and
[MedImageInsight Premium image preprocessing and requirements](/models/fine-tune-medimageinsight-premium#image-preprocessing-and-requirements).

<Info>

Follow the [CxrReportGen Premium training data requirements](/models/fine-tune-cxrreportgen-premium#training-data-format)
or [MedImageInsight Premium training data requirements](/models/fine-tune-medimageinsight-premium#training-data-format)
...
[Upload file REST API reference](https://learn.microsoft.com/rest/api/azureopenai/files/upload).
To import a file from Azure Blob Storage or a web location instead of
uploading it directly, see the
[Import file REST API reference](https://learn.microsoft.com/rest/api/azureopenai/files/import).
For files that are 512 MB or larger, use the multipart
[Uploads API](https://learn.microsoft.com/rest/api/azureopenai/upload-file) instead.
...
[CxrReportGen Premium hyperparameters](/models/fine-tune-cxrreportgen-premium#hyperparameters)
or
[MedImageInsight Premium hyperparameters](/models/fine-tune-medimageinsight-premium#hyperparameters)
for the model you selected.
...
[Fine-tuning REST API reference](https://learn.microsoft.com/rest/api/microsoft-foundry/azureopenai/fine-tuning).
...
[Evaluate CxrReportGen Premium](/models/fine-tune-cxrreportgen-premium#evaluate-the-fine-tuned-model)
and
[Evaluate MedImageInsight Premium](/models/fine-tune-medimageinsight-premium#evaluate-the-fine-tuned-model).

## Troubleshooting

| Error | Condition | Fix |
|---|---|---|
| File rejected — *"The maximum allowed size is 512 MB"* | Direct Files API operations require files smaller than 512 MB. | Reduce the file size to less than 512 MB, or use the multipart [Uploads API](https://learn.microsoft.com/azure/ai-foundry/openai/authoring-reference-preview#upload-file---start) for files up to 9 GB. |
...
- To delete the fine-tuned deployment, see
  [az cognitiveservices account deployment delete](https://learn.microsoft.com/cli/azure/cognitiveservices/account/deployment).
- To delete an uploaded file, see the
  [Delete file REST API reference](https://learn.microsoft.com/rest/api/azureopenai/files/delete).
...
- [Fine-tune CxrReportGen Premium](/models/fine-tune-cxrreportgen-premium)
- [Fine-tune MedImageInsight Premium](/models/fine-tune-medimageinsight-premium)
