...
- **Role-based access control (RBAC):** One or both of the following roles at the subscription or resource group scope:
  ...
  - [**Foundry User**](../concepts/rbac-foundry#built-in-roles) – View Foundry resource data and usage context.
...
- **Region and model availability check:** Confirm required model and feature availability in your target regions before deployment. For details, see [Feature availability across cloud regions](/models/region-support).
...
If you need to grant these roles to team members, see [Assign access to Cost Management data](https://learn.microsoft.com/azure/cost-management-billing/costs/assign-access-acm-data) and [Foundry RBAC roles](../concepts/rbac-foundry).
...
- **View Foundry resources and related usage context:** [Foundry User](../concepts/rbac-foundry#built-in-roles).
...
1. Required models and services are available in your target regions. See [Feature availability across cloud regions](/models/region-support).
...
For Azure OpenAI models with short-context and long-context pricing categories, see [Short context and long context](/models/models-sold-directly-by-azure) to understand how input length differs from the model's total context window.
...
Fine-tuned deployments incur hosting charges while deployed, even during low usage periods. Remove or scale down deployments that you don't need. For details on deployment lifecycle and cleanup policies, see the [fine-tuning documentation](/models/fine-tuning).
...
This custom role example doesn't grant access to Foundry resources by itself. Assign an additional role such as [Foundry User](../concepts/rbac-foundry#built-in-roles) if users also need Foundry resource visibility.
...
Estimates do not reflect discounts or contracted pricing that may appear on your final bill. Estimates cover standard deployment costs only, not [provisioned throughput](/models/provisioned-throughput).
...
<Frame>
  <img src="/images/agent-costs.png" alt="Screenshot of the Agents tab under Assets, showing the Estimated costs column with monthly cost estimates for each agent based on configuration and usage." />
</Frame>
...
**Reference:** [Agent concepts](/agents/development-lifecycle)

<Frame>
  <img src="/images/agent-list.png" alt="Screenshot of the Agents tab showing a list of agents with columns for Name, Status, and Estimated costs. The Estimated costs column displays monthly values." />
</Frame>
...
**Reference:** [Monitor agent metrics](/agents/how-to-monitor-agents-dashboard)

<Frame>
  <img src="/images/agent-build-cost.png" alt="Screenshot of the Monitor tab for an agent, showing operational metrics including total token cost, token usage, average inference latency, agent runs chart, and runs and token metrics." />
</Frame>
...
**Reference:** [Monitor models](/observability/monitor-models)

<Frame>
  <img src="/images/model-costs.png" alt="Screenshot of Azure portal showing the Monitor tab with total cost and estimated cost chart for a selected model and date range." />
</Frame>
...
<Frame>
<img src="/images/cost-overview-deployment-tags.png" alt="Screenshot of cost overview showing deployment-level tags filter." />
</Frame>

1. Select **Costs by resource** > **Resources** to see your Foundry resource cost split across model deployments:

<Frame>
<img src="/images/azure-foundry-cost-split.png" alt="Screenshot of split of Foundry resource cost across model deployments." />
</Frame>
...
<Frame>
<img src="/images/cost-by-meter.png" alt="Screenshot of how to see the cost by each meter in the resource group." />
</Frame>
...
<Frame>
  <img src="/images/cost-by-meter-1p.png" alt="Screenshot of cost analysis dashboard scoped to the resource group where the Foundry resource is deployed, highlighting the meters for Azure OpenAI and Phi models. Cost is group by meter." />
</Frame>
...
<Frame>
<img src="/images/cost-by-resource.png" alt="Screenshot of how to see the cost by each resource in the resource group." />
</Frame>
...
<Frame>
<img src="/images/cost-by-resource-saas.png" alt="Screenshot of cost analysis dashboard scoped to the resource group where the Foundry resource is deployed, highlighting the meters for models billed throughout Azure Marketplace. Cost is group by resource." />
</Frame>
...
<Frame>
<img src="/images/cost-analysis-project-tag.png" alt="Screenshot of Cost Management Cost analysis view filtered by the project tag, showing accumulated cost over time for a selected Foundry project." />
</Frame>
...
<Frame>
  <img src="/images/cost-analyzer.png" alt="Screenshot of cost analysis dashboard showing how to access accumulated costs." />
</Frame>

The cost analysis dashboard shows the accumulated costs that are analyzed depending on what you specified for **Scope**.

<Frame>
  <img src="/images/subscription.png" alt="Screenshot of cost analysis dashboard with scope set to subscription." />
</Frame>
...
<Frame>
  <img src="/images/service-tier.png" alt="Screenshot of cost analysis dashboard with service tier highlighted." />
</Frame>
