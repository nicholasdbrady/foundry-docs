...
- Quota available in the target region for the model you want to deploy. To check or request quota, see [Manage Azure OpenAI in Microsoft Foundry Models quota](/models/quota).
...
- The model name and version that you want to deploy. For supported models, see [Azure OpenAI models](/models/models-sold-directly-by-azure).
...
- [Manage Azure OpenAI in Microsoft Foundry Models quota](/models/quota)
- [Azure OpenAI quotas and limits](/models/quotas-limits)
