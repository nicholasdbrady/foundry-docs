...
In this quickstart, you transcribe speech to text by using the [OpenAI transcription model](../../../ai-services/speech-service/transcribe-overview). The transcription model can transcribe human speech in numerous languages and translate other languages into English.
...
The file size limit for the transcription model is 25 MB. If you need to transcribe a file larger than 25 MB, you can use the Azure Speech in Foundry Tools [batch transcription](../../../ai-services/speech-service/batch-transcription-create#use-a-whisper-model) API.
