...
Reference: [Use the Azure OpenAI Responses API](/models/responses) | [OpenAI Python SDK](https://github.com/openai/openai-python) | [OpenAI Node SDK](https://github.com/openai/openai-node) | [OpenAI Java SDK](https://github.com/openai/openai-java)
...
- [Use skills with the Responses API](/models/skills)
