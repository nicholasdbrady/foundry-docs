...
For multi-agent workflows, inject developer-defined function outputs into the active response so the waiting agent can resume while other agents continue. See [Use multi-agent orchestration with the Azure OpenAI Responses API](/models/responses-multi-agent#choose-http-or-websocket-mode).
...
<Card title="Use the Azure OpenAI Responses API" icon="arrow-right" href="../how-to/responses.md" />
