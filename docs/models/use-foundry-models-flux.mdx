...
- A [Microsoft Foundry project](../../how-to/create-projects). FLUX models are available for global standard deployment in all regions.
...
FLUX models are available for [global standard deployment](/models/deployment-types#global-standard) in all regions. To deploy a FLUX model, follow the instructions in [Deploy Microsoft Foundry Models in the Foundry portal](/models/deploy-foundry-models).
...
- [Models sold by Azure](/models/models-sold-directly-by-azure)
