...
sidebarTitle: "Deploy and use Claude models in Microsoft Foundry"
---
...
- A [Microsoft Foundry project](/setup/create-projects) created in one of the supported regions: **East US2** or **Sweden Central**.
- [Foundry Models from partners and community](/models/catalog/models-from-partners) require access to **Azure Marketplace** to create subscriptions. Ensure that you have the [permissions required to subscribe to model offerings](/models/catalog/configure-marketplace).
...
Claude models in Foundry are available for [global standard deployment](/models/capabilities/deployment-types#global-standard). To deploy a Claude model, follow the instructions in [Deploy Microsoft Foundry Models in the Foundry portal](/models/capabilities/deploy-foundry-models).

After deployment, use the [Foundry playground](/models/capabilities/concept-playgrounds) to interactively test the model.
...
For more details about the model capabilities, see [capabilities of Claude models](/models/catalog/models-from-partners#anthropic).
...
|:------------------|:----------------|:--------------|:--------------|:-----------|:-----------|
| claude-opus-4-6   | [Global Standard](/models/capabilities/deployment-types#global-standard)  | 0        | 0    | 2,000      | 2,000,000     |
...
- [Data, privacy, and security for Claude models in Microsoft Foundry (preview)](/security/data-privacy)
