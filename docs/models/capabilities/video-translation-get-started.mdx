...
1. Enter and search for "Azure-AI-Speech" in the catalog search box.
   ...
   ![Screenshot of the model catalog in Microsoft Foundry portal.](/images/search-model-catalog.png)
...
1. Select **Speech capabilities by scenario** > **Video translation**.
   ...
   ![Screenshot of filtering Speech service capabilities by scenario.](/images/capabilities-by-scenario.png)
...
1. Select the **Play** button to hear the translated audio. Select the original video tab to play the original audio.
   ...
   ![Screenshot that shows selecting a voice type on the new project page.](/images/compare-original-translated.png)
...
1. Select **My videos** > **Upload video**.
   ...
   ![Screenshot of selecting the upload video button.](/images/select-upload-video.png)

1. On the **Upload video** page, select a **Voice type**. 

   ![Screenshot of selecting a voice type on the new project page.](/images/select-voice-type.png)
...
1. Select **Next: Advanced settings** if you want to adjust the advanced settings. 
    ...
    ![Screenshot of providing video information on the new project page.](/images/provide-video-information.png)
...
1. Optionally, you can adjust the following settings:
    ...
    ![Screenshot of providing lexicon and subtitle information while creating a new project.](/images/provide-video-information-advanced.png)
...
![Screenshot of selecting a successfully translated video.](/images/select-succeeded-video.png)
...
![Screenshot of reviewing details of the translated video.](/images/compare-original-translated-custom.png)
...
![Screenshot of one segment with unidentified voice name.](/images/voice-unidentified.png)
...
![Screenshot of adjusting voice settings on the voice settings page.](/images/voice-settings.png)

You can make multiple changes to the video, including adjusting the voice settings, adding or removing segments, and changing the time frame of the scripts. You're only charged after you select **Apply changes** to apply your changes. You can select **Save** to save work in progress without incurring any charges.

![Screenshot of selecting apply changes button after making all changes.](/images/apply-changes.png)
