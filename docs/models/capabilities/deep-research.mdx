...
- At least one data source configured in your request:
  - `web_search_preview` (see [Web search (preview)](/models/capabilities/web-search)), and/or
...
<Card title="Use the Azure OpenAI Responses API" icon="arrow-right" href="responses.md" />
<Card title="Web search (preview)" icon="arrow-right" href="web-search.md" />
