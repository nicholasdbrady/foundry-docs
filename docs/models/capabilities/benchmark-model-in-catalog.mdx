...
![Screenshot showing the compare model experience in Microsoft Foundry.](/images/compare-model-overview.png)
...
- **Metric comparison table**: This table presents detailed results for each metric.
    ...
    ![Screenshot showing the metric comparison table on the benchmarks tab.](/images/benchmark-overview.png)
