...
<Note>
For [Foundry Models sold directly by Azure](/models/catalog/models-sold-directly-by-azure), such as the Azure OpenAI model `gpt-4o-mini`, you don't subscribe to Azure Marketplace.
</Note>
...
<Tip>
Each model supports different deployment types, providing different data residency or throughput guarantees. See [deployment types](/models/capabilities/deployment-types) for more details. In this example, the model supports the Global Standard deployment type.
</Tip>
