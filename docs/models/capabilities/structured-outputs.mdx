...
sidebarTitle: "How to use structured outputs with Azure OpenAI in Microsoft Foundry Models"
---
# Structured outputs
...
- [Assistants](../how-to/assistant.md) or [Foundry Agents Service](/agents/development/overview).
