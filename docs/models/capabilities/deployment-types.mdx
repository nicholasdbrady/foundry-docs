...
![Screenshot of the Foundry portal deployment dialog showing the deployment type selection box with Global Standard selected.](/images/models-deploy-deployment-type.png)
