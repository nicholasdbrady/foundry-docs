...
![Screenshot showing how to enable priority processing during model deployment in the Foundry portal.](/images/enable-priority-processing-foundry.png)
...
![Screenshot of the priority processing utilization on the resource's metrics page in the Azure portal.](/images/azure-monitor-priority-processsing-utilization.png)
...
![Screenshot of the priority processing utilization on the resource's cost analysis page in the Azure portal.](/images/cost-analysis-priority-processing.png)
