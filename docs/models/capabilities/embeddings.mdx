...
![Screenshot of the initial DataFrame table results from the csv file.](/images/initial-dataframe.png)
...
![Screenshot of the smaller DataFrame table results with only text, summary, and title columns displayed.](/images/cleanup-dataframe.png)
...
![Screenshot of the DataFrame with a new column called n_tokens.](/images/tokens-dataframe.png)
...
![Screenshot of the formatted results from df_bills command.](/images/embed-text-documents.png)
...
![Screenshot of the formatted results of res once the search query has been run.](/images/query-result.png)
...
[Azure OpenAI models](/models/catalog/models-sold-directly-by-azure)
