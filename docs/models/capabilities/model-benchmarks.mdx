...
Performance metrics are aggregated over 14 days using 24 trials per day, with two requests per trial sent at one-hour intervals. Unless otherwise noted, the following default parameters apply to both [serverless API deployments](../../foundry-classic/concepts/foundry-models-overview.md) and [Azure OpenAI](https://learn.microsoft.com/azure/ai-foundry/openai/overview):

| Parameter | Value | Applicable for |
|--|--|--|
| Region | East US/East US2 | [serverless API deployments](../../foundry-classic/concepts/foundry-models-overview.md) and [Azure OpenAI](https://learn.microsoft.com/azure/ai-foundry/openai/overview) |
