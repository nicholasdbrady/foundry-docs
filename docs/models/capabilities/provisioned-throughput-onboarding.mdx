...
![Diagram of model independent quota with one pool of PTUs available to multiple Azure OpenAI models.](/images/model-independent-quota.png)
...
![A diagram showing hourly billing.](/images/hourly-billing.png)
