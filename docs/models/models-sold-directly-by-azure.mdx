...
| [GPT-5.5 series](/models/models-sold-directly-by-azure#gpt-55) | **NEW** `gpt-5.5` |
...
Other deployment categories like *batch* are also available. To learn about all available model deployment types, see  [Deployment types for Microsoft Foundry Models](/models/deployment-types).
