...
Before you run the examples in this article, confirm that your resource region supports the Responses API. The v1 API is required to access the latest features — for details, see the [API version lifecycle](../api-version-lifecycle). The Responses API is currently available in the following regions:
...
Not every model is available in every supported region. Check the [models page](/models/models-sold-directly-by-azure) for model region availability. For the full set of request and response parameters, see the [Responses API reference documentation](https://learn.microsoft.com/rest/api/microsoft-foundry/azureopenai/responses).
...
- [Azure OpenAI REST API reference](https://learn.microsoft.com/rest/api/microsoft-foundry/azureopenai/responses)
