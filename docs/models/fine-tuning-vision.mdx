...
- Familiarity with the [fine-tuning workflow](/models/fine-tuning). Vision fine-tuning follows the same process with image-specific data formatting.
- Fine-tuning access for the supported models in a [supported region](/models/models-sold-directly-by-azure).
...
|-------|--------|--------|
| `gpt-4o` | `2024-08-06` | [Supported regions](/models/models-sold-directly-by-azure). |
| `gpt-4.1` | `2025-04-14` | [Supported regions](/models/models-sold-directly-by-azure). |
...
For detailed steps, see [Fine-tune an Azure OpenAI model](/models/fine-tuning).
...
- [Fine-tune a model](/models/fine-tuning) — Complete fine-tuning workflow including upload, training, and monitoring.
- [Deploy a fine-tuned model](/models/fine-tuning-deploy) — Deploy your customized model for inference.
- [Fine-tuning model regional availability](/models/models-sold-directly-by-azure) — Check which regions support vision fine-tuning.
- [Model quotas and limits](/models/quotas-limits) — Review rate limits and quotas for fine-tuned models.
