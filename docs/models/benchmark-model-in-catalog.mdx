...
- At least **Reader** role on the Foundry project. For more information, see [Role-based access control in Foundry](../concepts/rbac-foundry).
...
1. Sort on different metrics — [quality](/models/model-benchmarks#quality-benchmarks-of-language-models), [safety](/models/model-benchmarks#safety-benchmarks-of-language-models), [estimated cost](/models/model-benchmarks#cost-benchmarks-of-language-models), and [throughput](/models/model-benchmarks#performance-benchmarks-of-language-models) — to view the top models for each criterion. Select any model to go to its detail page, or select **Go to leaderboard** to view the full list. The model detail page shows the model's overview, benchmarks, and deployment options.
...
The **Try with your own data** option on the benchmarks tab is available only in Foundry (classic). To evaluate a model with your own data in the new portal, see [Evaluate generative AI apps](/evaluation/evaluate-generative-ai-app).
...
| Benchmark scores differ from my results | Public benchmarks use standardized datasets and might not reflect performance on your specific data. To evaluate a model with your own data, see [Evaluate generative AI apps](/evaluation/evaluate-generative-ai-app). |
...
- [Model leaderboards in Foundry portal](/models/model-benchmarks) - Learn about the benchmarks, datasets, and metrics behind the leaderboard scores.
- [Run evaluations from the Foundry portal](/evaluation/evaluate-generative-ai-app) - Run evaluations on your own data to measure model performance for your scenario.
- [See Evaluation Results in Foundry portal](/evaluation/evaluate-results) - Interpret and compare evaluation results across runs.
