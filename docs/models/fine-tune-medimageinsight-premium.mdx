...
sidebarTitle: "Fine-tune MedImageInsight Premium in Microsoft Foundry"
---
...
[Prepare your data](/models/fine-tune-premium-healthcare-models#prepare-your-data).
...
[Deploy the fine-tuned model](/models/fine-tune-premium-healthcare-models#deploy-the-fine-tuned-model)
on the hub.
...
- [Deploy and use MedImageInsight Premium](/models/deploy-medimageinsight-premium)
- [Healthcare AI examples (GitHub)](https://aka.ms/HealthcareAIExamples)
