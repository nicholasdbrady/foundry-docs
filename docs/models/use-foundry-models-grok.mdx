---
title: "Deploy and use Grok models in Microsoft Foundry"
...
- A [Microsoft Foundry project](../../how-to/create-projects) in a region supported for Grok 4.6 (preview) deployment. For more information, see [Supported deployment types and regions](#supported-deployment-types-and-regions).
- The **Cognitive Services Contributor** role on the Foundry resource, to deploy models. For more information, see [Azure RBAC roles](https://learn.microsoft.com/azure/role-based-access-control/built-in-roles).
...
This article focuses on `grok-4.6`. For full capability details on all Grok models, see [SpaceXAI models sold by Azure](/models/models-sold-directly-by-azure#spacexai-models-sold-by-azure).

## Deploy Grok 4.6

To deploy Grok 4.6 (preview), follow the instructions in [Deploy Microsoft Foundry Models in the Foundry portal](/models/deploy-foundry-models), and select the `grok-4.6` model to deploy.
...
**Reference:** [az cognitiveservices account deployment create](https://learn.microsoft.com/cli/azure/cognitiveservices/account/deployment#az-cognitiveservices-account-deployment-create)

For more on the CLI deployment workflow, see [Add and configure models to Foundry Models](/models/create-model-deployments).
...
Grok 4.6 (preview) also supports the [Responses API](/models/generate-responses), which offers a simplified interface for stateful, multi-turn interactions and built-in tool orchestration.
...
For more information about the Responses API, see [Use the Azure OpenAI Responses API](/models/responses). For more information about Chat Completions API, see [Work with chat completion models](/models/chatgpt).
...
Grok 4.6 supports **Global Standard deployment** type in all regions. For supported deployment regions, see [Region availability for Foundry Models sold by Azure](/models/models-sold-directly-by-azure-region-availability).
...
You can request more quota if needed. For more information, see [Request increases to the default limits](/models/quotas-limits#request-increases-to-the-default-limits).
...
- [Microsoft Foundry REST Reference - Azure OpenAI Responses](https://learn.microsoft.com/rest/api/microsoft-foundry/azureopenai/responses)
- [Microsoft Foundry REST Reference - Azure OpenAI Chat](https://learn.microsoft.com/rest/api/microsoft-foundry/azureopenai/chat)
...
- [Configure Microsoft Entra ID authentication](../how-to/configure-entra-id)
