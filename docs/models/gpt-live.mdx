...
sidebarTitle: "Use GPT-Live for real-time voice"
---

This article shows how to connect to GPT-Live over WebSocket, configure a session, stream audio, and read the events GPT-Live returns. For an overview of GPT-Live and its capabilities, see [What is GPT-Live?](/models/gpt-live)

## Prerequisites

- An Azure subscription - [Create one for free](https://azure.microsoft.com/pricing/purchase-options/azure-account?cid=msft_learn).
- A Microsoft Foundry resource - [Create a Microsoft Foundry resource](https://learn.microsoft.com/azure/ai-services/multi-service-resource).
- An API key or Microsoft Entra ID credentials for authentication. For production applications, use [Microsoft Entra ID](https://learn.microsoft.com/en-us/azure/foundry-classic/openai/how-to/managed-identity) for enhanced security.
...
| `delegation` | Either `{ type: "client" }` or `{ type: "responses", responses: {...} }`. Omitting this field or setting it to `null` selects client delegation. See [Delegate work in GPT-Live](/models/gpt-live-delegation). |
...
- [Delegate work in GPT-Live](/models/gpt-live-delegation)
- [Use GPT-Live via WebRTC](/models/gpt-live-webrtc)
- [GPT-Live event API reference](../gpt-live-reference)
