...
If you want broader prompt guidance (few-shot examples, ordering, and token efficiency), see [Prompt engineering techniques](/models/prompt-engineering).
...
For guidance and templates designed for safety, see [Safety system messages](../concepts/system-message) and [Safety system message templates](../concepts/safety-system-message-templates).
...
If you’re tuning prompts as part of an evaluation workflow, you can also use the broader guidance in [Prompt engineering techniques](/models/prompt-engineering).
...
- For broader prompt patterns, see [Prompt engineering techniques](/models/prompt-engineering).
- If you need safety-focused frameworks, see [Safety system messages](../concepts/system-message).
- For a ready-made baseline, see [Safety system message templates](../concepts/safety-system-message-templates).
