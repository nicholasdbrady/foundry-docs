...
- A [Microsoft Foundry project](../../how-to/create-projects). MAI image models are available for **global standard deployment** (West Central US, East US, West US, West Europe, Sweden Central, South India, and UAE North).
