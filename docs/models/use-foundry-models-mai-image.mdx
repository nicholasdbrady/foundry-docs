...
- A [Microsoft Foundry project](../../how-to/create-projects). MAI image models are available for **global standard deployment** in West Central US, East US, West US, West Europe, Sweden Central, South India, and UAE North.
...
For more details about the model capabilities, see capabilities of Microsoft models in [Foundry Models sold by Azure](/models/models-sold-directly-by-azure).
