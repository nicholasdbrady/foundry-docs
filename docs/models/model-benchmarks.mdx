...
To get started, [compare and select models using the model leaderboard](/models/benchmark-model-in-catalog) in Foundry portal.
...
Leaderboard benchmarks provide standardized comparisons across models using public datasets. To evaluate model performance on your specific data and use case, see [Evaluate your generative AI apps](/evaluation/evaluate-generative-ai-app).
...
- [Compare and select models using the model leaderboard in Foundry portal](/models/benchmark-model-in-catalog)
- [Evaluate your generative AI apps](/evaluation/evaluate-generative-ai-app)
