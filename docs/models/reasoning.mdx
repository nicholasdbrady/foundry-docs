...
- If you use the REST examples:
  - Install the Azure CLI. For more information, see [Install the Azure CLI](https://learn.microsoft.com/cli/azure/install-azure-cli).
...
<Frame>
  <img src="/images/reasoning-context-modes.svg" alt="Diagram showing that current_turn drops earlier reasoning, while all_turns carries compatible reasoning across three turns." />
</Frame>
...
Capping output addresses only half of a multi-turn workload. Reasoning models also resend a growing conversation on every turn, and `all_turns` adds earlier reasoning items on top of that. To reduce what you pay for those repeated input tokens, see [Prompt caching](/models/prompt-caching).
...
<Tabs>
  ...
  <Tab title="Python">
    ...
    **Microsoft Entra ID:**
    ...
    If you're new to using Microsoft Entra ID for authentication see [How to configure Azure OpenAI with Microsoft Entra ID authentication](https://learn.microsoft.com/en-us/azure/foundry-classic/openai/how-to/managed-identity).
...
Use the [Responses API](/models/responses) when you combine reasoning with function or custom tools.
...
When using the latest reasoning models with the [Responses API](/models/responses) you can use the reasoning summary parameter to receive summaries of the model's chain of thought reasoning. 

The `reasoning.summary` parameter isn't supported when [multi-agent orchestration](/models/responses-multi-agent) is enabled.
...
For more information about encrypted reasoning items, see [Encrypted reasoning items](/models/responses#encrypted-reasoning-items).
...
| --- | --- | --- |
| `gpt-6-astra` | [Model availability](/models/models-sold-directly-by-azure-region-availability) | No access request needed. Quota request required depending on [quota tier](/models/quotas-limits). Tier 5 and Tier 6 subscriptions have quota by default. |
| `gpt-6-sol` | [Model availability](/models/models-sold-directly-by-azure-region-availability) | No access request needed. |
| `gpt-6-luna` | [Model availability](/models/models-sold-directly-by-azure-region-availability) | No access request needed. |
| `gpt-5.6-sol` | [Model availability](/models/models-sold-directly-by-azure-region-availability) | No access request needed. Quota request required depending on [quota tier](/models/quotas-limits). Tier 5 and Tier 6 subscriptions have quota by default. |
| `gpt-5.6-terra` | [Model availability](/models/models-sold-directly-by-azure-region-availability) | No access request needed. Quota request required depending on [quota tier](/models/quotas-limits). Tier 5 and Tier 6 subscriptions have quota by default. |
| `gpt-5.6-luna` | [Model availability](/models/models-sold-directly-by-azure-region-availability) | No access request needed. Quota request required depending on [quota tier](/models/quotas-limits). Tier 5 and Tier 6 subscriptions have quota by default. |
| `gpt-chat-latest` | [Model availability](/models/models-sold-directly-by-azure-region-availability) | No access request needed. |
| `gpt-5.5` | [Model availability](/models/models-sold-directly-by-azure-region-availability) | No access request needed. Quota request required depending on [quota tier](/models/quotas-limits). Tier 5 and Tier 6 subscriptions have quota by default. |
| `gpt-5.4-mini` | [Model availability](/models/models-sold-directly-by-azure-region-availability) | No access request needed. |
| `gpt-5.4-nano` | [Model availability](/models/models-sold-directly-by-azure-region-availability) | No access request needed. |
| `gpt-5.4-pro` | [Model availability](/models/models-sold-directly-by-azure-region-availability) | Access is no longer restricted for this model. |
| `gpt-5.4` | [Model availability](/models/models-sold-directly-by-azure-region-availability) | Access is no longer restricted for this model. |
| `gpt-5.3-codex` | [Model availability](/models/models-sold-directly-by-azure-region-availability) | Access is no longer restricted for this model. |
| `gpt-5.2-codex` | [Model availability](/models/models-sold-directly-by-azure-region-availability) | Access is no longer restricted for this model. |
| `gpt-5.2` | [Model availability](/models/models-sold-directly-by-azure-region-availability) | Access is no longer restricted for this model. |
| `gpt-5.1-codex-max` | [Model availability](/models/models-sold-directly-by-azure-region-availability) | Access is no longer restricted for this model. |
| `gpt-5.1` | [Model availability](/models/models-sold-directly-by-azure-region-availability) | Access is no longer restricted for this model. |
| `gpt-5.1-chat` | [Model availability](/models/models-sold-directly-by-azure-region-availability) | No access request needed. |
| `gpt-5.1-codex` | [Model availability](/models/models-sold-directly-by-azure-region-availability) | Access is no longer restricted for this model. |
| `gpt-5.1-codex-mini` | [Model availability](/models/models-sold-directly-by-azure-region-availability) | No access request needed. | 
| `gpt-5-pro` | [Model availability](/models/models-sold-directly-by-azure-region-availability) | Access is no longer restricted for this model. |
| `gpt-5-codex` | [Model availability](/models/models-sold-directly-by-azure-region-availability) | Access is no longer restricted for this model. |
| `gpt-5` | [Model availability](/models/models-sold-directly-by-azure-region-availability) | Access is no longer restricted for this model. |
| `gpt-5-mini` | [Model availability](/models/models-sold-directly-by-azure-region-availability) | No access request needed. |
| `gpt-5-nano` | [Model availability](/models/models-sold-directly-by-azure-region-availability) | No access request needed. |
| `o3-pro` | [Model availability](/models/models-sold-directly-by-azure-region-availability) | Access is no longer restricted for this model. |
| `codex-mini` | [Model availability](/models/models-sold-directly-by-azure-region-availability) | No access request needed. |
| `o4-mini` | [Model availability](/models/models-sold-directly-by-azure-region-availability) | Access is no longer restricted for this model. |
| `o3` | [Model availability](/models/models-sold-directly-by-azure-region-availability) | Access is no longer restricted for this model. |
| `o3-mini` | [Model availability](/models/models-sold-directly-by-azure-region-availability) | Access is no longer restricted for this model. |
| `o1` | [Model availability](/models/models-sold-directly-by-azure-region-availability) | Access is no longer restricted for this model. |

## API and feature support

Input and output limits share the available context budget and aren't additive. For details and a GPT-5.5 calculation example, see [Understand model token limits](/models/models-sold-directly-by-azure) and [Responses API token budget](/models/models-sold-directly-by-azure).

<Tabs>
  <Tab title="GPT-6 reasoning models">

    | **Feature** | **gpt-6-astra**, **2026-09-03** | **gpt-6-sol**, **2026-09-22** | **gpt-6-luna**, **2026-09-22** |
    | --- | --- | --- | --- |
    | **[Structured outputs](/models/structured-outputs)** | ✅ | ✅ | ✅ |
  ...
  <Tab title="GPT-5 reasoning models">
    ...
    | **[Structured Outputs](/models/structured-outputs)** | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ |✅ | ✅ | ✅ | ✅ | ✅ | ✅| ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ |
    | **[Context Window](/models/models-sold-directly-by-azure#o-series-models)** | 1,050,000<br /><br />Input:<br />922,000<br />Output:<br />128,000 | 1,050,000<br /><br />Input:<br />922,000<br />Output:<br />128,000 | 1,050,000<br /><br />Input:<br />922,000<br />Output:<br />128,000 | 1,050,000<br /><br />Input:<br />922,000<br />Output:<br />128,000 | 400,000 <br /><br />Input: 272,000 <br /> Output: 128,000 <br />| 400,000 <br /><br />Input: 272,000 <br /> Output: 128,000 <br />| 1,050,000<br /><br />Input:<br />922,000<br />Output:<br />128,000 | 1,050,000 <br /><br />Input:<br />922,000<br />Output:<br />128,000  | 400,000 <br /><br />Input: 272,000 <br /> Output: 128,000  | 400,000 <br /><br />Input: 272,000 <br /> Output: 128,000 | 400,000 <br /><br />Input: 272,000 <br /> Output: 128,000 | 400,000 <br /><br />Input: 272,000 <br /> Output: 128,000 | 400,000 <br /><br />Input: 272,000 <br /> Output: 128,000 | 128,000 <br /><br />Input: 111,616 <br /> Output: 16,384 | 400,000 <br /><br />Input: 272,000 <br /> Output: 128,000 | 400,000 <br /><br />Input: 272,000 <br /> Output: 128,000 | 400,000 <br /><br />Input: 272,000 <br /> Output: 128,000 | 400,000 <br /><br />Input: 272,000 <br /> Output: 128,000 | 400,000 <br /><br />Input: 272,000 <br /> Output: 128,000 | 400,000 <br /><br /> Input: 272,000 <br /> Output: 128,000 |  400,000 <br /><br /> Input: 272,000 <br /> Output: 128,000 |
    | **[Reasoning effort](#reasoning-effort)**<sup>7</sup> | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅  | ✅ | ✅ | ✅ | ✅| ✅<sup>6</sup> | ✅<sup>4</sup> | ✅  | ✅  | ✅  | ✅<sup>5</sup>| ✅| ✅| ✅|✅|
    | **[Image input](/models/gpt-with-vision)** | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅| ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ |
  ...
  <Tab title="O-Series Reasoning Models">

    | **Feature**  | **codex-mini**, **2025-05-16**  | **o3-pro**, **2025-06-10**   | **o4-mini**, **2025-04-16**  | **o3**, **2025-04-16** | **o3-mini**, **2025-01-31**  |**o1**, **2024-12-17**   |  
    |:-------------------|:--------------------------:|:------:|:--------|:-----:|:-------:|:--------------------------:|
    | **[Developer Messages](#developer-messages)** | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ |
    | **[Structured Outputs](/models/structured-outputs)** | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ |
    | **[Context Window](/models/models-sold-directly-by-azure#o-series-models)** |  Input: 200,000 <br /> Output: 100,000 | Input: 200,000 <br /> Output: 100,000 | Input: 200,000 <br /> Output: 100,000 | Input: 200,000 <br /> Output: 100,000 | Input: 200,000 <br /> Output: 100,000 | Input: 200,000 <br /> Output: 100,000  | 
...
- To avoid timeouts [background mode](/models/responses#background-tasks) is recommended for `o3-pro`.
