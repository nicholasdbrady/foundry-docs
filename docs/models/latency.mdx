...
For the complete metrics catalog, including dimensions and aggregation guidance, see [Azure OpenAI monitoring data reference](../monitor-openai-reference).
...
For the full list of monitoring metrics, dimensions, and resource logs, see [Azure OpenAI monitoring data reference](../monitor-openai-reference).

## Summary

- **Model latency**: If model latency is important to you, we recommend trying out the [GPT-4o mini model](/models/models-sold-directly-by-azure).
