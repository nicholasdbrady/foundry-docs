...
The following upgrade guidance only applies to Standard deployment types. For guidance on updating or migrating provisioned deployment types, review the [model management documentation](/models/working-with-models).
...
* Read [what's new](https://learn.microsoft.com/en-us/azure/foundry-classic/openai/whats-new) and [models](/models/models-sold-directly-by-azure) to understand the changes and new features.
* Read the documentation on [Deploy Foundry Models](/models/deploy-foundry-models) and [version upgrades](/models/working-with-models) to understand how to work with model versions.
...
Azure notifies you of upcoming retirements through email to subscription owners and contributors, Azure Service Health alerts, and the upcoming retirement tables in [Foundry Models lifecycle and support policy in Azure Government](/models/model-retirements-gov). 

## Related content

- [Foundry Models sold by Azure in Azure Government](/models/models-sold-directly-by-azure-gov)
- [Foundry Models lifecycle and support policy in Azure Government](/models/model-retirements-gov)
- [Deploy Foundry Models](/models/deploy-foundry-models)
- [Deployment types in Foundry Models in Azure Government](/models/deployment-types-gov)
