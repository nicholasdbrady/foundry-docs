...
- A model router deployment. To create one, see [Use model router](/models/model-router#deploy-a-model-router-model).
...
| --- | --- |
| Quality falls below workload requirements | Try [Quality mode](/models/model-router#optional-change-the-routing-mode) or constrain the [model subset](/models/model-router#optional-route-to-a-model-subset). |
