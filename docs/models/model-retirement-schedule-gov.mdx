...
This article lists the retirement schedule for Foundry Models in Azure Government — their current lifecycle stage, retirement date, and suggested replacement. Use it to plan migrations before a model is deprecated or retired. For details on what each lifecycle stage means and how notifications work, see [Microsoft Foundry Models lifecycle and support policy in Azure Government](/models/model-retirements-gov).
...
- [Microsoft Foundry Models lifecycle and support policy in Azure Government](/models/model-retirements-gov)
