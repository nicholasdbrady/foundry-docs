...
This article focuses on where there are differences from Commercial for Azure Government. For general information, see [Foundry Models lifecycle and support policy](/models/model-retirements). 
...
For a full comparison of deployment types, see [Deployment type comparison](/models/deployment-types-gov).
...
- The upgrade schedule is published in advance in the [Model Retirement Schedule](/models/model-retirements-gov).
...
- [Model Retirement Schedule in Azure Government](/models/model-retirements-gov) for specific dates for all current, deprecated, and retired models
...
- [Model versions in Microsoft Foundry Models in Azure Government](/models/model-versions-gov) for how version upgrades work
