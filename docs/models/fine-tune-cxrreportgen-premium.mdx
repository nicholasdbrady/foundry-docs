...
sidebarTitle: "Fine-tune CxrReportGen Premium in Microsoft Foundry"
---
...
see [Customize a premium healthcare AI model with fine-tuning](/models/fine-tune-premium-healthcare-models).
...
[Prepare your data](/models/fine-tune-premium-healthcare-models#prepare-your-data). This article defines the
...
limits, see
[Prepare your data](/models/fine-tune-premium-healthcare-models#prepare-your-data) in the fine-tuning
workflow hub.
...
[Create the fine-tuning job](/models/fine-tune-premium-healthcare-models#create-the-fine-tuning-job)
...
[Deploy the fine-tuned model](/models/fine-tune-premium-healthcare-models#deploy-the-fine-tuned-model) in
...
- [Deploy and use CxrReportGen Premium](/models/deploy-cxrreportgen-premium)
