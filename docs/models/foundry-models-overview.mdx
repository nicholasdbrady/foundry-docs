...
You don't always need to create a deployment. With [instant access (preview)](/models/instant-models), you call supported models by name and start running inference immediately — no deployment required.

</Tip>

The model catalog offers two distinct options to deploy models for your use: managed compute and serverless deployments. To learn about the deployment options, see [Deployment overview for Microsoft Foundry Models](/models/deployments-overview). To learn how Foundry handles the data you provide to Foundry Models sold by Azure, see [Data, privacy, and security for Models sold by Azure in Microsoft Foundry](/models/data-privacy).
...
Suppose you decide to use an API other than the [Azure OpenAI SDK with the Azure OpenAI v1 APIs](/models/supported-languages) to work with a model that's deployed via a serverless API. In such a situation, content filtering isn't enabled unless you implement it separately by using Azure AI Content Safety.
...
- [Region availability for Foundry Models sold by Azure](/models/models-sold-directly-by-azure-region-availability)
- [Region availability for Foundry Models from partners and community](/models/models-from-partners#region-availability-by-deployment-type)
...
- [Retired Foundry Models](/models/retired-models)
 
## Related content

- [Instant access to models in Microsoft Foundry (preview)](/models/instant-models)
- [Data, privacy, and security for Models sold by Azure in Microsoft Foundry](/models/data-privacy)
