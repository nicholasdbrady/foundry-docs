...
- Reference: [`AIProjectClient.get_openai_client`](https://learn.microsoft.com/python/api/azure-ai-projects/azure.ai.projects.aiprojectclient) (Python) / [`AIProjectClient.getOpenAIClient`](https://learn.microsoft.com/javascript/api/@azure/ai-projects/aiprojectclient) (JavaScript/TypeScript)
...
- Reference: [Deployments - Create Or Update (REST API)](https://learn.microsoft.com/rest/api/aiservices/accountmanagement/deployments/create-or-update) (Python control-plane call)
- Reference: [`CognitiveServicesManagementClient`](https://learn.microsoft.com/javascript/api/@azure/arm-cognitiveservices/cognitiveservicesmanagementclient) (JavaScript/TypeScript)
...
<ZoneContent group="programming-language-javascript__programming-language-python__programming-language-studio__rest-api" value="rest-api" options={[{"id": "programming-language-studio", "title": "Portal"}, {"id": "programming-language-python", "title": "Python"}, {"id": "programming-language-javascript", "title": "JavaScript"}, {"id": "rest-api", "title": "REST API"}]} values={["programming-language-studio", "programming-language-python", "programming-language-javascript", "rest-api"]} defaultValue="programming-language-studio">
