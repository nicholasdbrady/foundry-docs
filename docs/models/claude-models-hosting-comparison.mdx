...
For current default rate limits by subscription type, see [Claude models in Microsoft Foundry — Quotas and rate limits](/models/claude-models#quotas-and-rate-limits).
