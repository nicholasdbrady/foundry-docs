...
For model availability and capabilities, see [Claude models in Microsoft Foundry](/models/claude-models). For detailed data handling information, see [Data, privacy, and security for Claude models](../../responsible-ai/claude-models/data-privacy).
...
For step-by-step instructions, see [Deploy and use Claude models in Microsoft Foundry](/models/use-foundry-models-claude).
...
For a full explanation of CCU billing, see [Claude Consumption Units (CCU) billing in Microsoft Foundry](../concepts/claude-models-billing).
