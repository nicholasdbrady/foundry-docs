...
![Screenshot that shows how to deploy a custom model in Foundry portal.](/images/deploy-dialogue.png)
...
![Screenshot of the Playground pane in Foundry portal, with sections highlighted.](/images/playground-load-new.png)
...
![Screenshot of the global standard deployment user experience with a fine-tuned model.](/images/global-standard.png)
