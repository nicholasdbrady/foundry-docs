...
Images can be provided either as publicly accessible URLs or data URIs containing [base64 encoded images](https://learn.microsoft.com/azure/ai-foundry/openai/how-to/gpt-with-vision).

## Prerequisites

- An Azure subscription. [Create one for free](https://azure.microsoft.com/free/).
- A Microsoft Foundry resource. See [Create an Azure AI Foundry resource](https://learn.microsoft.com/azure/ai-foundry/how-to/create-azure-ai-resource).
- Familiarity with the [fine-tuning workflow](/models/fine-tuning/fine-tuning). Vision fine-tuning follows the same process with image-specific data formatting.
- Fine-tuning access for the supported models in a [supported region](../../foundry-models/concepts/models-sold-directly-by-azure.md).
...
|-------|--------|--------|
| `gpt-4o` | `2024-08-06` | [Supported regions](../../foundry-models/concepts/models-sold-directly-by-azure.md). |
| `gpt-4.1` | `2025-04-14` | [Supported regions](../../foundry-models/concepts/models-sold-directly-by-azure.md). |
...
For detailed steps, see [Fine-tune an Azure OpenAI model](/models/fine-tuning/fine-tuning).

## Content moderation policy

We scan your images before training to ensure that they comply with our usage policy. For details, see the [Transparency Note](https://learn.microsoft.com/azure/ai-foundry/responsible-ai/openai/transparency-note). This might introduce latency in file validation before fine-tuning begins.
...
For more information about data privacy, see [Data and privacy for Face - Foundry Tools](https://learn.microsoft.com/azure/ai-foundry/responsible-ai/computer-vision/image-analysis-data-privacy-security).
</Info>
## Troubleshooting
...
- [Fine-tune a model](/models/fine-tuning/fine-tuning) — Complete fine-tuning workflow including upload, training, and monitoring.
- [Deploy a fine-tuned model](/models/fine-tuning/fine-tuning-deploy) — Deploy your customized model for inference.
- [Fine-tuning model regional availability](../../foundry-models/concepts/models-sold-directly-by-azure.md) — Check which regions support vision fine-tuning.
- [Model quotas and limits](/setup/quotas-limits) — Review rate limits and quotas for fine-tuned models.
