...
- Fine-tuning access for the supported models in a [supported region](/models/catalog/models-sold-directly-by-azure).
...
|-------|--------|--------|
| `gpt-4o` | `2024-08-06` | [Supported regions](/models/catalog/models-sold-directly-by-azure). |
| `gpt-4.1` | `2025-04-14` | [Supported regions](/models/catalog/models-sold-directly-by-azure). |
...
- [Fine-tuning model regional availability](/models/catalog/models-sold-directly-by-azure) — Check which regions support vision fine-tuning.
