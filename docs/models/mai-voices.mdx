...
sidebarTitle: "What is MAI-Voice?"
---
...
<Tabs>
  <Tab title="MAI-Voice-2-Flash">
    ...
    You can integrate with MAI-Voice-2-Flash using the Azure Speech SDK via SSML, and also via [Voice Live](https://learn.microsoft.com/azure/ai-services/speech-service/voice-live-how-to#audio-output-through-azure-text-to-speech).

  </Tab>
  <Tab title="MAI-Voice-2">
...
- A Speech resource in a region that supports MAI models ([region support](https://learn.microsoft.com/azure/cognitive-services/speech-service/regions)).
...
Follow the [text to speech quickstart](/models/get-started-text-to-speech). In the SSML, use a MAI-Voice voice name in the `name` attribute of the `<voice>` element. See the prebuilt voice tables above for available names.
...
## Next steps
- [Speech Synthesis Markup Language (SSML) overview](speech-synthesis-markup)
- [Get started with text to speech](/models/get-started-text-to-speech)
- [High definition (HD) voices](high-definition-voices)
