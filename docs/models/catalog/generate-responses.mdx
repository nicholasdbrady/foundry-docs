...
- A deployment of a Foundry Model, such as the `DeepSeek-V3.1` model used in this article. If you don't have a deployment already, see [Add and configure Foundry Models](/models/capabilities/create-model-deployments) to a model deployment to your resource.
