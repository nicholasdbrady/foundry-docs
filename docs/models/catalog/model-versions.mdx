...
* Read the documentation on [model deployments](../../../foundry-classic/openai/how-to/create-resource.md) and [version upgrades](/models/catalog/working-with-models) to understand how to work with model versions.
