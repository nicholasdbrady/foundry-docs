...
sidebarTitle: "Model versions in Microsoft Foundry Models"
---
...
* Read [what's new](../../openai/whats-new.md) and [models](/models/catalog/models-sold-directly-by-azure) to understand the changes and new features.
* Read the documentation on [model deployments](../../openai/how-to/create-resource.md) and [version upgrades](/models/catalog/working-with-models) to understand how to work with model versions.
