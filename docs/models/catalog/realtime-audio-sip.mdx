...
sidebarTitle: "Use the GPT Realtime API via SIP"
---
...
1. Create a webhook for incoming calls using the [Azure OpenAI Webhook Service REST API](/models/capabilities/webhooks).
...
- [Use the Realtime API via WebRTC](/models/catalog/realtime-audio-webrtc) for browser-based applications
- [Use the Realtime API via WebSocket](/models/catalog/realtime-audio-websockets) for server-to-server scenarios
- [Azure OpenAI webhooks](/models/capabilities/webhooks) for webhook configuration details
- [Realtime API reference](/api-sdk/realtime-audio-reference) for complete API documentation
