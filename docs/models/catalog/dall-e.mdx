...
sidebarTitle: "How to Use Image Generation Models from OpenAI"
---
...
- Deploy a `dall-e-3` or `gpt-image-1`-series model with your Azure OpenAI resource. For more information on deployments, see [Create a resource and deploy a model with Azure OpenAI](https://learn.microsoft.com/azure/ai-foundry/openai/how-to/create-resource).
...
- Use image generation via [image generation API](https://learn.microsoft.com/azure/ai-foundry/openai/dall-e-quickstart) or [responses API](https://learn.microsoft.com/azure/ai-foundry/openai/how-to/responses)
...
<Tip>
For image generation token costs, see [Image tokens](/models/catalog/models-sold-directly-by-azure).
</Tip>
...
* [What is Azure OpenAI?](/models/catalog/models-sold-directly-by-azure)
* [Quickstart: Generate images with Azure OpenAI](/models/catalog/dall-e-quickstart)
