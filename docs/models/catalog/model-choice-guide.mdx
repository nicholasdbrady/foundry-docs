...
sidebarTitle: "GPT-5 vs GPT-4.1 - choosing the right model for your use case"
---
...
If you wish to utilize the advanced features of GPT-5 while ensuring consistent latency, we recommend selecting the [Provisioned Throughput](https://learn.microsoft.com/azure/ai-foundry/openai/concepts/provisioned-throughput) deployment type. This option provides specific latency service level agreements (SLAs) for latency and is well-suited to use cases where latency sensitivity is critical. [Get started with Provisioned Throughput.](https://learn.microsoft.com/azure/ai-foundry/openai/how-to/provisioned-get-started)
