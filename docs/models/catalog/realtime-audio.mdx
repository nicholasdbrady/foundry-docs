...
sidebarTitle: "Use the GPT Realtime API for speech and audio with Azure OpenAI"
---
...
The GPT real-time models are available for global deployments in [East US 2 and Sweden Central regions](/models/catalog/models-sold-directly-by-azure#global-standard-model-availability).
...
See the [models and versions documentation](/models/catalog/models-sold-directly-by-azure#audio-models) for more information.
...
- For steps to deploy and use the `gpt-4o-realtime-preview`, `gpt-4o-mini-realtime-preview`, `gpt-realtime`, `gpt-realtime-mini`, or `gpt-realtime-mini-2025-12-15` model, see [the real-time audio quickstart](/models/catalog/realtime-audio-quickstart).
...
![Diagram of the Realtime API input audio sequence without server decision mode.](/images/input-audio-buffer-client-managed.png)
...
![Diagram of the real time API input audio sequence with server decision mode.](/images/input-audio-buffer-server-vad.png)
...
![Diagram of the real-time API conversation item sequence.](/images/conversation-item-sequence.png)
