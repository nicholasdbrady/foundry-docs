...
sidebarTitle: "Use the GPT Realtime API via WebSockets"
---
...
The GPT real-time models are available for global deployments in the [East US 2 and Sweden Central regions](/models/catalog/models-sold-directly-by-azure#global-standard-model-availability).
...
For more information about supported models, see the [models and versions documentation](/models/catalog/models-sold-directly-by-azure#audio-models).
...
Now that you've done the above steps, you can follow the instructions in the [Realtime API quickstart](/models/catalog/realtime-audio-quickstart) to get started with the Realtime API via WebSockets.
