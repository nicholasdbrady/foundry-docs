...
sidebarTitle: "Use the GPT Realtime API via WebRTC"
---
...
Use the [Realtime API via WebSockets](/models/catalog/realtime-audio-websockets) if you need to:
...
You can access the GPT real-time models for global deployments in the [East US 2 and Sweden Central regions](/models/catalog/models-sold-directly-by-azure#global-standard-model-availability).
