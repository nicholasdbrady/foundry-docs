---
title: "Use tool search with the Azure OpenAI Responses API"
description: "Learn how to use tool search with the Azure OpenAI Responses API to defer tool definitions, reduce context usage, and preserve prompt caching."
---
...
Tool search in the Responses API is different from [tool search in a Foundry Agent Service toolbox](/tools-and-knowledge/tool-search). Responses API tool search defers tool definitions that you declare in a request. Toolbox tool search discovers tools configured in a versioned Foundry toolbox.
...
Reference: [Responses API reference](https://learn.microsoft.com/rest/api/microsoft-foundry/azureopenai/responses)
...
- [Use function calling with Azure OpenAI](/models/function-calling)
- [Web search with the Responses API](/models/web-search)
