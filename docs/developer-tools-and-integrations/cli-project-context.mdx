...
* [Install the Azure Developer CLI Foundry extensions](/developer-tools-and-integrations/install-cli-foundry-extensions)
* [Initialize a hosted agent project with the Azure Developer CLI](/agents/init-agent-project)
* [Optimize an existing agent without AZD project files](/agents/optimize-agent-targets#optimize-an-existing-agent-without-azd-project-files)
