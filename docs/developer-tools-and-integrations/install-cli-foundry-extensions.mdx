...
* [Quickstart: Deploy your first hosted agent](../quickstarts/quickstart-hosted-agent)
* [Initialize a hosted agent project with the Azure Developer CLI](init-agent-project)
