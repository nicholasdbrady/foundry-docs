...
To get started with the agents playground, see [Understanding the agent development lifecycle](/agents/development-lifecycle).
...
| Model not available in deployment list | Check [model regional availability](/models/region-support) for your Foundry resource region. |
...
- [Understanding the agent development lifecycle](/agents/development-lifecycle)
