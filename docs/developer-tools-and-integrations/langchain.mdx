...
| Chat history stores | `langchain_azure_ai.chat_history` | Persist and replay chat history across sessions. Use memory-powered histories to retrieve consolidated pass chat history. [See detailed examples](/developer-tools-and-integrations/langchain-memory). |
