...
Foundry provides the tools and best practices for performing your own [risk and safety evaluations](../../concepts/safety-evaluations-transparency-note) of models.
