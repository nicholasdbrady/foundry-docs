...
1. In the deployment window, configure the following settings:
   ...
   * **Token Plan**: Select **Pay-per-token** -> Datazone Standard or **Provisioned Throughput** -> Datazone or Global. For more information, see [Deployment types](/models/deployment-types#deployment-type-comparison).
