...
which uses Azure AI Inference SDK (retired). [Learn more](https://learn.microsoft.com/en-us/azure/foundry-classic/how-to/develop/langchain).
...
- [Foundry models overview](/models/foundry-models-overview)
- [Microsoft Foundry SDK overview](sdk-overview)
- [Use LangChain with memory in Foundry](/developer-tools-and-integrations/langchain-memory)
- [Use LangChain with Foundry Agent Service](/developer-tools-and-integrations/langchain-agents)
