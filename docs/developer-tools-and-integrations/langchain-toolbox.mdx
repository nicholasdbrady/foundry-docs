...
- A [toolbox configured in your Foundry project](/toolboxes/toolbox). Note its name.
...
about human-in-the-loop approvals, see [Use Foundry Agent Service with LangGraph](/developer-tools-and-integrations/langchain-agents).
