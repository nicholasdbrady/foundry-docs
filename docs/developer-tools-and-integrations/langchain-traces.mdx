...
If you deployed your LangGraph or LangChain solution, you can register that deployment into [Foundry Control Plane](../../control-plane/overview)
...
- [Get started with langchain-azure-ai](/developer-tools-and-integrations/langchain)
- [Use LangGraph with the Agent Service](/developer-tools-and-integrations/langchain-agents)
