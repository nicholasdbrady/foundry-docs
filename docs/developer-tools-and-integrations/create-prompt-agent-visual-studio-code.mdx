...
see [Create an agent](/developer-tools-and-integrations/create-agent-visual-studio-code).
...
- [Select a Foundry project](/developer-tools-and-integrations/set-up-foundry-project-visual-studio-code).
  You need permission to create agents and use the project's models and tools.
  See [Foundry role-based access control](../../concepts/rbac-foundry).
- A model deployment in that project. See
  [Set up Foundry resources](/get-started/quickstart-create-foundry-resources).
...
<Frame>
<img src="/images/agent-builder.png" alt="Screenshot of Agent Builder with a saved Foundry prompt agent, version selector, model, instructions, tool, and playground conversation." />
</Frame>
...
see [Publish an agent application](/agents/agent-applications).
...
[Save changes as versions](/agents/development-lifecycle#save-changes-as-versions).
...
Approval settings don't grant access to the underlying service. For service permissions, see [Agent identity concepts](/agents/agent-identity).

## Use a toolbox (preview)

A [toolbox](/get-started/toolbox-overview) groups reusable tools
...
<Frame>
<img src="/images/select-toolbox.png" alt="Screenshot of the Select a toolbox dialog showing toolbox names, versions, and tool and skill counts." />
</Frame>
...
<Frame>
<img src="/images/connect-agent-to-agent.png" alt="Screenshot of the Custom tab in Connect an A2A agent, with name, HTTPS endpoint, agent-card path, and authentication fields." />
</Frame>

For endpoint setup, agent cards, identity options, and permissions, see
[Enable an A2A endpoint](/agents/enable-agent-to-agent-endpoint).
...
<Frame>
  <img src="/images/conversations.png" alt="Screenshot of the Conversations tab showing conversation IDs, status, token usage, and start times." />
</Frame>
...
This tab differs from the local prompt dataset view. For service evaluation guidance, see [Evaluate your agents](/evaluation/evaluate-agent).
...
SDK use, see the [prompt-agent quickstart](/get-started/prompt-agent).
