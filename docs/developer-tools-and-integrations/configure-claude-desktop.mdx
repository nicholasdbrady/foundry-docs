...
- A Microsoft Foundry resource with one or more Claude models deployed. See [Deploy and use Claude models in Microsoft Foundry (preview)](/models/use-foundry-models-claude).
...
Claude models in Microsoft Foundry are currently in preview. Model availability might change. Check the [Foundry Models from partners](/models/models-from-partners) page for the latest list of available models.
...
- [Configure Claude Code for Microsoft Foundry](/developer-tools-and-integrations/configure-claude-code)
- [Data, privacy, and security for Claude models](../../responsible-ai/claude-models/data-privacy)
- [Deploy and use Claude models in Microsoft Foundry (preview)](/models/use-foundry-models-claude)
