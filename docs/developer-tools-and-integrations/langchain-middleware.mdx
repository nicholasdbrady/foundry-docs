...
<Frame>
  <img src="/images/content-moderation-graph.png" alt="Diagram of the agent graph with content moderation middleware." />
</Frame>
...
<Frame>
  <img src="/images/prompt-shield-graph.png" alt="Diagram of the agent graph with prompt shield middleware." />
</Frame>
...
supported regions, see [Azure AI Content Safety region support](../../../ai-services/content-safety/overview#region-availability).
...
<Frame>
  <img src="/images/groundedness-graph.png" alt="Diagram of the agent graph with groundedness middleware." />
</Frame>
...
<Frame>
  <img src="/images/protected-material-graph.png" alt="Diagram of the agent graph with protected material middleware." />
</Frame>
...
<Card title="Use Foundry Agent Service with LangGraph" icon="arrow-right" href="langchain-agents.md" />
## Related content
