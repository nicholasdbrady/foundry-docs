...
[hosted agents](../../agents/overview#hosted-agents). The hosting
...
[Manage Hosted agent sessions](../../agents/how-to/manage-hosted-sessions).
...
project. For details, see [Deploy a Hosted agent](../../agents/how-to/deploy-hosted-agent#required-permissions).
...
[Deploy a Hosted agent](../../agents/how-to/deploy-hosted-agent) and
[Manage Hosted agent lifecycle](../../agents/how-to/manage-hosted-agent).

### Deploy with Foundry Toolkit Visual Studio Code extension

For extension-based deployment, see [Quickstart: Deploy your first hosted agent](../../agents/quickstarts/quickstart-hosted-agent).
...
- [Get started with LangChain and LangGraph with Foundry](/developer-tools-and-integrations/langchain)
- [Use Foundry Agent Service with LangGraph](/developer-tools-and-integrations/langchain-agents)
- [Trace LangChain and LangGraph apps with Microsoft Foundry and Azure Monitor](/developer-tools-and-integrations/langchain-traces)
- [Manage Hosted agent sessions](../../agents/how-to/manage-hosted-sessions)
