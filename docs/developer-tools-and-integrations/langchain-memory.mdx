...
<Card title="Trace LangChain and LangGraph apps" icon="arrow-right" href="langchain-traces.md" />
## Related content
...
- [Use memory with Foundry Agent Service](/tools-and-knowledge/memory-usage)
- [What is memory in Foundry Agent Service](/tools-and-knowledge/what-is-memory)
