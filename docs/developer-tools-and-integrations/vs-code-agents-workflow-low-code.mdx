...
See the [workflow migration guide](/agents/workflow#migration-guide)
...
- [Select the Foundry project](/developer-tools-and-integrations/set-up-foundry-project-visual-studio-code)
...
1. In the workflow designer, switch to the **YAML** view and copy or export the
   ...
   [Export your workflow definition](/agents/workflow#before-you-migrate-export-your-workflow-definition).
