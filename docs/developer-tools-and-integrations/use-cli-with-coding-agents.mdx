...
- A Microsoft Foundry project endpoint for the commands you want to run. For more information, see [Set the azd project context](/developer-tools-and-integrations/cli-project-context).
...
For the full explanation of how the CLI resolves the endpoint, including the precedence order, see [Set the azd project context](/developer-tools-and-integrations/cli-project-context).
...
For the full explanation, including how the standalone context interacts with in-project work, see [Set the azd project context](/developer-tools-and-integrations/cli-project-context).
...
- [Set the azd project context](/developer-tools-and-integrations/cli-project-context) to understand how the CLI resolves the Foundry project endpoint.
