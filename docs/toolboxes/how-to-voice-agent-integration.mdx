...
For complete code examples, see the [new agent quickstart](/toolboxes/voice-live-agents-quickstart). The [classic quickstart](voice-live-agents-quickstart-classic) remains available.
