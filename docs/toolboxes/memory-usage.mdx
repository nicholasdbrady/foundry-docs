...
This article explains how to create, manage, and use memory stores. For conceptual information, see [Memory in Foundry Agent Service](/toolboxes/what-is-memory).
...
- A [Microsoft Foundry project](../../how-to/create-projects) with configured [authorization and permissions](#authorization-and-permissions).
- A [chat model deployment](/models/create-model-deployments), such as `gpt-5.2`, in your project.
- An [embedding model deployment](/models/embeddings), such as `text-embedding-3-small`, in your project.
- A [configured local environment](#set-up-your-environment) with required packages and environment variables.

### Authorization and permissions

Use [role-based access control](../../concepts/rbac-foundry) for production deployments. If roles aren't feasible, skip this section and use key-based authentication instead.
...
<ZonePivot group="csharp__java__python__python-csharp-typescript-java__rest__typescript" options={[{"id": "python", "title": "Python"}, {"id": "csharp", "title": "C#"}, {"id": "typescript", "title": "TypeScript"}, {"id": "java", "title": "Java"}, {"id": "python,csharp,typescript,java", "title": "Python,Csharp,Typescript,Java"}, {"id": "rest", "title": "REST"}]} defaultValue="python" />

<ZoneContent group="csharp__java__python__python-csharp-typescript-java__rest__typescript" value="python" options={[{"id": "python", "title": "Python"}, {"id": "csharp", "title": "C#"}, {"id": "typescript", "title": "TypeScript"}, {"id": "java", "title": "Java"}, {"id": "python,csharp,typescript,java", "title": "Python,Csharp,Typescript,Java"}, {"id": "rest", "title": "REST"}]} values={["python", "csharp", "typescript", "java", "python,csharp,typescript,java", "rest"]} defaultValue="python">
...
<ZoneContent group="csharp__java__python__python-csharp-typescript-java__rest__typescript" value="csharp" options={[{"id": "python", "title": "Python"}, {"id": "csharp", "title": "C#"}, {"id": "typescript", "title": "TypeScript"}, {"id": "java", "title": "Java"}, {"id": "python,csharp,typescript,java", "title": "Python,Csharp,Typescript,Java"}, {"id": "rest", "title": "REST"}]} values={["python", "csharp", "typescript", "java", "python,csharp,typescript,java", "rest"]} defaultValue="python">
...
<ZoneContent group="csharp__java__python__python-csharp-typescript-java__rest__typescript" value="typescript" options={[{"id": "python", "title": "Python"}, {"id": "csharp", "title": "C#"}, {"id": "typescript", "title": "TypeScript"}, {"id": "java", "title": "Java"}, {"id": "python,csharp,typescript,java", "title": "Python,Csharp,Typescript,Java"}, {"id": "rest", "title": "REST"}]} values={["python", "csharp", "typescript", "java", "python,csharp,typescript,java", "rest"]} defaultValue="python">
...
<ZoneContent group="csharp__java__python__python-csharp-typescript-java__rest__typescript" value="java" options={[{"id": "python", "title": "Python"}, {"id": "csharp", "title": "C#"}, {"id": "typescript", "title": "TypeScript"}, {"id": "java", "title": "Java"}, {"id": "python,csharp,typescript,java", "title": "Python,Csharp,Typescript,Java"}, {"id": "rest", "title": "REST"}]} values={["python", "csharp", "typescript", "java", "python,csharp,typescript,java", "rest"]} defaultValue="python">
...
<ZoneContent group="csharp__java__python__python-csharp-typescript-java__rest__typescript" value="python,csharp,typescript,java" options={[{"id": "python", "title": "Python"}, {"id": "csharp", "title": "C#"}, {"id": "typescript", "title": "TypeScript"}, {"id": "java", "title": "Java"}, {"id": "python,csharp,typescript,java", "title": "Python,Csharp,Typescript,Java"}, {"id": "rest", "title": "REST"}]} values={["python", "csharp", "typescript", "java", "python,csharp,typescript,java", "rest"]} defaultValue="python">
...
<ZoneContent group="csharp__java__python__python-csharp-typescript-java__rest__typescript" value="rest" options={[{"id": "python", "title": "Python"}, {"id": "csharp", "title": "C#"}, {"id": "typescript", "title": "TypeScript"}, {"id": "java", "title": "Java"}, {"id": "python,csharp,typescript,java", "title": "Python,Csharp,Typescript,Java"}, {"id": "rest", "title": "REST"}]} values={["python", "csharp", "typescript", "java", "python,csharp,typescript,java", "rest"]} defaultValue="python">
...
For more information about user profile and chat summary memories, see [Memory types](/toolboxes/what-is-memory#memory-types).
...
- [Memory in Foundry Agent Service](/toolboxes/what-is-memory)
- [Foundry Agent Service quotas and limits](/agents/limits-quotas-regions)
