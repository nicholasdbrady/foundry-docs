...
sidebarTitle: "What is Azure Translator document translation?"
---
...
<Tabs>
  <Tab title="Asynchronous (batch)">
    ...
    | **Translate image file formats** 🆕 | &bull; [Translate text within an image while maintaining the original design and layout](reference/start-batch-translation#translate-image-files).<br />&bull; **Supported formats**: `.jpeg`, `.png`, `.bmp`, `.webp`<br />&bull; **Pricing**: Calculated on a per-image basis. For more information, see [Pricing](https://azure.microsoft.com/pricing/details/cognitive-services/translator). |
...
<Tabs>
  <Tab title="Asynchronous (batch)">
    ...
    |**Client libraries (SDKs)**|Use the [Document translation client libraries](document-sdk-overview) for [.NET/C#](https://learn.microsoft.com/dotnet/api/overview/azure/ai.translation.document-readme), [Python](https://learn.microsoft.com/python/api/overview/azure/ai-translation-document-readme), [JavaScript/TypeScript](https://github.com/Azure/azure-sdk-for-js/blob/main/sdk/translation/ai-translation-document/README.md), or [Java](https://learn.microsoft.com/java/api/overview/azure/ai-translation-document-readme).|
  ...
  <Tab title="Synchronous">
    ...
    |**Client libraries (SDKs)**|Integrate translation capabilities into your applications by using the [Document translation client libraries](document-sdk-overview).|
...
The region where you create the Translator resource determines where document content is processed and temporarily stored. For processing locations, custom endpoint requirements, and managed identity considerations, see [Region support for Azure Translator](../region-support).
