...
The recommended way to add Fabric IQ is through a toolbox, then attach the toolbox to your agent as an MCP tool. See [What is a toolbox?](/get-started/toolbox-overview)
...
For code samples, see [Long-running operations](/toolboxes/model-context-protocol#long-running-operations-preview).
...
<Frame>
<img src="/images/entra-api-permissions-search.png" alt="Screenshot of Power BI Service delegated permissions selected in the Microsoft Entra admin center." />
</Frame>
