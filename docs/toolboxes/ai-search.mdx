...
Ground your Foundry agent's responses in your proprietary content by connecting it to an Azure AI Search index. The [Azure AI Search](../../../../search/search-what-is-azure-search) tool retrieves indexed documents so the Foundry model powering the agent can generate answers with inline citations, enabling accurate, source-backed responses.
...
For a managed knowledge base experience, see [Foundry IQ](/toolboxes/foundry-iq-connect).

For tool optimization, see [best practices](/agents/tool-best-practice).
...
If you use a coding agent like GitHub Copilot, the [Microsoft Foundry Skill](/get-started/use-microsoft-foundry-skill) can help connect Azure AI Search, review authentication choices, and adapt the setup to your agent.
...
- Install the SDK package for your preferred language. See the [quickstart](/get-started/get-started-code) for details.
...
- You need the latest SDK package. For more information, see the [quickstart](/get-started/get-started-code).
...
The recommended way to add Azure AI Search is through a toolbox, then attach the toolbox to your agent as an MCP tool. See [What is a toolbox?](/get-started/toolbox-overview)
...
The quickest way to create a connection is through the Foundry portal. For all connection methods and supported connection types, see [Add a new connection to your project](../../../how-to/connections-add).
...
<Frame>
<img src="/images/connection-endpoint.png" alt="A screenshot of an AI Search resource Overview tab in the Azure portal." />
</Frame>
...
<Frame>
<img src="/images/azure-portal.png" alt="A screenshot of an AI Search resource Keys tab in the Azure portal." />
</Frame>
...
<Tabs>
  <Tab title="Foundry portal">
    ...
    For more detailed steps, see [Add a new connection to your project](../../../how-to/connections-add).
...
Don't put real keys in source control. Store secrets in a secure store (for example, Azure Key Vault) and inject them at deployment time.
  ...
  <Tab title="Python SDK">
    ...
    Reference: [CognitiveServicesManagementClient](https://learn.microsoft.com/python/api/azure-mgmt-cognitiveservices/azure.mgmt.cognitiveservices.CognitiveServicesManagementClient), [ProjectConnectionsOperations](https://learn.microsoft.com/python/api/azure-mgmt-cognitiveservices/azure.mgmt.cognitiveservices.operations.projectconnectionsoperations).
...
Don't put real keys in source control. Store secrets in a secure store (for example, Azure Key Vault) and inject them at deployment time.
    ...
    For the full API specification, see [Project Connections REST API reference](https://learn.microsoft.com/rest/api/microsoftfoundry/accountmanagement/project-connections).
  ...
  <Tab title="Bicep">
    ...
    For more information about deploying connections with Bicep, see [Add a new connection to your project](../../../how-to/connections-add).
...
- [Project Connections REST API reference](https://learn.microsoft.com/rest/api/microsoftfoundry/accountmanagement/project-connections)
- [Connect a Foundry IQ knowledge base to Foundry Agent Service](/toolboxes/foundry-iq-connect)
...
- [Quickstart: Build an agent with Foundry](/get-started/get-started-code)
