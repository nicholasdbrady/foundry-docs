...
The Speech MCP tool doesn't support [Network-secured Microsoft Foundry](../../../agents/how-to/virtual-networks). For more information, see [Connect to Model Context Protocol servers](/toolboxes/model-context-protocol).
...
If you want to work with code, see [Connect to Model Context Protocol servers](/toolboxes/model-context-protocol) for SDK examples in Python, C#, and JavaScript.
...
- Learn more about MCP connections: [Connect to Model Context Protocol servers](/toolboxes/model-context-protocol).
