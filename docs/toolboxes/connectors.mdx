...
<ZonePivot group="azd__foundry-portal__programming-language-rest" options={[{"id": "foundry-portal", "title": "Foundry Portal"}, {"id": "programming-language-rest", "title": "REST"}, {"id": "azd", "title": "Azure Developer CLI"}]} defaultValue="foundry-portal" />

<ZoneContent group="azd__foundry-portal__programming-language-rest" value="foundry-portal" options={[{"id": "foundry-portal", "title": "Foundry Portal"}, {"id": "programming-language-rest", "title": "REST"}, {"id": "azd", "title": "Azure Developer CLI"}]} values={["foundry-portal", "programming-language-rest", "azd"]} defaultValue="foundry-portal">
...
To reuse the connector across agents and govern it centrally, add it to a [Foundry Toolbox](/toolboxes/toolbox) instead of attaching it to a single agent. Create a toolbox that includes the connector's managed MCP server, then attach the toolbox to your agents. You can add, remove, or reconfigure connectors in the toolbox without changing agent code.

</ZoneContent>
<ZoneContent group="azd__foundry-portal__programming-language-rest" value="programming-language-rest" options={[{"id": "foundry-portal", "title": "Foundry Portal"}, {"id": "programming-language-rest", "title": "REST"}, {"id": "azd", "title": "Azure Developer CLI"}]} values={["foundry-portal", "programming-language-rest", "azd"]} defaultValue="foundry-portal">
...
Add the connector's managed MCP server to a [Foundry Toolbox](/toolboxes/toolbox) and attach the toolbox to your agent. A toolbox is the recommended way to connect agents with tools.
...
For other languages and runtime options, see [Connect agents to MCP servers](/toolboxes/model-context-protocol). For full toolbox configuration and deployment, see [Create and use a Foundry Toolbox](/toolboxes/toolbox).

</ZoneContent>
<ZoneContent group="azd__foundry-portal__programming-language-rest" value="azd" options={[{"id": "foundry-portal", "title": "Foundry Portal"}, {"id": "programming-language-rest", "title": "REST"}, {"id": "azd", "title": "Azure Developer CLI"}]} values={["foundry-portal", "programming-language-rest", "azd"]} defaultValue="foundry-portal">

The [Azure Developer CLI](https://learn.microsoft.com/azure/developer/azure-developer-cli/install-azd) (`azd`) provides commands to create and manage connector connections through the `microsoft.foundry` extension. The `azd` path supports **OAuth2** connectors, which are the connectors supported in Foundry today.
...
After the connection is created and consent is recorded, reference it from your agent the same way as any other managed MCP server. The simplest path is to add the connection to a [Foundry Toolbox](/toolboxes/toolbox) and attach the toolbox to your agent:
...
For end-to-end agent scaffolding and deployment with the Azure Developer CLI, see [Create and use a Foundry Toolbox](/toolboxes/toolbox).
...
- [Create and use a Foundry Toolbox](/toolboxes/toolbox)
