...
- An existing or new toolbox with at least one tool. See [Curate intent-based toolbox in Foundry](/toolboxes/toolbox).
...
Publishing a new toolbox creates its first version. That version becomes the default version automatically. For the full toolbox creation workflow, see [Curate intent-based toolbox in Foundry](/toolboxes/toolbox#create-a-toolbox-version).
...
- [Curate intent-based toolbox in Foundry](/toolboxes/toolbox)
- [Toolbox overview](/get-started/toolbox-overview)
