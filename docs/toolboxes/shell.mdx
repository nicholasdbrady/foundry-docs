...
Learn more about the [Responses API shell tool](/models/shells).
...
For broader toolbox network isolation, including how toolbox traffic flows when your project uses a virtual network and private link, see [Network isolation for a toolbox in Microsoft Foundry](/toolboxes/toolbox-network-isolation).
...
- [Network isolation for a toolbox](/toolboxes/toolbox-network-isolation)
- [Connect to an MCP server](/toolboxes/model-context-protocol)
