...
- A Foundry project with an [Application Insights resource](https://learn.microsoft.com/azure/azure-monitor/app/app-insights-overview) connected. See [Set up tracing](/observability/trace-agent-setup).
- OpenTelemetry instrumentation configured in your application. See [Set up tracing in Microsoft Foundry](/observability/trace-agent-setup) for setup instructions.
...
<Frame>
  <img src="/images/trace-annotations.png" alt="Screenshot of the Annotations tab on the trace detail page in the Foundry portal." />
</Frame>
...
- [Log end user feedback](/observability/log-end-user-feedback)
- [Set up tracing in Microsoft Foundry](/observability/trace-agent-setup)
- [Review agent interactions with Trace Replay](/observability/trace-agent-replay)
