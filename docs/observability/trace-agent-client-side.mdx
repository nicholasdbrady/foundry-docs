...
- Contributor or higher role on the Foundry project. To view traces, you also need [Log Analytics Reader](https://learn.microsoft.com/azure/azure-monitor/logs/manage-access) on the connected Application Insights resource. If those Log Analytics tables are [protected](https://learn.microsoft.com/azure/azure-monitor/logs/protected-tables-configure), also assign [Privileged Monitoring Data Reader](https://learn.microsoft.com/azure/azure-monitor/logs/manage-access). For more information, see [Role-based access control in Foundry](../../concepts/rbac-foundry).
...
Send traces to [Azure Application Insights](https://learn.microsoft.com/azure/azure-monitor/app/app-insights-overview) so they appear in the Foundry portal's **Traces** view and in Azure Monitor.
...
<Tabs>
  ...
  <Tab title="JavaScript/TypeScript">
    ...
    Reference: [AIProjectClient class](https://learn.microsoft.com/javascript/api/@azure/ai-projects/aiprojectclient), [telemetry.getApplicationInsightsConnectionString](https://learn.microsoft.com/javascript/api/@azure/ai-projects/aiprojectclient)
...
- [Agent tracing overview (preview)](/observability/trace-agent-concept)
- [Set up tracing in Microsoft Foundry](/observability/trace-agent-setup)
- [Configure tracing for agent frameworks](/observability/trace-agent-framework)
- [Monitor agents with the Agent Monitoring Dashboard](/agents/how-to-monitor-agents-dashboard)
