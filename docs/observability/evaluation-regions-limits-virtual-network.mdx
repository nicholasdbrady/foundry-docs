...
For network isolation, you can bring your own virtual network for evaluation. To learn more, see [How to configure a private link](/security/configure-private-link).
