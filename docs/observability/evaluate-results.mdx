...
sidebarTitle: "See Evaluation Results in Microsoft Foundry portal"
---
...
![Screenshot of the evaluation details page showing evaluation runs.](/images/evaluation-runs.png)
