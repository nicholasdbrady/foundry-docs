...
- Improve low metrics with prompt iteration or [fine-tuning](https://learn.microsoft.com/en-us/azure/foundry-classic/concepts/fine-tuning-overview).
...
- [Create evaluations with OpenAI evaluation graders in Azure OpenAI Hub](https://learn.microsoft.com/en-us/azure/foundry-classic/openai/how-to/evaluations).
