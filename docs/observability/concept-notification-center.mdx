...
- An active Microsoft Foundry project. To create one, see [Create a project](../how-to/create-projects).
...
These steps require portal access. For RBAC role requirements, see [Role-based access control for Microsoft Foundry](rbac-foundry).
