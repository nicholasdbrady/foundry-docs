...
1. **Create a connection**: Follow the instructions in [Add a new connection to your project](/setup/connections-add) to connect your Azure OpenAI or AI Services resource to your Foundry project.
...
- [AI Red Teaming Agent concepts](/observability/ai-red-teaming-agent)
