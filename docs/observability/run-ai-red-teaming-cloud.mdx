...
1. **Create a connection**: Follow the instructions in [Configure project connections](https://learn.microsoft.com/en-us/azure/foundry-classic/foundry-models/how-to/configure-project-connection) to connect your Azure OpenAI or AI Services resource to your Foundry project.
