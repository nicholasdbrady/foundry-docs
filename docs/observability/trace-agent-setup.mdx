...
- Foundry also allows for easy [integration](/observability/trace-agent-framework) with top agent frameworks.
...
- [Monitor AI agents with the Agent Monitoring Dashboard](/observability/how-to-monitor-agents-dashboard)
