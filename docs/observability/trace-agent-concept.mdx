...
Once tracing is enabled for your project, you can inspect traces in the Foundry portal and in Azure Monitor Application Insights. For the step-by-step setup and viewing options, see [How to set up tracing in Microsoft Foundry](/observability/trace-agent-setup).
...
To learn more, see [tracing integrations](/observability/trace-agent-framework).
