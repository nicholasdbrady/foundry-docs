...
sidebarTitle: "Cloud Evaluation with the Microsoft Foundry SDK"
---
...
Cloud evaluation results are stored in your Foundry project. You can review results in the portal, retrieve them through the SDK, or route them to Application Insights if connected. Cloud evaluation supports all Microsoft-curated [built-in evaluators](/observability/observability#what-are-evaluators) and your own [custom evaluators](/observability/custom-evaluators). Evaluators are managed in the [evaluator catalog](/observability/evaluate-generative-ai-app#view-and-manage-the-evaluators-in-the-evaluator-library) with the same project-scope, role-based access control.
