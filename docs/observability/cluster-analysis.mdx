...
![Screenshot of the setup cluster analysis window.](/images/cluster-analysis-set-up.png)
...
![Screenshot of the cluster analysis page.](/images/cluster-analysis-map.png)
...
![Screenshot of a selected cluster with the side panel open.](/images/cluster-analysis-side-panel.png)
...
![Screenshot of a selected subcluster with the side panel open.](/images/cluster-analysis-sub-cluster-side-panel.png)
...
![Screenshot of entry ID select with side panel opened.](/images/cluster-analysis-entry-id.png)
...
![Screenshot of the cluster analysis's filter panel.](/images/cluster-analysis-filter.png)
...
![Screenshot of the cluster analysis's advanced filtering.](/images/cluster-analysis-advanced-filtering.png)
