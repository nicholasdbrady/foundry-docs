...
The AI Red Teaming Agent leverages Microsoft's open-source framework for Python Risk Identification Tool's ([PyRIT](https://github.com/Azure/PyRIT)) AI red teaming capabilities along with Microsoft Foundry's [Risk and Safety Evaluations](/observability/risk-safety-evaluators) to help you automatically assess safety issues in three ways:
