...
In production, we recommend implementing **safety guardrails** such as [Azure AI Content Safety filters](../../ai-services/content-safety/overview) or implementing safety system messages using our [templates](/guardrails/safety-system-message-templates). For agentic workflows, we recommend leveraging [Foundry Control Plane](/manage/overview) to apply guardrails and govern your fleet of agents.
