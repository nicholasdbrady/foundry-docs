...
![Diagram of AI application lifecycle, showing model selection, building an AI application, and operationalizing.](/images/lifecycle.png)
...
![Diagram of Pre-production evaluation for models and applications with the six steps.](/images/evaluation-models-diagram.png)
...
![Screenshot of the Foundry portal showing agent playground with the metrics selected.](/images/agent-playground-evaluation-metrics.png)
</Warning>
