...
For a complete list of built-in evaluators, see [Built-in evaluators reference](/evaluation/built-in-evaluators).
...
For details on setting up production monitoring, see [Monitor agents dashboard](/agents/how-to-monitor-agents-dashboard).
...
For guidance on implementing tracing, see [Trace agent overview](/observability/trace-agent-concept).
...
- **Bring your own data**: Evaluate AI applications using your own data with quality, safety, or [custom evaluators](/evaluation/custom-evaluators). Use the [Foundry portal](/evaluation/evaluate-generative-ai-app) evaluation wizard or [Foundry SDK](/evaluation/cloud-evaluation) and [view results in the Foundry portal](/evaluation/evaluate-results).

- **AI red teaming agent**: The [AI red teaming agent](/evaluation/run-ai-red-teaming-cloud) simulates complex attacks using Microsoft's PyRIT framework to identify safety and security vulnerabilities before deployment. Best used with human-in-the-loop processes.

### Post-production monitoring

After deployment, [continuous monitoring](/agents/how-to-monitor-agents-dashboard) ensures your AI application maintains quality in real-world conditions:
...
| -----| -----| ----|
| How to set up tracing? | Configure distributed tracing | [Trace overview](/observability/trace-agent-concept) <br /><br /> [Trace with Agents SDK](/observability/trace-agent-setup) |
| What are you evaluating for? | Identify or build relevant evaluators | [Built-in evaluators](/evaluation/built-in-evaluators) <br /><br /> [Custom evaluators](/evaluation/custom-evaluators) <br /><br /> [Python SDK samples](https://github.com/Azure/azure-sdk-for-python/blob/main/sdk/ai/azure-ai-projects/samples/evaluations/README.md) <br /><br /> [C# SDK samples](https://github.com/Azure/azure-sdk-for-net/tree/main/sdk/ai/Azure.AI.Projects/tests/Samples/Evaluation) |
| What data should you use? | Upload or generate relevant dataset | [Select data source](/evaluation/evaluate-generative-ai-app#step-3-select-data-source) |
| How to run evaluations? | Run evaluation | [Agent evaluation runs](/evaluation/evaluate-agent) <br /><br /> [Remote cloud run](/evaluation/cloud-evaluation) |
| How did my model/AI application perform? | Analyze results | [View evaluation results](/evaluation/evaluate-results) <br /><br /> [Cluster analysis](/evaluation/cluster-analysis) |
| How can I improve? | Analyze results and optimize agents | Analyze evaluation failures with [cluster analysis](/evaluation/cluster-analysis). <br /><br /> Optimize agents and [re-evaluate](/evaluation/evaluate-agent). <br /><br /> Review [evaluation results](/evaluation/evaluate-results). |

## Region support, rate limits, and virtual network support

To learn which regions support AI-assisted evaluators, the rate limits that apply to evaluation runs, and how to configure virtual network support for network isolation, see [region support, rate limits, and virtual network support for evaluation](/evaluation/evaluation-regions-limits-virtual-network).
...
<Frame>
  <img src="/images/agent-playground-evaluation-metrics.png" alt="Screenshot of the Foundry portal showing agents playground with the metrics selected." />
</Frame>
...
- [Virtual network support for evaluation](/evaluation/evaluation-regions-limits-virtual-network)
- [Foundry control plane](../control-plane/overview)
- [Evaluate generative AI apps by using Foundry](/evaluation/evaluate-generative-ai-app)
- [See evaluation results in the Foundry portal](/evaluation/evaluate-results)
- [Foundry Transparency Note](/evaluation/safety-evaluations-transparency-note)
