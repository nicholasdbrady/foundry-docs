...
[Trace evaluation](/evaluation/cloud-evaluation#trace-evaluation-preview) runs evaluators against agent interactions that Application Insights already captured, instead of replaying requests. 
