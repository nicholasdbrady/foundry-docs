...
- A [Foundry project](/setup/create-projects) with one or more [published agents](/agent-service/overview).
...
<Frame>
  <img src="/images/monitor-dashboard-overview.png" alt="Screenshot of the Foundry Operate Overview page showing active alerts, agent run volume chart, and the Ask AI banner with predefined prompts." />
</Frame>
...
<Frame>
  <img src="/images/monitor-dashboard.png" alt="Screenshot of the model monitoring dashboard with the Ask AI banner showing predefined prompt options." />
</Frame>
...
<Frame>
  <img src="/images/monitor-dashboard-summary.png" alt="Screenshot of the model monitoring dashboard with the Ask AI panel open on the right, showing a dashboard summary response with annotated links to token usage and request count charts." />
</Frame>
...
- [Agents overview](/agent-service/overview)
