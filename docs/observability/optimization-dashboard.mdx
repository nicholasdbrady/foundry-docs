...
1. Select one of the predefined prompts from the *Ask AI* banner under *Build/Model/Monitor*, *Build/Agent/Monitor*, or overview page.
    ...
    ![Screenshot of the monitor dashboard with the Ask AI banner at the top.](/images/monitor-dashboard.png)

    ![Screenshot of the monitor dashboard overview page.](/images/monitor-dashboard-overview.png)
...
![Screenshot showing a monitor dashboard summary from Ask AI.](/images/monitor-dashboard-overview.png)
