...
After you create a custom evaluator, you can add it to the evaluator catalog in your Foundry project and use it in [batch evaluation runs](/observability/cloud-evaluation).
...
For more information on data source options, evaluator mappings, and advanced scenarios, see [Run evaluations from the SDK](/observability/cloud-evaluation).
...
For detailed steps on running evaluations from the portal, see [Run evaluations from the portal](/observability/evaluate-generative-ai-app#create-an-evaluation).
