...
<Frame>
  <img src="/images/empty-state.png" alt="Screenshot of the Insights page before its first analysis, showing model configuration and the Run scan now action." />
</Frame>
...
<Frame>
  <img src="/images/insights-generated.png" alt="Screenshot of generated Insights and selected details, including category, severity, linked traces, evidence, and a proposed fix." />
</Frame>
...
<Frame>
  <img src="/images/insights-history-button.png" alt="Screenshot of the Insights toolbar with the Run now action and History icon." />
</Frame>
...
<Frame>
  <img src="/images/insights-generation-history.png" alt="Screenshot of Insights generation history showing run status, timing, token usage, analyzed traces, and new or updated Insights." />
</Frame>
...
Complete [Foundry MCP Server setup](/developer-tools-and-integrations/get-started), open your agent's source folder in Visual Studio Code, and select **Agent** mode in GitHub Copilot Chat. Confirm that the Foundry tools are enabled, and then use a prompt such as:
...
Install the skill by following [Use the Microsoft Foundry Skill in coding agents](/get-started/use-microsoft-foundry-skill). Open the folder that contains your agent code, and then use a prompt such as:
...
<Frame>
  <img src="/images/fix-general-advice-when-no-access-to-code.png" alt="Screenshot of an Insight with general remediation guidance when editable agent instructions or source code aren't available." />
</Frame>
...
<Frame>
  <img src="/images/fix-prompt-agent.png" alt="Screenshot of a Prompt agent proposed fix showing a side-by-side diff of the agent instructions." />
</Frame>
...
<Frame>
  <img src="/images/fix-code-based-hosted-agent.png" alt="Screenshot of a code-based Hosted agent proposed fix showing a side-by-side source code diff." />
</Frame>
...
Reference: [AgentInsightMonitorCreate](https://learn.microsoft.com/python/api/azure-ai-projects/azure.ai.projects.models.agentinsightmonitorcreate), [BetaAgentInsightMonitorsOperations][monitor-operations].
...
Reference: [AgentInsightRunCreate](https://learn.microsoft.com/python/api/azure-ai-projects/azure.ai.projects.models.agentinsightruncreate), [BetaAgentInsightMonitorsOperations][monitor-operations].
...
Reference: [AgentInsightUpdate](https://learn.microsoft.com/python/api/azure-ai-projects/azure.ai.projects.models.agentinsightupdate), [BetaAgentInsightMonitorsOperations][monitor-operations].
...
Reference: [AgentInsightMonitorUpdate](https://learn.microsoft.com/python/api/azure-ai-projects/azure.ai.projects.models.agentinsightmonitorupdate), [BetaAgentInsightMonitorsOperations][monitor-operations].
...
- [Set up tracing](/observability/trace-agent-setup)
- [Monitor agents](/agents/how-to-monitor-agents-dashboard)
- [Evaluate agents](/evaluation/evaluate-agent)
