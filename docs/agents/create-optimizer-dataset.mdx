...
For the interactive wizard, non-interactive flags, and details about the generated artifacts, see [Generate a dataset and an evaluator](/evaluation/azure-developer-cli-evaluation#generate-a-dataset-and-an-evaluator).
