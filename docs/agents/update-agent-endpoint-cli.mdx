...
If you use a coding agent like GitHub Copilot, the [Microsoft Foundry Skill](/get-started/use-microsoft-foundry-skill) can help update endpoint metadata and agent card settings while keeping deployment changes separate.
