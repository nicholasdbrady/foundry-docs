...
Prefer a Docker-less inner loop? You can also [deploy a hosted agent directly from source code (preview)](/get-started/deploy-hosted-agent-code) - upload a `.zip` of your Python or .NET code and the platform builds and hosts it for you.
