...
If you use a coding agent like GitHub Copilot, the [Microsoft Foundry Skill](/get-started/use-microsoft-foundry-skill) can help you plan the container deployment flow, prepare `azd` commands, and connect the SDK or REST steps to your project.
...
<ZonePivot group="azd__csharp__javascript__python__rest" options={[{"id": "azd", "title": "Azure Developer CLI"}, {"id": "python", "title": "Python"}, {"id": "csharp", "title": "C#"}, {"id": "javascript", "title": "JavaScript"}, {"id": "rest", "title": "REST"}]} defaultValue="azd" />

<ZoneContent group="azd__csharp__javascript__python__rest" value="azd" options={[{"id": "azd", "title": "Azure Developer CLI"}, {"id": "python", "title": "Python"}, {"id": "csharp", "title": "C#"}, {"id": "javascript", "title": "JavaScript"}, {"id": "rest", "title": "REST"}]} values={["azd", "python", "csharp", "javascript", "rest"]} defaultValue="azd">
...
<ZoneContent group="azd__csharp__javascript__python__rest" value="python" options={[{"id": "azd", "title": "Azure Developer CLI"}, {"id": "python", "title": "Python"}, {"id": "csharp", "title": "C#"}, {"id": "javascript", "title": "JavaScript"}, {"id": "rest", "title": "REST"}]} values={["azd", "python", "csharp", "javascript", "rest"]} defaultValue="azd">
...
To set when session compute goes idle, see [Manage session idleness](/agents/manage-hosted-sessions#manage-session-idleness).
...
<ZoneContent group="azd__csharp__javascript__python__rest" value="csharp" options={[{"id": "azd", "title": "Azure Developer CLI"}, {"id": "python", "title": "Python"}, {"id": "csharp", "title": "C#"}, {"id": "javascript", "title": "JavaScript"}, {"id": "rest", "title": "REST"}]} values={["azd", "python", "csharp", "javascript", "rest"]} defaultValue="azd">
...
<ZoneContent group="azd__csharp__javascript__python__rest" value="javascript" options={[{"id": "azd", "title": "Azure Developer CLI"}, {"id": "python", "title": "Python"}, {"id": "csharp", "title": "C#"}, {"id": "javascript", "title": "JavaScript"}, {"id": "rest", "title": "REST"}]} values={["azd", "python", "csharp", "javascript", "rest"]} defaultValue="azd">
...
<ZoneContent group="azd__csharp__javascript__python__rest" value="rest" options={[{"id": "azd", "title": "Azure Developer CLI"}, {"id": "python", "title": "Python"}, {"id": "csharp", "title": "C#"}, {"id": "javascript", "title": "JavaScript"}, {"id": "rest", "title": "REST"}]} values={["azd", "python", "csharp", "javascript", "rest"]} defaultValue="azd">
