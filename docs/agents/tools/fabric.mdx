...
sidebarTitle: "Use the Microsoft Fabric data agent with Foundry agents"
---
...
- Assign developers and end users at least the `Azure AI User` Azure RBAC role. For more information, see [Azure role-based access control in Foundry](/security/rbac-foundry).
...
- For the REST sample, also set:
  ...
  - Use user identity authentication. Service principal authentication isn't supported for the Fabric data agent.
  - For more information about how agent identity works, see [Agent identity](/agents/development/agent-identity).

## Code example

<Note>
- To run this code, you need the latest prerelease package. For more information, see [Get ready to code](/get-started/get-started-code#get-ready-to-code).
...
<Card title="Get started with the SDK" icon="arrow-right" href="../../../../quickstarts/get-started-code.md?view=foundry&preserve-view=true" />
