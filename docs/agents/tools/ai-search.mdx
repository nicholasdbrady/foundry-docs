...
---
<Tip>
For a managed knowledge base experience, see [Foundry IQ](/agents/tools/foundry-iq-connect). For tool optimization, see [best practices](/agents/tools/tool-best-practice).
</Tip>
...
- [Connect a Foundry IQ knowledge base to Foundry Agent Service](/agents/tools/foundry-iq-connect)
