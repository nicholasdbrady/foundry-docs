...
sidebarTitle: "Use the image generation tool in Foundry Agent Service (preview)"
---
...
Before you start, install the `azure-ai-projects` package (version 2.0.0b1 or later). For package installation instructions, see the [quickstart](/get-started/get-started-code).
