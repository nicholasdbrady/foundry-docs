...
sidebarTitle: "Use Code Interpreter with Microsoft Foundry agents"
---
...
- Latest prerelease SDK package installed (`azure-ai-projects>=2.0.0b1` for Python). See the [quickstart](/get-started/get-started-code) for installation steps.
