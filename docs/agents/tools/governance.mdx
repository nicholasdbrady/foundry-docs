...
sidebarTitle: "Govern MCP Tools by Using an AI Gateway"
---
...
</Warning>    > Avoid deleting authentication headers (such as `Authorization`) unless you're sure that the MCP server doesn't require them.
