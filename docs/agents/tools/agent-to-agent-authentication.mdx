...
sidebarTitle: "Agent2Agent (A2A) authentication"
---
...
- The **Azure AI User** role or higher on your project. This role grants permissions to create project connections and configure agents. For details, see [Role-based access control in the Foundry portal](/security/rbac-foundry).
...
For more information about agent identity lifecycle, see [Agent identity concepts in Microsoft Foundry](/agents/development/agent-identity).
...
1. **Create a project connection** in the Foundry portal. The connection stores the A2A endpoint URL, authentication method, and credentials.
   - For general connection guidance, see [Add a new connection to your project](/setup/connections-add).
   - For A2A-specific configuration, see [Add an A2A agent endpoint to Foundry Agent Service](/agents/tools/agent-to-agent).
...
- [Add an A2A agent endpoint to Foundry Agent Service](/agents/tools/agent-to-agent): Step-by-step guide to configure an A2A tool for your agent.
- [Agent identity concepts in Microsoft Foundry](/agents/development/agent-identity): Learn how agent identities work and their lifecycle.
- [Role-based access control for Microsoft Foundry](/security/rbac-foundry): Understand the roles and permissions available in Foundry.
- [Add a new connection to your project](/setup/connections-add): General guidance for creating project connections.
