...
</Warning>   > - You need the **Contributor** or **Owner** role at the subscription or resource group level to create Bing resources and get resource keys.
...
![A screenshot showing citations for Bing search results.](/images/website-citations.png)
