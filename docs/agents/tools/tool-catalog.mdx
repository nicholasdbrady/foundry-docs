...
![Screenshot of a tool details page in the Foundry portal showing configuration and setup information.](/images/tool-example.png)
...
<!--
![A screenshot showing the tools list in the Foundry portal.](/images/tool-view.png)
-->
