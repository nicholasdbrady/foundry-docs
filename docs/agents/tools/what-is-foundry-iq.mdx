...
sidebarTitle: "What is Foundry IQ?"
---
# Foundry IQ (preview)
...
1. Sign in to the [Microsoft Foundry (new) portal](/overview/what-is-foundry#microsoft-foundry-portals).
...
+ You can use the [Azure portal](https://learn.microsoft.com/azure/search/get-started-portal-agentic-retrieval) to create knowledge bases and knowledge sources, but agent configuration and integration must be done in the Microsoft Foundry (new) portal or programmatically.
</Note>
...
1. [Connect an agent](https://learn.microsoft.com/azure/ai-foundry/agents/how-to/foundry-iq-connect) to your knowledge base.
...
+ For step-by-step integration guidance, learn how to [connect a Foundry IQ knowledge base to Foundry Agent Service](/agents/tools/foundry-iq-connect).
