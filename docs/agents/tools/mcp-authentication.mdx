...
sidebarTitle: "Set up MCP server authentication"
---
...
<Check>Choose an authentication method based on your security requirements</Check>
<Check>Configure key-based, Microsoft Entra, or OAuth authentication</Check>
<Check>Set up and validate your MCP server connection</Check>
<Note>
...
- [Agent identity concepts in Foundry](/agents/development/agent-identity)
