...
![Diagram that shows a user query, retrieval from a data store, and a grounded model response.](/images/rag-pattern.png)
...
![Diagram that shows retrieval from an index and how the retrieved passages are added to the model prompt.](/images/rag-pattern-with-index.png)
