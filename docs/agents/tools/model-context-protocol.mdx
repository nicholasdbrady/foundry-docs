...
sidebarTitle: "Connect to MCP Server Endpoints for agents (Preview)"
---
...
<Note>
When you use a [Network Secured Microsoft Foundry](/setup/virtual-networks), you can't use private MCP servers deployed in the same virtual network. You can only use publicly accessible MCP servers.
</Note>
