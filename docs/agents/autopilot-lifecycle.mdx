...
The [autopilot pattern](/agents/autopilot-overview#types-of-autopilots-you-can-build) you choose determines which roles appear.
...
- [Quickstart: Build your first autopilot](/agents/agent-365) covers provisioning, building, publishing, approval, and hiring your first instance.
