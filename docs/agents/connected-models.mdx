...
- [Bing grounding](/toolboxes/bing-tools)
- [SharePoint (preview)](/toolboxes/sharepoint)
- [Memory Search (preview)](/toolboxes/memory-usage#use-memories-via-an-agent-tool)
- [Microsoft Fabric (preview)](/toolboxes/fabric)
