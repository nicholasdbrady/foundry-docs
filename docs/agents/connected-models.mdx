...
Foundry Agent Service lets your agents call models hosted in another Foundry resource without copying or redeploying them. This capability is part of the broader *bring your own model* experience. For third-party models and the full set of options, see [Bring your own model with the AI Gateway](ai-gateway).
...
For step-by-step instructions, see [Create a model connection](ai-gateway). Provide the following values:
...
For step-by-step instructions, see [Create a model connection](ai-gateway).
...
When you create agents in code, reference the connected model using the format `<connection-name>/<model-name>`. For an end-to-end example, see [Create a prompt agent with the model connection](ai-gateway).
...
- [Bing grounding](/tools-and-knowledge/bing-tools)
- [SharePoint (preview)](/tools-and-knowledge/sharepoint)
- [Memory Search (preview)](/tools-and-knowledge/memory-usage#use-memories-via-an-agent-tool)
- [Microsoft Fabric (preview)](/tools-and-knowledge/fabric)

## Related content

- [Bring your own model with the AI Gateway](ai-gateway)
- [Create a model connection](ai-gateway)
- [What is Microsoft Foundry Agent Service?](/agents/overview)
