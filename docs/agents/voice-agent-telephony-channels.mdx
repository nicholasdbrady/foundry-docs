...
Use [Teams Phone extensibility (TPE)](https://learn.microsoft.com/azure/communication-services/concepts/interop/tpe/teams-phone-extensibility-overview) or Twilio to connect a phone number to your Microsoft Foundry voice agent. Receive inbound calls and place outbound calls through the call-job API.
...
1. Follow [Teams Phone System extensibility quick start](https://learn.microsoft.com/azure/communication-services/quickstarts/tpe/teams-phone-extensibility-quickstart) to provision the application, bot, resource account, and Azure Communication Services association.
...
<Tabs>
  ...
  <Tab title="Python SDK">
    ...
    Reference: [CreateTeamsPhoneExtensionTelephonyBindingRequest](https://learn.microsoft.com/python/api/azure-ai-projects/azure.ai.projects.models.createteamsphoneextensiontelephonybindingrequest).
    ...
    Reference: [CreateTwilioTelephonyBindingRequest](https://learn.microsoft.com/python/api/azure-ai-projects/azure.ai.projects.models.createtwiliotelephonybindingrequest).
    ...
    Reference: [BetaVoiceAgentsTelephonyOperations.create_binding](https://learn.microsoft.com/python/api/azure-ai-projects/azure.ai.projects.operations.betavoiceagentstelephonyoperations).
    ...
    Reference: [BetaVoiceAgentsTelephonyOperations](https://learn.microsoft.com/python/api/azure-ai-projects/azure.ai.projects.operations.betavoiceagentstelephonyoperations) | [MatchConditions](https://learn.microsoft.com/python/api/azure-core/azure.core.matchconditions).
...
Complete the application and role setup in [Deliver events to Microsoft Entra protected endpoints](https://learn.microsoft.com/azure/event-grid/secure-webhook-delivery) first. Obtain the webhook tenant and audience from the administrator who configures secure incoming-call delivery. The webhook application identifies the token audience; it isn't the Microsoft Event Grid first-party application.
...
Reference: [az eventgrid event-subscription create](https://learn.microsoft.com/cli/azure/eventgrid/event-subscription#az-eventgrid-event-subscription-create).
...
Event Grid allows up to 500 event subscriptions per system topic. Plan incoming-call delivery within the [Event Grid quotas and limits](https://learn.microsoft.com/azure/event-grid/quotas-limits).
...
<Tabs>
  ...
  <Tab title="Python SDK">
    ...
    Reference: [CreateTelephonyCallJobRequest](https://learn.microsoft.com/python/api/azure-ai-projects/azure.ai.projects.models.createtelephonycalljobrequest) | [BetaVoiceAgentsTelephonyOperations.create_call_job](https://learn.microsoft.com/python/api/azure-ai-projects/azure.ai.projects.operations.betavoiceagentstelephonyoperations).
    ...
    Reference: [BetaVoiceAgentsTelephonyOperations.get_call_job](https://learn.microsoft.com/python/api/azure-ai-projects/azure.ai.projects.operations.betavoiceagentstelephonyoperations).
    ...
    Reference: [BetaVoiceAgentsTelephonyOperations.cancel_call_job](https://learn.microsoft.com/python/api/azure-ai-projects/azure.ai.projects.operations.betavoiceagentstelephonyoperations) | [MatchConditions](https://learn.microsoft.com/python/api/azure-core/azure.core.matchconditions).
  ...
  <Tab title="REST">
    ...
    Reference: [CreateTelephonyCallJobRequest](https://learn.microsoft.com/python/api/azure-ai-projects/azure.ai.projects.models.createtelephonycalljobrequest).
    ...
    Reference: [BetaVoiceAgentsTelephonyOperations.cancel_call_job](https://learn.microsoft.com/python/api/azure-ai-projects/azure.ai.projects.operations.betavoiceagentstelephonyoperations).
...
<Tabs>
  ...
  <Tab title="Python SDK">
    ...
    Reference: [BetaVoiceAgentsTelephonyOperations](https://learn.microsoft.com/python/api/azure-ai-projects/azure.ai.projects.operations.betavoiceagentstelephonyoperations).
...
<Tabs>
  ...
  <Tab title="Python SDK">
    ...
    Reference: [BetaVoiceAgentsTelephonyOperations.list_calls](https://learn.microsoft.com/python/api/azure-ai-projects/azure.ai.projects.operations.betavoiceagentstelephonyoperations).
    ...
    Reference: [BetaVoiceAgentsTelephonyOperations.transfer_call](https://learn.microsoft.com/python/api/azure-ai-projects/azure.ai.projects.operations.betavoiceagentstelephonyoperations).
    ...
    Reference: [BetaVoiceAgentsTelephonyOperations.end_call](https://learn.microsoft.com/python/api/azure-ai-projects/azure.ai.projects.operations.betavoiceagentstelephonyoperations).
...
<Tabs>
  ...
  <Tab title="Python SDK">
    ...
    Reference: [BetaVoiceAgentsTelephonyOperations.delete_binding](https://learn.microsoft.com/python/api/azure-ai-projects/azure.ai.projects.operations.betavoiceagentstelephonyoperations).
...
- [Publish and share a voice-based agent](/agents/voice-agent-channels-publish)
