...
- The latest SDK package for your language. See the [quickstart](/get-started/get-started-code) for installation steps.
...
<ZonePivot group="python__typescript" options={[{"id": "python", "title": "Python"}, {"id": "typescript", "title": "TypeScript"}]} defaultValue="python" />

<ZoneContent group="python__typescript" value="python" options={[{"id": "python", "title": "Python"}, {"id": "typescript", "title": "TypeScript"}]} values={["python", "typescript"]} defaultValue="python">
...
<ZoneContent group="python__typescript" value="typescript" options={[{"id": "python", "title": "Python"}, {"id": "typescript", "title": "TypeScript"}]} values={["python", "typescript"]} defaultValue="python">
...
For more information about connecting to MCP servers, see [Connect agents to MCP servers](/toolboxes/model-context-protocol).
...
- [Code Interpreter tool for Foundry agents](/toolboxes/code-interpreter)
- [File search tool for agents](/toolboxes/file-search)
- [Connect agents to MCP servers](/toolboxes/model-context-protocol)
