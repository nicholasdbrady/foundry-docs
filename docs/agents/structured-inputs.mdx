...
For more information about connecting to MCP servers, see [Connect agents to MCP servers](/tools-and-knowledge/model-context-protocol).
...
- [Code Interpreter tool for Foundry agents](/agents/code-interpreter)
- [File search tool for agents](/agents/file-search)
- [Connect agents to MCP servers](/tools-and-knowledge/model-context-protocol)
