...
Spoken output has different constraints from text output. See [Optimize voice agent instructions](/agents/optimize-voice-agent-instructions) for the full guidance. The essentials:
