...
<Frame>
  <img src="/images/foundry-agent-identity-model.png" alt="Diagram that shows a Foundry custom blueprint creating exactly one agent identity, with no agent user account." />
</Frame>
...
<Frame>
  <img src="/images/foundry-autopilot-identity-model.png" alt="Diagram that shows one Foundry blueprint hired into two team instances, each with its own agent identity and agent user account." />
</Frame>
...
<Frame>
  <img src="/images/blueprint-sharing.png" alt="Diagram that compares rebuilding an agent for every team with one blueprint producing per-team instances that share logic but hold separate access." />
</Frame>
...
- [Autopilot lifecycle in Microsoft Foundry](/agents/autopilot-lifecycle) covers the stages from building a blueprint to ending an instance.
- [Agent identity concepts in Microsoft Foundry](/agents/agent-identity) covers how Foundry provisions and uses agent identities at runtime.
- [Microsoft Agent 365 integration with Foundry](/agents/agent-365-integration) covers registry sync and which agent types support autopilot publishing.
