...
| **[Publishing](/agents/publish-copilot)** | Version agents, create stable endpoints, and share through Microsoft Teams, Microsoft 365 Copilot, and the Entra Agent Registry. |
...
- **Want the least to manage?** [Start with a prompt agent](/get-started/prompt-agent). Configure instructions, a model, and tools; Foundry runs it with no code or infrastructure.
