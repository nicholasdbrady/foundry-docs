...
- The [Azure Developer CLI (`azd`)](https://learn.microsoft.com/azure/developer/azure-developer-cli/install-azd) with the Foundry agents extension.
- The [Azure CLI (`az`)](https://learn.microsoft.com/cli/azure/install-azure-cli) and [`curl`](https://curl.se/) to call the deployed agent.
