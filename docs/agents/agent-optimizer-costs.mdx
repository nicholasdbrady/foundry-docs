...
<Frame>
  <img src="/images/agent-optimizer-cost-estimate.png" alt="Screenshot of the prompt-agent optimization Review step showing Minimum, Estimated, and Maximum costs with the estimated cost breakdown expanded." />
</Frame>
...
<Frame>
  <img src="/images/agent-optimizer-token-usage.png" alt="Screenshot of the Token usage view showing input, output, total tokens, and estimated cost grouped by optimization phase and model." />
</Frame>
