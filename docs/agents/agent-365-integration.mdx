...
For step-by-step instructions on publishing a Foundry agent to Agent 365, see [Publish an agent as an autopilot in Agent 365](/agents/agent-365).
...
| **[Hosted agent](/agents/hosted-agents)** | ✅ | ✅ | Supported using A365 SDK |
...
This lets you restrict data flows where compliance regulations may require it. For details, see [Configure Agent 365 data collection for Microsoft Foundry](../how-to/configure-agent-365-data-collection).
