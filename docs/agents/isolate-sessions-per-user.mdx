...
<ZonePivot group="azd__python__rest" options={[{"id": "azd", "title": "Azure Developer CLI"}, {"id": "rest", "title": "REST"}, {"id": "python", "title": "Python"}]} defaultValue="azd" />

<ZoneContent group="azd__python__rest" value="azd" options={[{"id": "azd", "title": "Azure Developer CLI"}, {"id": "rest", "title": "REST"}, {"id": "python", "title": "Python"}]} values={["azd", "rest", "python"]} defaultValue="azd">
...
<ZoneContent group="azd__python__rest" value="rest" options={[{"id": "azd", "title": "Azure Developer CLI"}, {"id": "rest", "title": "REST"}, {"id": "python", "title": "Python"}]} values={["azd", "rest", "python"]} defaultValue="azd">
...
<ZoneContent group="azd__python__rest" value="python" options={[{"id": "azd", "title": "Azure Developer CLI"}, {"id": "rest", "title": "REST"}, {"id": "python", "title": "Python"}]} values={["azd", "rest", "python"]} defaultValue="azd">
...
To pass `x-ms-user-identity`, the calling identity must hold the `Microsoft.CognitiveServices/accounts/AIServices/agents/endpoints/UserIdentityImpersonation/action` permission on the agent. A caller without it receives a `403`. Grant this permission to your middle-tier service's identity. For more about agent permissions, see [Hosted agent permissions reference](/agents/hosted-agent-permissions).
