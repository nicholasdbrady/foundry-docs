...
1. Go to Foundry and navigate to Azure OpenAI and the Chat playground.
    ![Screenshot of Foundry portal showing the Chat playground entry point for Azure OpenAI.](/images/navigate-chat-playground.png)
1. Navigate to the default safety system messages integrated in the studio.
    ![Screenshot of Foundry portal showing where to open the system message and safety system message settings.](/images/navigate-system-message.png)
1. Select the system messages that are applicable to your scenario. 
    ![Screenshot of Foundry portal showing a list of available safety system message templates to select.](/images/select-system-message.png)
1. Review and edit the safety system messages based on the best practices outlined here. 
    ![Screenshot of Foundry portal showing an editable safety system message text area.](/images/review-system-message.png)
1. Apply changes and evaluate your system. 
    ![Screenshot of Foundry portal showing how to apply changes and run a test in the Chat playground.](/images/apply-system-message.png)
