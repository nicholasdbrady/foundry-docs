...
</Warning>   > Foundry doesn't save workflows automatically. Select **Save** after every change to preserve your work.
...
1. Configure the agent to send output as a JSON schema:
   ...
   ![Screenshot that shows the window for configuring a JSON schema format for output.](/images/select-parameters.png)
...
1. Copy the desired JSON schema and paste it in the **Add response format** window. The following screenshot shows a math example. Select **Save**.
   ...
   ![Screenshot that shows the addition of a response format in JSON.](/images/response-format.png)

  <Warning>

</Warning>  > Don't include secrets (passwords, keys, tokens) in JSON schemas, prompts, or saved workflow variables.
...
1. Select **Create new variable**. Choose a variable name, and then select **Done**.
   ...
   ![Screenshot that shows options for creating a new variable in a Microsoft Foundry workflow.](/images/save-output.png)
...
1. On the pane that appears, in the **Ask a question** box, enter **What is your name?** or another message. In the **Save user response as** box, enter a variable name; for example, `Var01`. Then select **Done**.
   ...
   ![Screenshot that shows the configuration of a question for sending a message.](/images/ask-a-question-node.png)
...
1. Add a **Send message** action. On the pane that appears, in the **Message to send** area, enter `{Upper(Local.Var01)}`. Then select **Done**.
   ...
   ![Screenshot that shows the variable instantiation for the action of sending a message.](/images/variable-message.png)

1. Select **Preview**.

1. On the preview pane, send a message to the agent to invoke the workflow.

   ![Screenshot that shows the preview of a question for the action of sending a message.](/images/type-question.png)
...
1. Type `System.` in the **Condition** box to build a condition statement for each if/else branch.
   ...
   ![A screenshot showing the system variables in the if-else condition text box.](/images/if-else-condition.png)
