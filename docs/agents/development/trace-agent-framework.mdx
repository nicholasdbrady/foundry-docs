...
- A [Foundry project](/setup/create-projects) with [tracing connected](/agents/development/trace-agent-setup) to Application Insights.
...
1. Confirm tracing is connected for your project. If needed, follow [Set up tracing in Microsoft Foundry](/agents/development/trace-agent-setup).
1. Run your agent at least once.
1. In the Foundry portal, go to **Observability** > **Traces**.
1. Confirm a new trace appears with spans for your agent's operations.
...
- Learn core concepts and architecture in the [Agent tracing overview](/agents/development/trace-agent-concept).
- If you haven't enabled tracing yet, see [Set up tracing in Microsoft Foundry](/agents/development/trace-agent-setup).
- Visualize agent health and performance metrics with the [Agent Monitoring Dashboard](/agents/development/how-to-monitor-agents-dashboard).
