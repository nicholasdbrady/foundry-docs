...
- Use a region that supports hosted agents. For the current supported regions, see [Hosted agents in Microsoft Foundry](/agents/development/hosted-agents#region-availability).
...
<Frame>
<img src="/images/create-instance.png" alt="Screenshot of creating an agent instance of a digital worker in Microsoft Teams." />
</Frame>
...
For more information about agent applications, identity, and publishing behavior in Foundry, see [Publish and share agents in Microsoft Foundry](/agents/development/publish-agent).
...
- [Hosted agents in Microsoft Foundry](/agents/development/hosted-agents)
- [Model Context Protocol (MCP) server authentication](/agents/tools/mcp-authentication)
