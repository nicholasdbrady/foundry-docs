...
1. Select **Publish** to create an agent application.
    ...
    ![Screenshot of the Publish option for an agent version in Microsoft Foundry.](/images/publish-agent.png)
...
![Screenshot of the agent store showing sections such as Your agents and Built by your org.](/images/agent-store.png)
