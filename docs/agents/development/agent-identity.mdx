...
![Screenshot of the JSON view in the Azure portal displaying an agent identity blueprint and agent identity details for a Foundry project.](/images/azure-agent-identity-json-view.png)
...
![Screenshot of the Microsoft Entra admin center that shows the tab for agent identities with an inventory of all agents in the tenant.](/images/entra-admin-center-agent-identities.png)
