...
To learn about Foundry hubs and projects, see [What is Microsoft Foundry?](/overview/what-is-foundry) and [Migrate from hub-based to Foundry projects](../../how-to/migrate-project.md).
</Info>
<Note>
