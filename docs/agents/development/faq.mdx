...
- Classic experience: [Quickstart: Create a new agent](quickstart.md)
...
To learn how conversations and responses work, see [Agent runtime components](../default/agents/concepts/runtime-components.md).
...
For concepts and terminology (for example, conversation and response), see [Agent runtime components](../default/agents/concepts/runtime-components.md).
...
Start with [Tools overview](how-to/tools-classic/overview.md), then see the tool-specific guidance:

- [Use Code Interpreter](how-to/tools-classic/code-interpreter.md)
- [Use File Search](how-to/tools-classic/file-search.md)
...
To understand usage and monitoring options, see [Metrics](how-to/metrics.md) and [Monitor the service](reference/monitor-service.md).
