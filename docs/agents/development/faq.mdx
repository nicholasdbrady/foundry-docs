...
To understand usage and monitoring options, see [Metrics](how-to/metrics.md) and [Monitor the service](../observability/how-to/how-to-monitor-agents-dashboard.md).
