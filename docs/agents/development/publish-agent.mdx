...
- [Azure AI User role](/security/rbac-foundry) on the Agent Application scope to chat with a published agent
...
For more details on setting up your development environment, see [Prepare your development environment](/developer-experience/install-cli-sdk).
