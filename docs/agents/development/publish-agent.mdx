...
![Diagram illustrating how Foundry projects organize agent versions, applications, and deployments, highlighting governance and RBAC roles.](/images/azure-agent-identity-overview.png)
...
![Diagram of an Agent Application routing traffic to a deployment running a specific agent version, showing a stable entry point and traffic flow.](/images/agent-application-routing-diagram.png)
...
[Prepare your development environment](/developer-experience/install-cli-sdk)
