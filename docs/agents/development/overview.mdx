...
sidebarTitle: "What is Foundry Agent Service?"
---
...
| **Observability and debugging** | [Full traceability](../how-to/develop/trace-agents-sdk.md) of conversations, tool invocations, and message traces; [Application Insights integration](/agents/development/metrics) for usage data. |
...
- **You need to debug tool calls or agent behavior**: Start with [trace agents with the SDK](../how-to/develop/trace-agents-sdk.md) and [metrics](/agents/development/metrics).
