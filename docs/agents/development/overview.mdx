...
- A deployed model that your agent can use. Model and region availability can vary; see [models that inform agents](/agents/development/limits-quotas-regions).
...
- For service limits, quotas, regions, and throttling considerations, see [Quotas and limits for Agent Service](/agents/development/limits-quotas-regions).
...
| **Trust and safety** | Integrated [guardrails](/guardrails/guardrails-overview) to help prevent misuse and mitigate prompt injection risks, including cross-prompt injection attacks (XPIA). All outputs are policy governed. |
| **Enterprise integration** | Ability to bring your own [storage](/setup/use-your-own-resources#use-an-existing-azure-cosmos-db-for-nosql-account-for-conversation-storage), [Azure AI Search index](/setup/use-your-own-resources#use-an-existing-azure-ai-search-resource), and [virtual network](how-to\virtual-networks.md) to meet compliance needs. |
| **Observability and debugging** | [Full traceability](/agents/development/trace-agent-concept) of conversations, tool invocations, and message traces; [Application Insights integration](/agents/development/metrics) for usage data. |
...
For configuration guidance, see [Use your own resources](/setup/use-your-own-resources) and [virtual networks](how-to\virtual-networks.md).
...
- **Model isn't available in your region** or **Requests are throttled or fail due to quota**: See [models that inform agents](/agents/development/limits-quotas-regions).
...
- **You need to debug tool calls or agent behavior**: Start with [trace agents](/agents/development/trace-agent-concept).

## Related content

- [Quickstart: Create your first agent](/get-started/get-started-code)
- [Models that inform agents](/agents/development/limits-quotas-regions)
- [Microsoft Foundry SDKs](/api-sdk/sdk-overview)
- [Trace agents](/agents/development/trace-agent-concept)
