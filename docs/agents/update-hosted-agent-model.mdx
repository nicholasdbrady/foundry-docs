...
- An initialized and deployed hosted agent project. For setup, see [Initialize an agent project](/agents/init-agent-project) and [Deploy a hosted agent](/agents/deploy-hosted-agent).
...
- [Azure YAML reference](/agents/azure-yaml-reference) for deployment configuration details.
- [Deploy a hosted agent](/agents/deploy-hosted-agent) to understand how deployment works.
