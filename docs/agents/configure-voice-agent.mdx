...
- [Foundry User role](../../concepts/rbac-foundry) on the project scope, or permission to create and update agents.
...
- A voice-based agent to configure. To create one, see [Quickstart: Create a voice-based prompt agent](/get-started/prompt-voice-agent).
...
<ZonePivot group="azure-cli__csharp__javascript__python" options={[{"id": "python", "title": "Python"}, {"id": "csharp", "title": "C#"}, {"id": "javascript", "title": "JavaScript"}, {"id": "azure-cli", "title": "Azure CLI"}]} defaultValue="python" />

<ZoneContent group="azure-cli__csharp__javascript__python" value="python" options={[{"id": "python", "title": "Python"}, {"id": "csharp", "title": "C#"}, {"id": "javascript", "title": "JavaScript"}, {"id": "azure-cli", "title": "Azure CLI"}]} values={["python", "csharp", "javascript", "azure-cli"]} defaultValue="python">

Install version 2.7.0 or later of the Azure AI Projects client library as shown in [Install the packages](/get-started/prompt-voice-agent).

Use Python 3.10 or later. Set `allow_preview=True` on `AIProjectClient` when you use `.agents` methods with voice definitions.

Sign in with `az login`. Set `FOUNDRY_PROJECT_ENDPOINT` and `FOUNDRY_VOICE_AGENT_NAME` as shown in the [quickstart](/get-started/prompt-voice-agent).

</ZoneContent>
<ZoneContent group="azure-cli__csharp__javascript__python" value="csharp" options={[{"id": "python", "title": "Python"}, {"id": "csharp", "title": "C#"}, {"id": "javascript", "title": "JavaScript"}, {"id": "azure-cli", "title": "Azure CLI"}]} values={["python", "csharp", "javascript", "azure-cli"]} defaultValue="python">
...
<ZoneContent group="azure-cli__csharp__javascript__python" value="javascript" options={[{"id": "python", "title": "Python"}, {"id": "csharp", "title": "C#"}, {"id": "javascript", "title": "JavaScript"}, {"id": "azure-cli", "title": "Azure CLI"}]} values={["python", "csharp", "javascript", "azure-cli"]} defaultValue="python">
...
<ZoneContent group="azure-cli__csharp__javascript__python" value="azure-cli" options={[{"id": "python", "title": "Python"}, {"id": "csharp", "title": "C#"}, {"id": "javascript", "title": "JavaScript"}, {"id": "azure-cli", "title": "Azure CLI"}]} values={["python", "csharp", "javascript", "azure-cli"]} defaultValue="python">
...
<ZonePivot group="azure-cli__csharp__foundry-portal__javascript__python" options={[{"id": "python", "title": "Python"}, {"id": "csharp", "title": "C#"}, {"id": "javascript", "title": "JavaScript"}, {"id": "azure-cli", "title": "Azure CLI"}, {"id": "foundry-portal", "title": "Foundry Portal"}]} defaultValue="python" />

<ZoneContent group="azure-cli__csharp__foundry-portal__javascript__python" value="python" options={[{"id": "python", "title": "Python"}, {"id": "csharp", "title": "C#"}, {"id": "javascript", "title": "JavaScript"}, {"id": "azure-cli", "title": "Azure CLI"}, {"id": "foundry-portal", "title": "Foundry Portal"}]} values={["python", "csharp", "javascript", "azure-cli", "foundry-portal"]} defaultValue="python">
...
`instructions` is the system message inserted into the model's context. Write it for speech: short sentences, no markdown, and no lists that a caller can't hear. For detailed guidance, see [Optimize voice agent instructions](/agents/optimize-voice-agent-instructions).
...
The greeting streams through the normal response events; don't send a user message or `response.create` to trigger it. Receive the greeting's response before sending the first user turn, as shown in the [quickstart](/get-started/prompt-voice-agent).
...
Attach server-side tools such as web search, Azure AI Search, and OpenAPI tools through a toolbox rather than declaring them directly. See [Create and manage a toolbox in Foundry](/toolboxes/toolbox).
...
A client can override `store` for a single session by using the `store` query parameter in the connect request. For information about what you can read back afterward, see [Voice agent tracing, monitoring, and evaluation](/agents/voice-agent-observability).
...
For an end-to-end walkthrough, see [Quickstart: Create a voice-based prompt agent](/get-started/prompt-voice-agent).

</ZoneContent>
<ZoneContent group="azure-cli__csharp__foundry-portal__javascript__python" value="csharp" options={[{"id": "python", "title": "Python"}, {"id": "csharp", "title": "C#"}, {"id": "javascript", "title": "JavaScript"}, {"id": "azure-cli", "title": "Azure CLI"}, {"id": "foundry-portal", "title": "Foundry Portal"}]} values={["python", "csharp", "javascript", "azure-cli", "foundry-portal"]} defaultValue="python">
...
Reference: [VoiceAgentFunctionTool](https://github.com/Azure/azure-sdk-for-net/blob/main/sdk/ai/Azure.AI.Projects.Agents/src/Generated/Models/VoiceAgentFunctionTool.cs), [ModelReaderWriter.Read](https://learn.microsoft.com/dotnet/api/system.clientmodel.primitives.modelreaderwriter.read).
...
A client can override this setting for a single session by using the `store` query parameter in the connect request. For information about what you can read back afterward, see [Voice agent tracing, monitoring, and evaluation](/agents/voice-agent-observability).
...
For a C# client walkthrough, see the [Voice agent .NET sample](https://github.com/Azure/azure-sdk-for-net/blob/main/sdk/ai/Azure.AI.Projects/samples/Sample_VoiceAgent.md). To test a spoken conversation in the playground, see [Quickstart: Create a voice-based prompt agent](/get-started/prompt-voice-agent).

</ZoneContent>
<ZoneContent group="azure-cli__csharp__foundry-portal__javascript__python" value="javascript" options={[{"id": "python", "title": "Python"}, {"id": "csharp", "title": "C#"}, {"id": "javascript", "title": "JavaScript"}, {"id": "azure-cli", "title": "Azure CLI"}, {"id": "foundry-portal", "title": "Foundry Portal"}]} values={["python", "csharp", "javascript", "azure-cli", "foundry-portal"]} defaultValue="python">
...
<ZoneContent group="azure-cli__csharp__foundry-portal__javascript__python" value="azure-cli" options={[{"id": "python", "title": "Python"}, {"id": "csharp", "title": "C#"}, {"id": "javascript", "title": "JavaScript"}, {"id": "azure-cli", "title": "Azure CLI"}, {"id": "foundry-portal", "title": "Foundry Portal"}]} values={["python", "csharp", "javascript", "azure-cli", "foundry-portal"]} defaultValue="python">
...
Changing `modelType` and `model.id` doesn't create the BYOM deployment. Create or confirm it in the Foundry resource before running `azd deploy`. For model deployment steps, see [Deploy models](/models/deploy-models-managed).

Keep the existing audio and advanced settings compatible with the selected model. For a voice wrapper that delegates conversation logic to a hosted agent, use `conversationEngine` instead of these model fields. See [Deploy a hosted voice agent with azd](/agents/deploy-hosted-voice-agent).
...
The `acs` provider is also supported, with different identifier formats. See the [telephony configuration reference](/agents/azure-yaml-reference#telephony-bindings) for the provider values and required fields.
...
This PowerShell example removes the Twilio binding configured in this section. It uses azd's telephony route, `/agents/{agentName}/telephony/{bindingId}`, with `api-version=2025-11-15-preview`. Don't mix this route's identifier format with the `/telephony/bindings` routes and `api-version=v1` in the [telephony SDK and REST guide](/agents/voice-agent-telephony-channels#understand-telephony-bindings).
...
<ZoneContent group="azure-cli__csharp__foundry-portal__javascript__python" value="foundry-portal" options={[{"id": "python", "title": "Python"}, {"id": "csharp", "title": "C#"}, {"id": "javascript", "title": "JavaScript"}, {"id": "azure-cli", "title": "Azure CLI"}, {"id": "foundry-portal", "title": "Foundry Portal"}]} values={["python", "csharp", "javascript", "azure-cli", "foundry-portal"]} defaultValue="python">
...
For lexicon authoring guidance, see [Improve synthesis with the Speech Synthesis Markup Language](https://learn.microsoft.com/azure/ai-services/speech-service/speech-synthesis-markup).
...
For more information, see [Model Context Protocol (MCP) tools](https://learn.microsoft.com/azure/foundry/agents/how-to/tools/model-context-protocol).
...
For current availability and requirements, see [Use real-time text-to-speech avatar](https://learn.microsoft.com/azure/ai-services/speech-service/text-to-speech-avatar/real-time-synthesis-avatar).
...
- [Optimize voice agent instructions](/agents/optimize-voice-agent-instructions)
...
- [Agent development with the Azure Developer CLI](/developer-tools-and-integrations/cli-agent-development)
- [How to use the Voice Live API](https://learn.microsoft.com/azure/ai-services/speech-service/voice-live-how-to)
- [Publish and connect a voice-based agent](/agents/voice-agent-channels-publish)
