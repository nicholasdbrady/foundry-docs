...
Create prompt-based agents in the Foundry portal or your own development environment by using the CLI, SDK, or REST API. For more information, see the [quickstart](/get-started/get-started-code).
