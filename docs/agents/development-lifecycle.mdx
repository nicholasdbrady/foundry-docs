...
To save an agent with a tool attached, you must successfully configure the tool. Reuse configured tools across agents. For information about available tools, see the [tools catalog](/get-started/tool-catalog).
...
- For a code-first workflow you can automate, see [Evaluate your AI agents](/observability/trace-agent-concept).
...
- [Discover tools in Foundry Tools](/get-started/tool-catalog)
