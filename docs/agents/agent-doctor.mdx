...
- For remote checks, an azd environment that resolves to a Foundry project endpoint. For context resolution, see [Understand azd project context](/developer-tools-and-integrations/cli-project-context).
...
- [Debug a hosted agent](/agents/debug-hosted-agent) for broader troubleshooting tactics.
- [Run a hosted agent locally with the Azure Developer CLI](/agents/run-hosted-agent-locally) to validate local startup.
- [Understand azd project context](/developer-tools-and-integrations/cli-project-context) for endpoint resolution used by remote checks.
