...
This article covers how to **expose** your agent as an A2A endpoint that other agents can call. If you want your agent to **call** a remote A2A endpoint, see [Connect to an A2A agent endpoint from Foundry Agent Service](/toolboxes/agent-to-agent).
...
For other authentication options (key-based, OAuth, managed identity), see [Create an A2A connection by using the REST API](/toolboxes/agent-to-agent#create-an-a2a-connection-by-using-the-rest-api).
...
For more language examples (C#, JavaScript, Java, REST), see [Connect to an A2A agent endpoint from Foundry Agent Service](/toolboxes/agent-to-agent).
