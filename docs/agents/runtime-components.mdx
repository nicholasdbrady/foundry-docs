...
For the full list of available tools, see the [tools overview](/get-started/tool-catalog). For best practices, see [Best practices for using tools](/agents/tool-best-practice).
...
For examples that show how conversations and responses work together in code, see [Create and use memory in Foundry Agent Service](/tools-and-knowledge/memory-usage).
...
For conceptual details, see [Memory in Foundry Agent Service](/tools-and-knowledge/what-is-memory). For full implementation guidance, see [Create and use memory](/tools-and-knowledge/memory-usage).
...
- **Be careful with non-Microsoft services**. If your agent calls tools backed by non-Microsoft services, some data might flow to those services. For related considerations, see [Discover tools in the Foundry Tools](/get-started/tool-catalog).
...
- [Discover tools in the Foundry Tools](/get-started/tool-catalog)
...
- [Create and use memory in Foundry Agent Service](/tools-and-knowledge/memory-usage)
