...
For the concepts behind each step and the full end-to-end path, see the [optimization workflow](/agents/agent-optimizer-overview#the-optimization-workflow).
...
<ZonePivot group="azd__csharp__foundry-skills__python__vscode" options={[{"id": "azd", "title": "Azure Developer CLI"}, {"id": "python", "title": "Python"}, {"id": "csharp", "title": "C#"}, {"id": "vscode", "title": "VS Code"}, {"id": "foundry-skills", "title": "Foundry Skills"}]} defaultValue="azd" />

<ZoneContent group="azd__csharp__foundry-skills__python__vscode" value="azd" options={[{"id": "azd", "title": "Azure Developer CLI"}, {"id": "python", "title": "Python"}, {"id": "csharp", "title": "C#"}, {"id": "vscode", "title": "VS Code"}, {"id": "foundry-skills", "title": "Foundry Skills"}]} values={["azd", "python", "csharp", "vscode", "foundry-skills"]} defaultValue="azd">
...
<ZoneContent group="azd__csharp__foundry-skills__python__vscode" value="python" options={[{"id": "azd", "title": "Azure Developer CLI"}, {"id": "python", "title": "Python"}, {"id": "csharp", "title": "C#"}, {"id": "vscode", "title": "VS Code"}, {"id": "foundry-skills", "title": "Foundry Skills"}]} values={["azd", "python", "csharp", "vscode", "foundry-skills"]} defaultValue="azd">
...
<ZoneContent group="azd__csharp__foundry-skills__python__vscode" value="csharp" options={[{"id": "azd", "title": "Azure Developer CLI"}, {"id": "python", "title": "Python"}, {"id": "csharp", "title": "C#"}, {"id": "vscode", "title": "VS Code"}, {"id": "foundry-skills", "title": "Foundry Skills"}]} values={["azd", "python", "csharp", "vscode", "foundry-skills"]} defaultValue="azd">
...
<ZoneContent group="azd__csharp__foundry-skills__python__vscode" value="vscode" options={[{"id": "azd", "title": "Azure Developer CLI"}, {"id": "python", "title": "Python"}, {"id": "csharp", "title": "C#"}, {"id": "vscode", "title": "VS Code"}, {"id": "foundry-skills", "title": "Foundry Skills"}]} values={["azd", "python", "csharp", "vscode", "foundry-skills"]} defaultValue="azd">
...
* [Microsoft Foundry Toolkit for Visual Studio Code](https://aka.ms/foundrytk)
  ...
  updates the [Microsoft Foundry Skill](/get-started/use-microsoft-foundry-skill)
...
extension](/developer-tools-and-integrations/get-started-projects-visual-studio-code).

</Tip>

</ZoneContent>
<ZoneContent group="azd__csharp__foundry-skills__python__vscode" value="foundry-skills" options={[{"id": "azd", "title": "Azure Developer CLI"}, {"id": "python", "title": "Python"}, {"id": "csharp", "title": "C#"}, {"id": "vscode", "title": "VS Code"}, {"id": "foundry-skills", "title": "Foundry Skills"}]} values={["azd", "python", "csharp", "vscode", "foundry-skills"]} defaultValue="azd">
...
If you already have an existing agent project, see [Make your agent optimizer-ready](/agents/make-agent-optimizer-ready) to add optimization support.

If you already have a Foundry project, add `-p <project-resource-id>` to target existing resources.

To optimize an already deployed agent without running `azd ai agent init` or creating `azure.yaml` and `.azure` files, skip this project-creation step and follow [Optimize an existing agent without AZD project files](/agents/optimize-agent-targets#optimize-an-existing-agent-without-azd-project-files).
...
The *eval model* scores each response (any chat-completion model works). The *optimization model* (`--optimize-model`) generates improved candidates and must be from the [supported list](/agents/agent-optimizer-overview#models) (gpt-5 family or DeepSeek). You can also set `optimization_model` under `options:` in `eval.yaml` to avoid passing the flag each time.
...
<Frame>
  <img src="/images/optimize-hosted-agent-vscode-optimize-tab.png" alt="Screenshot of a hosted agent in Foundry Toolkit with the Optimize preview tab selected and the New Optimization button available." />
</Frame>
...
<Frame>
  <img src="/images/optimize-hosted-agent-vscode-select-workspace.png" alt="Screenshot of the Select Workspace prompt in Foundry Toolkit showing Current workspace and Browse options for locating the hosted agent code." />
</Frame>
...
1. Answer the four optimization questions in Copilot Chat:
   ...
   | Optimization model | Select an existing deployment from the [supported optimization models](/agents/agent-optimizer-overview#models). |
...
<Frame>
  <img src="/images/optimize-hosted-agent-vscode-results.png" alt="Screenshot of a completed optimization run in Foundry Toolkit comparing the baseline and generated candidates, with scores, configuration changes, and deployment options." />
</Frame>
...
- [Make your agent optimizer-ready](/agents/make-agent-optimizer-ready)
- [Create an evaluation dataset and evaluators](/agents/create-optimizer-dataset)
- [Optimize agent instructions, skills, tools, and models](/agents/optimize-agent-targets)
- [Run agent evaluations with the azd CLI](https://learn.microsoft.com/azure/foundry/observability/how-to/azure-developer-cli-evaluation)
