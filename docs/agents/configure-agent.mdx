...
For the complete publishing flow, see [Publish agents to Microsoft Copilot and Microsoft Teams by using the REST API](/agents/publish-copilot-virtual-network).
