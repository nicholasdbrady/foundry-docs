...
For the complete publishing flow, see [Publish agents to Microsoft 365 Copilot and Microsoft Teams by using the REST API](/agents/publish-copilot-virtual-network).
