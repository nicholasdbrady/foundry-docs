...
- An active [Microsoft Foundry project](../../how-to/create-projects) with at least one agent deployed.
...
Routines work with projects secured by a virtual network. Because a routine uses the project's existing agent invocation path, it inherits the project's network configuration and doesn't require extra networking setup. For more information, see [Set up private networking for Foundry Agent Service](virtual-networks).

Routines don't support customer-managed key (CMK) encryption. Don't use routines for workloads that require CMK protection.

</Note>

<ZonePivot group="azd__programming-language-csharp__programming-language-javascript__programming-language-python__programming-language-rest" options={[{"id": "programming-language-python", "title": "Python"}, {"id": "programming-language-csharp", "title": "C#"}, {"id": "programming-language-javascript", "title": "JavaScript"}, {"id": "programming-language-rest", "title": "REST"}, {"id": "azd", "title": "Azure Developer CLI"}]} defaultValue="programming-language-python" />

<ZoneContent group="azd__programming-language-csharp__programming-language-javascript__programming-language-python__programming-language-rest" value="programming-language-python" options={[{"id": "programming-language-python", "title": "Python"}, {"id": "programming-language-csharp", "title": "C#"}, {"id": "programming-language-javascript", "title": "JavaScript"}, {"id": "programming-language-rest", "title": "REST"}, {"id": "azd", "title": "Azure Developer CLI"}]} values={["programming-language-python", "programming-language-csharp", "programming-language-javascript", "programming-language-rest", "azd"]} defaultValue="programming-language-python">
...
- Install the [Azure CLI](https://learn.microsoft.com/cli/azure/install-azure-cli) to acquire access tokens.

</ZoneContent>
<ZoneContent group="azd__programming-language-csharp__programming-language-javascript__programming-language-python__programming-language-rest" value="azd" options={[{"id": "programming-language-python", "title": "Python"}, {"id": "programming-language-csharp", "title": "C#"}, {"id": "programming-language-javascript", "title": "JavaScript"}, {"id": "programming-language-rest", "title": "REST"}, {"id": "azd", "title": "Azure Developer CLI"}]} values={["programming-language-python", "programming-language-csharp", "programming-language-javascript", "programming-language-rest", "azd"]} defaultValue="programming-language-python">

- Install the [Azure Developer CLI](https://learn.microsoft.com/azure/developer/azure-developer-cli/install-azd) (`azd` 1.23.13 or later).
...
Reference: [RoutineAuthorization](https://learn.microsoft.com/python/api/azure-ai-projects/azure.ai.projects.models.routineauthorization).
...
To select creator identity from a C# application, use the [REST create request](/agents/use-routines).

</ZoneContent>

{/* markdownlint-disable-next-line MD044 */}
<ZonePivot group="programming-language-javascript__programming-language-rest" options={[{"id": "programming-language-javascript", "title": "JavaScript"}, {"id": "programming-language-rest", "title": "REST"}]} defaultValue="programming-language-javascript" />

<ZoneContent group="programming-language-javascript__programming-language-rest" value="programming-language-javascript" options={[{"id": "programming-language-javascript", "title": "JavaScript"}, {"id": "programming-language-rest", "title": "REST"}]} values={["programming-language-javascript", "programming-language-rest"]} defaultValue="programming-language-javascript">
...
Reference: [RoutineAuthorization](https://learn.microsoft.com/javascript/api/@azure/ai-projects/routineauthorization).
...
<Frame>
<img src="/images/routine-one-time-schedule.png" alt="Screenshot of the New routine dialog with the One-time schedule trigger type selected, showing a date picker and a time picker under Run at." />
</Frame>
...
An event-based trigger runs an agent when an external event occurs, such as a GitHub issue being opened or a message being posted to a Microsoft Teams channel. Event-based triggers rely on a connector connection that Foundry provisions in your account's connector namespace and uses to authenticate to the external system. The trigger references this connection by ID. For more about connector connections, see [Add managed MCP servers powered by connector namespaces](/toolboxes/connectors).
...
The trigger relies on a GitHub connector connection. Foundry provisions the connection to GitHub in your account's connector namespace and authenticates to GitHub through it. The `connection_id` you set on the trigger references this connection. Each tab shows how to create the connection and the routine that uses it. For more about connector connections, see [Add managed MCP servers powered by connector namespaces](/toolboxes/connectors).
...
To connect GitHub in the portal, follow the portal steps in [Add managed MCP servers powered by connector namespaces](/toolboxes/connectors). After the connection exists, create the routine that references it through the REST API, an SDK, or the Azure Developer CLI, as shown in the other tabs.
...
For the complete connector reference, see [Add managed MCP servers powered by connector namespaces](/toolboxes/connectors).
...
The Python SDK creates the routine but not the GitHub connector connection. Create the connection first in the [Foundry portal](/toolboxes/connectors), with the [REST API](/toolboxes/connectors), or with the [Azure Developer CLI](/toolboxes/connectors), then reference it by name in the trigger's `connection_id` field.
...
The C# SDK creates the routine but not the GitHub connector connection. Create the connection first in the [Foundry portal](/toolboxes/connectors), with the [REST API](/toolboxes/connectors), or with the [Azure Developer CLI](/toolboxes/connectors). Then reference it by name in the trigger's `ConnectionId` property.
...
The JavaScript SDK creates the routine but not the GitHub connector connection. Create the connection first in the [Foundry portal](/toolboxes/connectors), with the [REST API](/toolboxes/connectors), or with the [Azure Developer CLI](/toolboxes/connectors), then reference it by name in the trigger's `connection_id` field.
...
The trigger requires a Microsoft Teams connector connection. Foundry provisions the connection in your account's connector namespace and uses it to authenticate to Teams. The `connection_id` in the trigger's `parameters` references this connection. For more about connector connections, see [Add managed MCP servers powered by connector namespaces](/toolboxes/connectors).
...
<ZonePivot group="azd__foundry-portal__programming-language-javascript__programming-language-python__programming-language-rest" options={[{"id": "foundry-portal", "title": "Foundry Portal"}, {"id": "programming-language-rest", "title": "REST"}, {"id": "programming-language-python", "title": "Python"}, {"id": "programming-language-javascript", "title": "JavaScript"}, {"id": "azd", "title": "Azure Developer CLI"}]} defaultValue="foundry-portal" />

<ZoneContent group="azd__foundry-portal__programming-language-javascript__programming-language-python__programming-language-rest" value="foundry-portal" options={[{"id": "foundry-portal", "title": "Foundry Portal"}, {"id": "programming-language-rest", "title": "REST"}, {"id": "programming-language-python", "title": "Python"}, {"id": "programming-language-javascript", "title": "JavaScript"}, {"id": "azd", "title": "Azure Developer CLI"}]} values={["foundry-portal", "programming-language-rest", "programming-language-python", "programming-language-javascript", "azd"]} defaultValue="foundry-portal">

To connect Teams in the portal, follow the portal steps in [Add managed MCP servers powered by connector namespaces](/toolboxes/connectors). After the connection exists, create the routine that references it through the REST API, an SDK, or the Azure Developer CLI, as shown in the other tabs.

</ZoneContent>
<ZoneContent group="azd__foundry-portal__programming-language-javascript__programming-language-python__programming-language-rest" value="programming-language-rest" options={[{"id": "foundry-portal", "title": "Foundry Portal"}, {"id": "programming-language-rest", "title": "REST"}, {"id": "programming-language-python", "title": "Python"}, {"id": "programming-language-javascript", "title": "JavaScript"}, {"id": "azd", "title": "Azure Developer CLI"}]} values={["foundry-portal", "programming-language-rest", "programming-language-python", "programming-language-javascript", "azd"]} defaultValue="foundry-portal">
...
The Python SDK creates the routine but not the Teams connector connection. Create the connection first in the [Foundry portal](/toolboxes/connectors), with the [REST API](/toolboxes/connectors), or with the [Azure Developer CLI](/toolboxes/connectors), then reference it by name in the trigger's `connection_id` parameter.
...
<ZoneContent group="azd__foundry-portal__programming-language-javascript__programming-language-python__programming-language-rest" value="azd" options={[{"id": "foundry-portal", "title": "Foundry Portal"}, {"id": "programming-language-rest", "title": "REST"}, {"id": "programming-language-python", "title": "Python"}, {"id": "programming-language-javascript", "title": "JavaScript"}, {"id": "azd", "title": "Azure Developer CLI"}]} values={["foundry-portal", "programming-language-rest", "programming-language-python", "programming-language-javascript", "azd"]} defaultValue="foundry-portal">

Create the Teams connector connection first by following the azd steps in [Add managed MCP servers powered by connector namespaces](/toolboxes/connectors). After the connection exists, reference it by name in the trigger's `connection_id` parameter.
...
For full setup instructions, usage examples, and how reminders differ from routines, see [Reminder tool for self-scheduling agents](/toolboxes/reminder-tool).
...
- **Agent types.** Routines support prompt agents and hosted agents. They don't support workflow agents. The agent-scheduled [reminder tool](/toolboxes/reminder-tool) is available only for hosted agents.
...
- [Create and configure agents](/agents/configure-agent)
- [Use toolboxes with agents](/toolboxes/toolbox)
