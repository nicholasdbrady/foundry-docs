...
To use your Agent Application in Microsoft Copilot and Teams, see [Publish agents to Microsoft Copilot and Microsoft Teams](/agents/publish-copilot).
...
- Learn how to [publish agents to Microsoft Copilot and Microsoft Teams](/agents/publish-copilot).
