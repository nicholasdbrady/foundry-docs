...
Before deploying a toolbox, verify that your target region supports the tool types you plan to use. For the full compatibility tables, see [Tool support by region and model](/agents/tool-best-practice#tool-support-by-region-and-model).
