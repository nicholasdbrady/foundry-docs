...
For a managed knowledge base experience, see [Foundry IQ](/tools-and-knowledge/foundry-iq-connect). For tool optimization, see [best practices](/agents/tool-best-practice).
