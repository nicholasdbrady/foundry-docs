...
<ZonePivot group="javascript__python" options={[{"id": "python", "title": "Python"}, {"id": "javascript", "title": "JavaScript"}]} defaultValue="python" />

<ZoneContent group="javascript__python" value="python" options={[{"id": "python", "title": "Python"}, {"id": "javascript", "title": "JavaScript"}]} values={["python", "javascript"]} defaultValue="python">
...
<ZoneContent group="javascript__python" value="javascript" options={[{"id": "python", "title": "Python"}, {"id": "javascript", "title": "JavaScript"}]} values={["python", "javascript"]} defaultValue="python">
