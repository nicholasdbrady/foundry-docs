...
If you use a coding agent like GitHub Copilot, the [Microsoft Foundry Skill](/get-started/use-microsoft-foundry-skill) can help you manage versions, endpoints, logs, and lifecycle operations from your project context.
...
<ZonePivot group="csharp__javascript__python" options={[{"id": "python", "title": "Python"}, {"id": "csharp", "title": "C#"}, {"id": "javascript", "title": "JavaScript"}]} defaultValue="python" />

<ZoneContent group="csharp__javascript__python" value="python" options={[{"id": "python", "title": "Python"}, {"id": "csharp", "title": "C#"}, {"id": "javascript", "title": "JavaScript"}]} values={["python", "csharp", "javascript"]} defaultValue="python">
...
<ZoneContent group="csharp__javascript__python" value="csharp" options={[{"id": "python", "title": "Python"}, {"id": "csharp", "title": "C#"}, {"id": "javascript", "title": "JavaScript"}]} values={["python", "csharp", "javascript"]} defaultValue="python">
...
<ZoneContent group="csharp__javascript__python" value="javascript" options={[{"id": "python", "title": "Python"}, {"id": "csharp", "title": "C#"}, {"id": "javascript", "title": "JavaScript"}]} values={["python", "csharp", "javascript"]} defaultValue="python">
...
Role assignments are an Azure Resource Manager operation. Use the Azure CLI commands shown in the REST tab with the agent identity value from the previous step, or use the [Azure Authorization management library for .NET](https://learn.microsoft.com/dotnet/api/overview/azure/resourcemanager.authorization-readme) to create role assignments programmatically.

</ZoneContent>
<ZoneContent group="azd__csharp__javascript__python__rest" value="javascript" options={[{"id": "rest", "title": "REST"}, {"id": "python", "title": "Python"}, {"id": "csharp", "title": "C#"}, {"id": "javascript", "title": "JavaScript"}, {"id": "azd", "title": "Azure Developer CLI"}]} values={["rest", "python", "csharp", "javascript", "azd"]} defaultValue="rest">

Role assignments are an Azure Resource Manager operation. Use the Azure CLI commands shown in the REST tab with the agent identity value from the previous step, or use the [Azure SDK for JavaScript management libraries](https://learn.microsoft.com/javascript/api/overview/azure/) to create role assignments programmatically.
