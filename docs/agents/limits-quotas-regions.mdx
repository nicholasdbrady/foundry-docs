...
[Capability hosts](/agents/capability-hosts) tell Agent Service where to store and process file uploads, vector stores, and conversation history. To store agent data in your own resources, see [Standard agent setup](standard-agent-setup).
...
- [Capability hosts](/agents/capability-hosts)
