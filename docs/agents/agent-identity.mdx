...
* **Model Context Protocol (MCP)**: Use your agent's identity to authenticate with MCP servers that support agent identity authentication. For details, see [Model Context Protocol](/tools-and-knowledge/model-context-protocol) and [MCP server authentication](/tools-and-knowledge/mcp-authentication).
* **Agent-to-Agent (A2A)**: Enable secure communication between agents by using agent identities. For details, see [Agent-to-Agent tool](/tools-and-knowledge/agent-to-agent) and [Agent2Agent (A2A) authentication](/tools-and-knowledge/agent-to-agent-authentication).
...
- [Set up MCP server authentication](/tools-and-knowledge/mcp-authentication#use-agent-identity-authentication)
- [Agent2Agent (A2A) authentication](/tools-and-knowledge/agent-to-agent-authentication)
...
- [Model Context Protocol](/tools-and-knowledge/model-context-protocol)
- [Agent-to-Agent tool](/tools-and-knowledge/agent-to-agent)
