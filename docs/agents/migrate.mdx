...
| `responses.create()` raises a model error | The model name might be incorrect or unavailable in your region. | Verify the model name in your Foundry project and check [model region availability](/agents/limits-quotas-regions). |

## Related content

- [Agent runtime components](/agents/runtime-components)
- [Quickstart: Create a Hosted agent](/agents/quickstart-hosted-agent)
