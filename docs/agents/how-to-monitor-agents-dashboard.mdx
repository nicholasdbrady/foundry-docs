...
Define the evaluation and the rule that runs when a response completes. To learn more about supported evaluators, see [Built in evaluators](/evaluation/built-in-evaluators).
