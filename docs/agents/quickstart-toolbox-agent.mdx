...
In this quickstart, you build a [toolbox](/agents/toolbox) that combines two tools behind one managed endpoint:
...
- [Curate an intent-based toolbox in Foundry](/agents/toolbox)
