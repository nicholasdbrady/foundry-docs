...
2. **Publish the new agent to Microsoft 365 and Teams** from the Foundry portal. Publishing is only available through the Foundry portal—there's no public publish API. For steps, see [Publish agents to Microsoft 365 Copilot and Microsoft Teams](/agents/publish-copilot).
...
- [Publish agents to Microsoft 365 Copilot and Teams](/agents/publish-copilot)
