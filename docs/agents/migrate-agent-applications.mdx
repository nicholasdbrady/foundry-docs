...
2. **Publish the new agent to Microsoft 365 and Teams** from the Foundry portal. You can only publish through the Foundry portal—there's no public publish API. For steps, see [Publish agents to Microsoft Copilot and Microsoft Teams](/agents/publish-copilot).
...
- [Publish agents to Microsoft Copilot and Teams](/agents/publish-copilot)
