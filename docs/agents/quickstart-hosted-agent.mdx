...
If you use a coding agent like GitHub Copilot, the [Microsoft Foundry Skill](/get-started/use-microsoft-foundry-skill) can help you pick a development path and complete the setup, deployment, and invocation steps.
...
<ZonePivot group="azd__canvas__csharp__foundry-skills__python__vscode" options={[{"id": "azd", "title": "Azure Developer CLI"}, {"id": "python", "title": "Python"}, {"id": "csharp", "title": "C#"}, {"id": "vscode", "title": "VS Code"}, {"id": "canvas", "title": "Canvas"}, {"id": "foundry-skills", "title": "Foundry Skills"}]} defaultValue="azd" />

<ZoneContent group="azd__canvas__csharp__foundry-skills__python__vscode" value="azd" options={[{"id": "azd", "title": "Azure Developer CLI"}, {"id": "python", "title": "Python"}, {"id": "csharp", "title": "C#"}, {"id": "vscode", "title": "VS Code"}, {"id": "canvas", "title": "Canvas"}, {"id": "foundry-skills", "title": "Foundry Skills"}]} values={["azd", "python", "csharp", "vscode", "canvas", "foundry-skills"]} defaultValue="azd">

* [Azure Developer CLI (azd) 1.27.1 or later](https://learn.microsoft.com/azure/developer/azure-developer-cli/install-azd).
...
<ZoneContent group="azd__canvas__csharp__foundry-skills__python__vscode" value="python" options={[{"id": "azd", "title": "Azure Developer CLI"}, {"id": "python", "title": "Python"}, {"id": "csharp", "title": "C#"}, {"id": "vscode", "title": "VS Code"}, {"id": "canvas", "title": "Canvas"}, {"id": "foundry-skills", "title": "Foundry Skills"}]} values={["azd", "python", "csharp", "vscode", "canvas", "foundry-skills"]} defaultValue="azd">
...
<ZoneContent group="azd__canvas__csharp__foundry-skills__python__vscode" value="csharp" options={[{"id": "azd", "title": "Azure Developer CLI"}, {"id": "python", "title": "Python"}, {"id": "csharp", "title": "C#"}, {"id": "vscode", "title": "VS Code"}, {"id": "canvas", "title": "Canvas"}, {"id": "foundry-skills", "title": "Foundry Skills"}]} values={["azd", "python", "csharp", "vscode", "canvas", "foundry-skills"]} defaultValue="azd">
...
<ZoneContent group="azd__canvas__csharp__foundry-skills__python__vscode" value="vscode" options={[{"id": "azd", "title": "Azure Developer CLI"}, {"id": "python", "title": "Python"}, {"id": "csharp", "title": "C#"}, {"id": "vscode", "title": "VS Code"}, {"id": "canvas", "title": "Canvas"}, {"id": "foundry-skills", "title": "Foundry Skills"}]} values={["azd", "python", "csharp", "vscode", "canvas", "foundry-skills"]} defaultValue="azd">

* [Visual Studio Code](https://code.visualstudio.com/).
* [Microsoft Foundry Toolkit for Visual Studio Code](https://aka.ms/foundrytk).

</ZoneContent>
<ZoneContent group="azd__canvas__csharp__foundry-skills__python__vscode" value="canvas" options={[{"id": "azd", "title": "Azure Developer CLI"}, {"id": "python", "title": "Python"}, {"id": "csharp", "title": "C#"}, {"id": "vscode", "title": "VS Code"}, {"id": "canvas", "title": "Canvas"}, {"id": "foundry-skills", "title": "Foundry Skills"}]} values={["azd", "python", "csharp", "vscode", "canvas", "foundry-skills"]} defaultValue="azd">
...
* [Azure Developer CLI (azd) 1.27.1 or later](https://learn.microsoft.com/azure/developer/azure-developer-cli/install-azd). The canvas uses `azd` to test and deploy the agent.
* The `azd microsoft.foundry` extension. Install and verify the extension after `azd` is installed:
...
<ZoneContent group="azd__canvas__csharp__foundry-skills__python__vscode" value="foundry-skills" options={[{"id": "azd", "title": "Azure Developer CLI"}, {"id": "python", "title": "Python"}, {"id": "csharp", "title": "C#"}, {"id": "vscode", "title": "VS Code"}, {"id": "canvas", "title": "Canvas"}, {"id": "foundry-skills", "title": "Foundry Skills"}]} values={["azd", "python", "csharp", "vscode", "canvas", "foundry-skills"]} defaultValue="azd">
...
1. Connect [Foundry Toolboxes](/toolboxes/toolbox) and their tools to give the agent capabilities, such as calling APIs or running code.
1. Connect [skills](/toolboxes/skills) that package reusable logic for the agent to use.
