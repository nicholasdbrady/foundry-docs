...
* If you have an existing Foundry project, you need `Foundry Project Manager` at project scope. If you need to create a new Foundry project, you need the `Owner` role at resource group scope. For the full role matrix, see [Hosted agent permissions reference](/agents/hosted-agent-permissions).
* [Python 3.13 or later](https://www.python.org/downloads/).

<ZonePivot group="azd__canvas__foundry-skills__python__vscode" options={[{"id": "azd", "title": "Azure Developer CLI"}, {"id": "python", "title": "Python"}, {"id": "vscode", "title": "VS Code"}, {"id": "canvas", "title": "Canvas"}, {"id": "foundry-skills", "title": "Foundry Skills"}]} defaultValue="azd" />

<ZoneContent group="azd__canvas__foundry-skills__python__vscode" value="azd" options={[{"id": "azd", "title": "Azure Developer CLI"}, {"id": "python", "title": "Python"}, {"id": "vscode", "title": "VS Code"}, {"id": "canvas", "title": "Canvas"}, {"id": "foundry-skills", "title": "Foundry Skills"}]} values={["azd", "python", "vscode", "canvas", "foundry-skills"]} defaultValue="azd">

* [Azure Developer CLI (azd) 1.25.3 or later](https://learn.microsoft.com/azure/developer/azure-developer-cli/install-azd).
...
<ZoneContent group="azd__canvas__foundry-skills__python__vscode" value="python" options={[{"id": "azd", "title": "Azure Developer CLI"}, {"id": "python", "title": "Python"}, {"id": "vscode", "title": "VS Code"}, {"id": "canvas", "title": "Canvas"}, {"id": "foundry-skills", "title": "Foundry Skills"}]} values={["azd", "python", "vscode", "canvas", "foundry-skills"]} defaultValue="azd">
...
<ZoneContent group="azd__canvas__foundry-skills__python__vscode" value="vscode" options={[{"id": "azd", "title": "Azure Developer CLI"}, {"id": "python", "title": "Python"}, {"id": "vscode", "title": "VS Code"}, {"id": "canvas", "title": "Canvas"}, {"id": "foundry-skills", "title": "Foundry Skills"}]} values={["azd", "python", "vscode", "canvas", "foundry-skills"]} defaultValue="azd">

* [Visual Studio Code](https://code.visualstudio.com/).
* [Microsoft Foundry Toolkit for Visual Studio Code](https://aka.ms/foundrytk).

</ZoneContent>
<ZoneContent group="azd__canvas__foundry-skills__python__vscode" value="canvas" options={[{"id": "azd", "title": "Azure Developer CLI"}, {"id": "python", "title": "Python"}, {"id": "vscode", "title": "VS Code"}, {"id": "canvas", "title": "Canvas"}, {"id": "foundry-skills", "title": "Foundry Skills"}]} values={["azd", "python", "vscode", "canvas", "foundry-skills"]} defaultValue="azd">

* [GitHub Copilot App](https://github.com/features/copilot).
* The Foundry Agent Canvas extension. To install it, in the GitHub Copilot App open **Settings** > **Plugins**, search for `foundry-agent-canvas`, and select **Install**. For other install options, see [What is the Foundry Agent Canvas?](/developer-tools-and-integrations/foundry-agent-canvas#install-the-foundry-agent-canvas)
* [Azure Developer CLI (azd) 1.25.3 or later](https://learn.microsoft.com/azure/developer/azure-developer-cli/install-azd). The canvas uses `azd` to test and deploy the agent.
* The `azd microsoft.foundry` extension. Install and verify the extension after `azd` is installed:
...
<ZoneContent group="azd__canvas__foundry-skills__python__vscode" value="foundry-skills" options={[{"id": "azd", "title": "Azure Developer CLI"}, {"id": "python", "title": "Python"}, {"id": "vscode", "title": "VS Code"}, {"id": "canvas", "title": "Canvas"}, {"id": "foundry-skills", "title": "Foundry Skills"}]} values={["azd", "python", "vscode", "canvas", "foundry-skills"]} defaultValue="azd">

* A coding agent host with the
  [Microsoft Foundry Skill](/get-started/use-microsoft-foundry-skill)
  installed.
...
<ZonePivot group="azd__canvas__python__vscode" options={[{"id": "azd", "title": "Azure Developer CLI"}, {"id": "python", "title": "Python"}, {"id": "vscode", "title": "VS Code"}, {"id": "canvas", "title": "Canvas"}]} defaultValue="azd" />

<ZoneContent group="azd__canvas__python__vscode" value="azd" options={[{"id": "azd", "title": "Azure Developer CLI"}, {"id": "python", "title": "Python"}, {"id": "vscode", "title": "VS Code"}, {"id": "canvas", "title": "Canvas"}]} values={["azd", "python", "vscode", "canvas"]} defaultValue="azd">
...
<ZoneContent group="azd__canvas__python__vscode" value="python" options={[{"id": "azd", "title": "Azure Developer CLI"}, {"id": "python", "title": "Python"}, {"id": "vscode", "title": "VS Code"}, {"id": "canvas", "title": "Canvas"}]} values={["azd", "python", "vscode", "canvas"]} defaultValue="azd">
...
<ZoneContent group="azd__canvas__python__vscode" value="vscode" options={[{"id": "azd", "title": "Azure Developer CLI"}, {"id": "python", "title": "Python"}, {"id": "vscode", "title": "VS Code"}, {"id": "canvas", "title": "Canvas"}]} values={["azd", "python", "vscode", "canvas"]} defaultValue="azd">
...
<ZoneContent group="azd__canvas__python__vscode" value="canvas" options={[{"id": "azd", "title": "Azure Developer CLI"}, {"id": "python", "title": "Python"}, {"id": "vscode", "title": "VS Code"}, {"id": "canvas", "title": "Canvas"}]} values={["azd", "python", "vscode", "canvas"]} defaultValue="azd">
...
1. Connect [Foundry Toolboxes](/agents/toolbox) and their tools to give the agent capabilities, such as calling APIs or running code.
1. Connect [skills](/tools-and-knowledge/skills) that package reusable logic for the agent to use.
1. Assign [guardrails](/agents/add-hosted-agent-guardrails) to apply safety and content controls.
...
<ZonePivot group="foundry-skills__python" options={[{"id": "python", "title": "Python"}, {"id": "foundry-skills", "title": "Foundry Skills"}]} defaultValue="python" />

<ZoneContent group="foundry-skills__python" value="python" options={[{"id": "python", "title": "Python"}, {"id": "foundry-skills", "title": "Foundry Skills"}]} values={["python", "foundry-skills"]} defaultValue="python">
...
<ZoneContent group="foundry-skills__python" value="foundry-skills" options={[{"id": "python", "title": "Python"}, {"id": "foundry-skills", "title": "Foundry Skills"}]} values={["python", "foundry-skills"]} defaultValue="python">
...
[Use the Microsoft Foundry Skill in coding agents](/get-started/use-microsoft-foundry-skill).
...
<ZonePivot group="azd__canvas__foundry-skills__vscode" options={[{"id": "azd", "title": "Azure Developer CLI"}, {"id": "vscode", "title": "VS Code"}, {"id": "canvas", "title": "Canvas"}, {"id": "foundry-skills", "title": "Foundry Skills"}]} defaultValue="azd" />

<ZoneContent group="azd__canvas__foundry-skills__vscode" value="azd" options={[{"id": "azd", "title": "Azure Developer CLI"}, {"id": "vscode", "title": "VS Code"}, {"id": "canvas", "title": "Canvas"}, {"id": "foundry-skills", "title": "Foundry Skills"}]} values={["azd", "vscode", "canvas", "foundry-skills"]} defaultValue="azd">
...
<ZoneContent group="azd__canvas__foundry-skills__vscode" value="vscode" options={[{"id": "azd", "title": "Azure Developer CLI"}, {"id": "vscode", "title": "VS Code"}, {"id": "canvas", "title": "Canvas"}, {"id": "foundry-skills", "title": "Foundry Skills"}]} values={["azd", "vscode", "canvas", "foundry-skills"]} defaultValue="azd">
...
<ZoneContent group="azd__canvas__foundry-skills__vscode" value="canvas" options={[{"id": "azd", "title": "Azure Developer CLI"}, {"id": "vscode", "title": "VS Code"}, {"id": "canvas", "title": "Canvas"}, {"id": "foundry-skills", "title": "Foundry Skills"}]} values={["azd", "vscode", "canvas", "foundry-skills"]} defaultValue="azd">
...
<ZoneContent group="azd__canvas__foundry-skills__vscode" value="foundry-skills" options={[{"id": "azd", "title": "Azure Developer CLI"}, {"id": "vscode", "title": "VS Code"}, {"id": "canvas", "title": "Canvas"}, {"id": "foundry-skills", "title": "Foundry Skills"}]} values={["azd", "vscode", "canvas", "foundry-skills"]} defaultValue="azd">
...
| Coding agent doesn't load the Microsoft Foundry Skill | Install or reload the skill by following [Use the Microsoft Foundry Skill in coding agents](/get-started/use-microsoft-foundry-skill). |
...
For the full permission and role-assignment matrix, see [Hosted agent permissions reference](/agents/hosted-agent-permissions).
...
<Card title="Build a toolbox and use it with a hosted agent" icon="arrow-right" href="quickstart-toolbox-agent.md" />
## Related content

* [What are hosted agents?](/agents/hosted-agents)
* [What is the Foundry Agent Canvas?](/developer-tools-and-integrations/foundry-agent-canvas)
* [Trace your hosted agent](/agents/quickstart-tracing-hosted-agent)
* [Deploy a hosted agent](/agents/deploy-hosted-agent)
* [Author azure.yaml for hosted agents](/agents/author-azure-yaml)
