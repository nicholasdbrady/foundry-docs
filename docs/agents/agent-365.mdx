...
<Frame>
<img src="/images/hire-copilot-store.png" alt="Screenshot of the Agents for your team section of the Microsoft Copilot agent store, with an autopilot highlighted." />
</Frame>
