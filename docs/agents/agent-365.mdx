...
An autopilot is an agent that acts as itself in Microsoft 365, under its own identity. You don't build an autopilot directly: you build a blueprint, and each autopilot is an instance created from it. For the model behind that, see [What is an autopilot in Microsoft Foundry?](/agents/autopilot-overview)
...
Provisioning creates role assignments as well as resources, which is why Contributor alone isn't enough. For the full matrix, see [Hosted agent permissions reference](/agents/hosted-agent-permissions).
...
Create all resources in a region that supports hosted agents. See [Region availability](/agents/hosted-agents#region-availability).
...
To publish an agent to the agent stores instead, set `publishAsAutopilot` to `false` and omit the agent user template. For that flow, see [Publish agents to Microsoft 365 and Teams by using the REST API](/agents/publish-copilot-virtual-network).
...
<Frame>
<img src="/images/approve-find-request.png" alt="Screenshot of the Requests tab in the Microsoft 365 admin center, with an autopilot listed in the Pending activate state." />
</Frame>
...
<Frame>
<img src="/images/approve-publish-activate.png" alt="Screenshot of the Publish to users step, showing host products, publish audience, and options for who can create agent instances." />
</Frame>
...
<Frame>
<img src="/images/approve-apply-template.png" alt="Screenshot of the Apply template step, showing the policy template list, available licenses, and default protections." />
</Frame>
...
<Frame>
<img src="/images/approve-grant-consent.png" alt="Screenshot of the Accept permissions step, showing agent tool permissions, observability permissions, and the Grant admin consent button." />
</Frame>

1. On **Review and finish**, check the audience, the activation scope, and the policy template, and then select **Publish**.

<Frame>
<img src="/images/approve-review-finish.png" alt="Screenshot of the Review and finish step, summarizing the agent, publish audience, activation scope, and policy template before publishing." />
</Frame>

1. Verify the autopilot on the **Registry** tab. Its status is **Available**.

<Frame>
<img src="/images/approve-registry.png" alt="Screenshot of the Registry tab in the Microsoft 365 admin center, showing the autopilot with a status of Available." />
</Frame>
...
<Frame>
<img src="/images/hire-teams-store.png" alt="Screenshot of the Agents for your team section of the Microsoft Teams app store, with an autopilot highlighted." />
</Frame>

   In Microsoft 365 Copilot, go to **Agents** > **Agents for your team**.

<Frame>
<img src="/images/hire-copilot-store.png" alt="Screenshot of the Agents for your team section of the Microsoft 365 Copilot agent store, with an autopilot highlighted." />
</Frame>
...
<Frame>
<img src="/images/hire-create-agent.png" alt="Screenshot of the Create agent dialog, showing fields for the agent icon, name, alias, domain, description, and manager." />
</Frame>
...
<Frame>
  <img src="/images/hire-teams-greeting.png" alt="Screenshot of a Microsoft Teams chat where a newly hired autopilot sends its first greeting message, labeled as an AI agent." />
</Frame>
...
- [What is an autopilot in Microsoft Foundry?](/agents/autopilot-overview) explains the identity model and why autopilots use blueprints.
- [Autopilot lifecycle in Microsoft Foundry](/agents/autopilot-lifecycle) covers what happens after you publish, including updating and ending an autopilot.
- [Microsoft Agent 365 integration with Foundry](/agents/agent-365-integration) covers registry sync, data collection, and data residency.
