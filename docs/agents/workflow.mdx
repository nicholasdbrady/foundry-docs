...
- [Create hosted agents](/developer-tools-and-integrations/vs-code-agents-workflow-pro-code)
...
- Call and orchestrate Foundry agents from a workflow: [Automate Foundry agents with workflows in Azure Logic Apps](https://learn.microsoft.com/azure/logic-apps/automate-foundry-agents-with-workflows)
