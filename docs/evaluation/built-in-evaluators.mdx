...
Microsoft Foundry includes built-in evaluators to assess the quality, safety, and reliability of AI responses throughout the development lifecycle. This reference lists all available evaluators, their purposes, and guidance on selecting the right one for your use case. You can also create [custom evaluators](/evaluation/custom-evaluators) tailored to your specific evaluation criteria.

As you choose evaluators, the [Microsoft Foundry Skill](/get-started/use-microsoft-foundry-skill) can help connect this reference to evaluation setup, prompt optimization, and troubleshooting workflows.
...
To learn more, see [General purpose evaluators](/evaluation/general-purpose-evaluators).
...
To learn more, see [Textual similarity evaluators](/evaluation/textual-similarity-evaluators).
...
To learn more, see [Retrieval-augmented Generation (RAG) evaluators](/evaluation/rag-evaluators).
...
To learn more, see [Risk and safety evaluators](/evaluation/risk-safety-evaluators).
...
To learn more, see [Agent evaluators](/evaluation/agent-evaluators).
...
To learn more, see [Rubric evaluators](/evaluation/rubric-evaluators).
...
To learn more, see [Azure OpenAI Graders](/evaluation/azure-openai-graders).
...
To learn more, see [Custom evaluators](/evaluation/custom-evaluators).
...
- [General purpose evaluators](/evaluation/general-purpose-evaluators)
- [Textual similarity evaluators](/evaluation/textual-similarity-evaluators)
- [Retrieval-augmented Generation (RAG) evaluators](/evaluation/rag-evaluators)
- [Risk and safety evaluators](/evaluation/risk-safety-evaluators)
- [Agent evaluators](/evaluation/agent-evaluators)
- [Rubric evaluators](/evaluation/rubric-evaluators)
- [Azure OpenAI Graders](/evaluation/azure-openai-graders)
- [Custom evaluators](/evaluation/custom-evaluators)
- [Evaluate generative AI apps in Foundry](/evaluation/evaluate-generative-ai-app)
