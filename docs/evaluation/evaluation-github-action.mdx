...
- [Evaluation in Azure DevOps](/evaluation/evaluation-azure-devops)
- [How to evaluate generative AI models and applications with Microsoft Foundry](/evaluation/evaluate-generative-ai-app)
