...
For details on running evaluations and configuring data sources, see [Run evaluations from the SDK](/evaluation/cloud-evaluation).
...
For setup steps, see [Monitor agents in the dashboard](/agents/how-to-monitor-agents-dashboard).

## Related content

- [Run evaluations from the SDK](/evaluation/cloud-evaluation)
- [Monitor agents in the dashboard](/agents/how-to-monitor-agents-dashboard)
