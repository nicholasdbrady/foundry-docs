...
- A completed evaluation run.
    - To run evaluations in the portal, see [Evaluate generative AI models and applications](/evaluation/evaluate-generative-ai-app).
    - To run evaluations from the SDK, see [Run evaluations from the SDK](/evaluation/cloud-evaluation) or [Evaluate your AI agents](/evaluation/evaluate-agent).
...
To learn more, see [Built in evaluators](/evaluation/built-in-evaluators).
...
| All safety metrics zero | Category disabled or unsupported model | Confirm model and evaluator support in [Risk and safety evaluators](/evaluation/built-in-evaluators#risk-and-safety-evaluators) |
| Groundedness unexpectedly low | Retrieval/context incomplete | Verify context construction / retrieval latency |

## Related content

- [Run evaluations from the Microsoft Foundry portal](/evaluation/evaluate-generative-ai-app)
- [Run batch evaluations from the SDK](/evaluation/cloud-evaluation)
- [Built-in evaluators](/evaluation/built-in-evaluators)
- [Improve model performance with fine-tuning](/models/fine-tuning)
