...
- [Microsoft concept documentation on how safety evaluation works](/evaluation/risk-safety-evaluators)
- [Microsoft how-to documentation on using safety evaluations](/evaluation/evaluate-generative-ai-app)
