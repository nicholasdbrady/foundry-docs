...
- One or more [completed evaluation runs](/evaluation/cloud-evaluation).
- A deployed model in your project to use for cluster analysis generation. To learn more, see [Create model deployments](/models/create-model-deployments).
...
- **Re-evaluate** — After making changes, run a new evaluation and generate a fresh cluster analysis to compare results. See [Run evaluations from the SDK](/evaluation/cloud-evaluation).
...
| No models appear in the generation window | No models are deployed in the project | Deploy a model in your project. See [Create model deployments](/models/create-model-deployments). |
