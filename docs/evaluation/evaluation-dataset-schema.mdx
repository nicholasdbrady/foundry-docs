...
[generated synthetic queries](/evaluation/cloud-evaluation-synthetic-data#generate-synthetic-queries)
...
[Tool definitions format](/evaluation/agent-evaluators#tool-definitions-format).
...
[Generate a simulation seed dataset](/evaluation/evaluation-dataset-synthetic#generate-a-simulation-seed-dataset-sdk).
...
[Evaluate a CSV dataset](/evaluation/cloud-evaluation-datasets#evaluate-a-csv-dataset).
...
[Set up evaluators and data mappings](/evaluation/cloud-evaluation-targets#set-up-evaluators-and-data-mappings).
...
<Card title="Run evaluations from the SDK" icon="arrow-right" href="cloud-evaluation.md" />
## Related content

- [Evaluation datasets in Microsoft Foundry](/evaluation/evaluation-datasets)
- [Built-in evaluators](/evaluation/built-in-evaluators)
