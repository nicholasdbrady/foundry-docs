...
In this article, you learn how to run an agent-targeted evaluation against a [Foundry agent](/agents/overview) or [hosted agent](/agents/hosted-agents) using built-in evaluators for quality, safety, and agent behavior. Specifically, you:
...
To build your own evaluators, see [Custom evaluators](/evaluation/custom-evaluators).
