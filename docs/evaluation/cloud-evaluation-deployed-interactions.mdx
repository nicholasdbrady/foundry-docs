...
Before you begin, complete [client setup](/evaluation/cloud-evaluation#set-up-the-sdk-client). This scenario also requires an [Application Insights resource connected to your Foundry project](/observability/trace-agent-setup).
...
In addition to the general [prerequisites](/evaluation/cloud-evaluation#prerequisites), trace evaluation requires:
