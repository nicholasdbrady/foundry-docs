...
| [Simulated conversations](/evaluation/cloud-evaluation-synthetic-data#simulate-conversations-preview) | You want to generate synthetic test conversations | `azure_ai_target_completions` with `conversation_gen_preview` |
