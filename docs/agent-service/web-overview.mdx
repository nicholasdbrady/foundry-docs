...
- The latest SDK package for your language (Python: `azure-ai-projects`, C#: `Azure.AI.Extensions.OpenAI`, JavaScript: `@azure/ai-projects`). See the [quickstart](/get-started/get-started-code) for installation steps.
