...
- **Embeddings**: Numeric representations of content used for vector similarity search. See [Understand embeddings](/foundry-models/embeddings).
...
- **Use a managed "use your data" experience** if you want a more guided way to connect, ingest, and chat over your data. See [Quickstart: Chat with Azure OpenAI models using your own data](/get-started/get-started-code).
...
- **Guided experience**: See [Quickstart: Chat with Azure OpenAI models using your own data](/get-started/get-started-code).
