...
- Use a region that supports hosted agents. For the current supported regions, see [Hosted agents in Microsoft Foundry](/agent-service/hosted-agents#region-availability).
...
For more information about agent applications, identity, and publishing behavior in Foundry, see [Publish and share agents in Microsoft Foundry](/agent-service/publish-agent).
...
- [Hosted agents in Microsoft Foundry](/agent-service/hosted-agents)
- [Model Context Protocol (MCP) server authentication](/agent-service/mcp-authentication)
