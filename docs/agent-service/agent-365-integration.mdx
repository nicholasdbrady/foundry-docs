...
For step-by-step instructions on publishing a Foundry agent to Agent 365, see [Publish an agent as a digital worker in Agent 365](/agent-service/agent-365).
...
|---|---|---|---|
| **[Prompt agent](/agent-service/prompt-agent)** | ✅ | ✅ | ✅ |
| **[Hosted agent](/agent-service/hosted-agents)** | ✅ | ✅ | Supported using A365 SDK |
| **[Workflow agent](/agent-service/workflow)** | ✅ | ❌ | ❌ |
...
This lets you restrict data flows where compliance regulations may require it. For details, see [Configure Agent 365 data collection for Microsoft Foundry](/security/configure-agent-365-data-collection).

## Related content

- [Configure Agent 365 data collection for Microsoft Foundry](/security/configure-agent-365-data-collection)
