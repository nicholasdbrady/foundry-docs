...
- Assign developers and end users at least the `Foundry User` Azure RBAC role. For more information, see [Azure role-based access control in Foundry](/security/rbac-foundry).
...
- For the REST sample, also set:
  ...
  - Use user identity authentication. Service principal authentication isn't supported for the Fabric data agent.
  - For more information about how agent identity works, see [Agent identity](/agent-service/agent-identity).

## Code example

<Note>

- For more information, see [Get ready to code](/get-started/get-started-code).
...
<Card title="Tool use best practices" icon="arrow-right" href="../../concepts/tool-best-practice.md" />
<Card title="Agent identity" icon="arrow-right" href="../../concepts/agent-identity.md" />
