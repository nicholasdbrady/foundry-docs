...
- Memory currently requires compatible Azure OpenAI chat and embedding model deployments. For a list of supported models, see [Azure OpenAI models and regions for Foundry Agent Service](/agent-service/limits-quotas-regions).
...
For broader Foundry Agent Service quotas and limits, see [Foundry Agent Service quotas and limits](/agent-service/limits-quotas-regions).
