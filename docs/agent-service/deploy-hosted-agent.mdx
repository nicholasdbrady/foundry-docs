...
* Agent code using a [supported framework](/agent-service/hosted-agents#framework-and-language-support)
...
- Image Generation
- Web Search
- MCP connections (see [Connect to Model Context Protocol servers](/agent-service/model-context-protocol))
