...
* (Optional) An [MCP tool](/agent-service/model-context-protocol), if you have one you want to use.
...
* [Azure Developer CLI](https://learn.microsoft.com/azure/developer/azure-developer-cli/install-azd) version 1.24.0 or later
...
For comprehensive details about all permissions and role assignments involved in Hosted agent deployment, see [Hosted agent permissions reference](/agent-service/hosted-agent-permissions).
...
You can see a full list of available tools in the [tool catalog](/agent-service/tool-catalog) article.
