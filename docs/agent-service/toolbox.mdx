...
| [Fabric IQ tool](/agent-service/fabric-iq) | ✔️ | ✔️ | No | No | ✔️ | No |
| Guardrail (RAI policy) | ✔️ | ✔️ | ✔️ | ✔️ | ✔️ | No |
| [Skill references](/agent-service/skills) | ✔️ | ✔️ | ✔️ | ✔️ | ✔️ | No |
| [Tool Search tool](/agent-service/tool-search) | ✔️ | ✔️ | No | No | ✔️ | No |
| [Work IQ tool](/agent-service/work-iq) | ✔️ | ✔️ | No | No | ✔️ | No |
...
- **azd (deploy)**: [Install the Azure Developer CLI](https://learn.microsoft.com/azure/developer/azure-developer-cli/install-azd) and the agent extension: `azd extension install azure.ai.agents`
...
To upload a file for Code Interpreter to use, call `POST {project_endpoint}/openai/v1/files` with `purpose=assistants`. The returned file ID is the value you supply as `<FILE_ID>` in the tool configuration. See [Code Interpreter](/agent-service/code-interpreter) for full upload examples.
...
<ZonePivot group="python__rest-api" options={[{"id": "rest-api", "title": "REST API"}, {"id": "python", "title": "Python"}]} defaultValue="rest-api" />

<ZoneContent group="python__rest-api" value="rest-api" options={[{"id": "rest-api", "title": "REST API"}, {"id": "python", "title": "Python"}]} values={["rest-api", "python"]} defaultValue="rest-api">
...
<ZoneContent group="python__rest-api" value="python" options={[{"id": "rest-api", "title": "REST API"}, {"id": "python", "title": "Python"}]} values={["rest-api", "python"]} defaultValue="rest-api">
