...
For additional agent types (workflow, hosted), see [Agent development lifecycle](/agent-service/development-lifecycle).
...
For the full list of available tools, see the [tools overview](/agent-service/tool-catalog). For best practices, see [Best practices for using tools](/agent-service/tool-best-practice).
...
For examples that show how conversations and responses work together in code, see [Create and use memory in Foundry Agent Service](/agent-service/memory-usage).
...
For details about response modes and how to consume outputs, see [Responses API](/foundry-models/responses).
...
For conceptual details, see [Memory in Foundry Agent Service](/agent-service/what-is-memory). For full implementation guidance, see [Create and use memory](/agent-service/memory-usage).
...
- **Be careful with non-Microsoft services**. If your agent calls tools backed by non-Microsoft services, some data might flow to those services. For related considerations, see [Discover tools in the Foundry Tools](/agent-service/tool-catalog).

## Limits and constraints

Limits can depend on the model, region, and the tools you attach (for example, streaming availability and tool support). For current availability and constraints for responses, see [Responses API](/foundry-models/responses).

## Related content

- [Agent development lifecycle](/agent-service/development-lifecycle)
- [Discover tools in the Foundry Tools](/agent-service/tool-catalog)
...
- [Create and use memory in Foundry Agent Service](/agent-service/memory-usage)
