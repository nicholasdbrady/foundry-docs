...
For complete code examples, see the [new agent quickstart](/agent-service/voice-live-agents-quickstart). The [classic quickstart](voice-live-agents-quickstart-classic) remains available.
