...
This article describes the legacy publishing experience. For the new agent publishing model, see [Migrate from agent applications to the new agent endpoint and publishing experience](/agent-service/migrate-agent-applications).
...
- [Azure AI Project Manager role](/security/rbac-foundry) on the Foundry resource scope to publish agents
...
- Familiarity with [Agent identity concepts in Foundry](/agent-service/agent-identity)
...
For more information about Azure RBAC, see [Role-based access control for Microsoft Foundry](/security/rbac-foundry)    
...
To use your Agent Application in Microsoft 365 Copilot and Teams, see [Publish agents to Microsoft 365 Copilot and Microsoft Teams](/agent-service/publish-copilot).

To publish your agent as a digital worker, see [Publish an agent as a digital worker in Agent 365](/agent-service/agent-365)

### Invoke using the Responses API protocol

To invoke your Agent Application using the Responses API protocol, you need:

- [Azure AI User role](/security/rbac-foundry) on the Agent Application scope
- The `openai` and `azure-identity` packages installed and authenticated as described in [Prepare your development environment](/developer-experience/install-cli-sdk)
...
- Learn about [Agent identity concepts in Foundry](/agent-service/agent-identity)
- Learn about [Hosted agents](/agent-service/hosted-agents)
- Learn how to [publish agents to Microsoft 365 Copilot and Microsoft Teams](/agent-service/publish-copilot)
- [Migrate from Agent Applications to the new agent model](/agent-service/migrate-agent-applications)
