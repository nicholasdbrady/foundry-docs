...
- [Invoke your Agent Application using the Responses API protocol](/agent-service/publish-responses)
- [Publish agents to Microsoft 365 Copilot and Microsoft Teams](/agent-service/publish-copilot) 

If you specifically want to build and publish an agent as a digital worker in Agent 365, see [Publish an agent as a digital worker in Agent 365](/agent-service/agent-365).
...
To use your Agent Application with the Responses API protocol, see [Invoke your Agent Application using the Responses API protocol](/agent-service/publish-responses)
