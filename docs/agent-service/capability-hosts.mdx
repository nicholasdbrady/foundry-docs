...
- Required permissions:
  ...
  - For details, see [Required permissions](/setup/environment-setup#required-permissions) and [Role-based access control (RBAC) in Microsoft Foundry](/security/rbac-foundry).
...
When you create capability hosts at both the account and project levels, your Azure resources store and process agent data. This is **standard agent setup**. For securing your agent service, see [Set up private networking for Foundry Agent Service](/setup/virtual-networks).

To learn more about standard agent setup, see [Built-in enterprise readiness with standard agent setup](/setup/standard-agent-setup).
...
To add connections in the Foundry portal, see [Add a new connection to your project](/setup/connections-add).
...
Reference: [Foundry account management REST API](https://learn.microsoft.com/rest/api/aifoundry/accountmanagement/operation-groups)
...
Reference: [Project Capability Hosts - Create or update](https://learn.microsoft.com/rest/api/aifoundry/accountmanagement/project-capability-hosts/create-or-update)
...
- [Standard agent setup](/setup/standard-agent-setup)
- [Set up your environment](/setup/environment-setup)
- [Add a new connection to your project](/setup/connections-add)
