...
- **Missing capability host**: Create an account-level capability host before deploying. See [Deploy a hosted agent](/agent-service/deploy-hosted-agent#create-an-account-level-capability-host)
