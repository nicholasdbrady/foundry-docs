...
- A Foundry project with Agent Service enabled. For setup instructions, see [Quickstart: Get started with Agent Service](https://learn.microsoft.com/en-us/azure/foundry-classic/agents/quickstart).
