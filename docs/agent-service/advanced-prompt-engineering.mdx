...
If you want guidance and templates designed for safety, see [Safety system messages](/agent-service/system-message) and [Safety system message templates](/agent-service/safety-system-message-templates).
...
- Use [Safety system messages](/agent-service/system-message) if you need safety-focused frameworks.
- Start from [Safety system message templates](/agent-service/safety-system-message-templates) when you want a ready-made baseline.
