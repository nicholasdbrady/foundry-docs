...
To reduce risk, combine system messages with other mitigations such as content filtering. See [Content filtering overview](../../../foundry-classic/foundry-models/concepts/content-filter.md) and the [Azure AI Content Safety quickstart](https://learn.microsoft.com/azure/ai-services/content-safety/quickstart-text) for layered protection.
