...
For design guidance, see [System message design](/agent-service/advanced-prompt-engineering) and [Safety system messages](/agent-service/system-message).
...
If the model refuses too often or allows harmful content, adjust your safety system message and retest. See [Safety system messages](/agent-service/system-message) for iteration strategies.
...
| Responses are inconsistent across runs. | Conflicting instructions or unclear priorities. | Remove conflicts, prioritize rules, and keep the message shorter. See [Common pitfalls](/agent-service/advanced-prompt-engineering#common-pitfalls). |
...
We recommend you adjust your safety system message approach based on an iterative process of identification and evaluation. Learn more in the [Safety system message conceptual guide](/agent-service/system-message).

## Next steps

- Read [Safety system messages](/agent-service/system-message) for authoring guidance and best practices.
- Use [System message design](/agent-service/advanced-prompt-engineering) to avoid common prompt pitfalls.
