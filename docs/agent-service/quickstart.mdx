...
<Tabs>
  <Tab title="Foundry (classic)">
    ...
    This content refers to the [Foundry (classic)](https://ai.azure.com/) portal, which supports hub-based projects and other resource types. To confirm that you're using Foundry (classic), make sure the version toggle in the portal banner is in the **off** position. <img src="/images/classic-foundry.png" />
...
<Frame>
<img src="/images/foundry-playground-navigation.png" alt="Screenshot showing the Playgrounds navigation and the Try Azure Language Playground button in Foundry (classic)." />
</Frame>
...
<Frame>
<img src="/images/language-detection.png" alt="A screenshot showing language detection results with confidence scores and ISO codes displayed in the Details pane of the Foundry portal." />
</Frame>
  ...
  <Tab title="Foundry (new)">

<Note>

This content refers to the [Foundry (new)](https://ai.azure.com/) portal, which supports only Foundry projects and provides streamlined access to models, agents, and tools. For more information, see [What is Microsoft Foundry?](https://learn.microsoft.com/en-us/azure/ai-foundry/what-is-foundry). To confirm that you're using Foundry (new), make sure the version toggle in the portal banner is in the **on** position. <img src="/images/new-foundry.png" />
...
<Frame>
<img src="/images/new-foundry-homepage.png" alt="Screenshot of the Foundry (new) homepage" />
</Frame>
