...
- For API key/token authentication: a project connection configured with your API key or token. See [Add a new connection to your project](/setup/connections-add).
...
1. Create a connection to store your API key.
  ...
  1. Create or select a connection that stores the secret. See [Add a new connection to your project](/setup/connections-add).
...
For more information about how agents authenticate with Microsoft Entra ID, see [Agent identity and authentication](/agent-service/agent-identity).
...
<Frame>
<img src="/images/managed-identity-portal.png" alt="A screenshot showing the managed identity selector in the Azure portal." />
</Frame>
...
<Frame>
<img src="/images/role-assignment-portal.png" alt="A screenshot showing the role assignment selector in the Azure portal." />
</Frame>
...
- [Set up your environment for Foundry Agent Service](/setup/environment-setup)
- [Agent identity and authentication](/agent-service/agent-identity)
