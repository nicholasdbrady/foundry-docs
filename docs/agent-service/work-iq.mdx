...
<ZonePivot group="python__rest-api" options={[{"id": "python", "title": "Python"}, {"id": "rest-api", "title": "REST API"}]} defaultValue="python" />

<ZoneContent group="python__rest-api" value="python" options={[{"id": "python", "title": "Python"}, {"id": "rest-api", "title": "REST API"}]} values={["python", "rest-api"]} defaultValue="python">
...
<ZoneContent group="python__rest-api" value="rest-api" options={[{"id": "python", "title": "Python"}, {"id": "rest-api", "title": "REST API"}]} values={["python", "rest-api"]} defaultValue="python">
