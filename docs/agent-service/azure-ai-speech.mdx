...
<Info>
The Speech MCP tool doesn't support [Network-secured Microsoft Foundry](/setup/virtual-networks). For more information, see [Connect to Model Context Protocol servers](/agent-service/model-context-protocol).
</Info>

## Prerequisites

- An Azure subscription. [Create one for free](https://azure.microsoft.com/pricing/purchase-options/azure-account?cid=msft_learn).
- A [Microsoft Foundry resource](/setup/multi-service-resource) created in a [supported region](../../../../ai-services/speech-service/regions.md). Your Foundry resource includes speech capabilities and is used by the Speech MCP server. The Speech MCP Server is available in all regions where Foundry Agent Service supports [MCP tools](/agent-service/tool-best-practice#tool-support-by-region-and-model).

## Usage support

This article shows how to connect the tool in Foundry portal.

If you want to work with code, see [Connect to Model Context Protocol servers](/agent-service/model-context-protocol) for SDK examples in Python, C#, and JavaScript.
...
- Learn more about MCP connections: [Connect to Model Context Protocol servers](/agent-service/model-context-protocol).
- Review tool usage guidance: [Tool best practices](/agent-service/tool-best-practice).
