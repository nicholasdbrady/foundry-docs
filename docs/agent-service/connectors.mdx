...
<ZonePivot group="foundry-portal__programming-language-rest" options={[{"id": "foundry-portal", "title": "Foundry Portal"}, {"id": "programming-language-rest", "title": "REST"}]} defaultValue="foundry-portal" />

<ZoneContent group="foundry-portal__programming-language-rest" value="foundry-portal" options={[{"id": "foundry-portal", "title": "Foundry Portal"}, {"id": "programming-language-rest", "title": "REST"}]} values={["foundry-portal", "programming-language-rest"]} defaultValue="foundry-portal">
...
<ZoneContent group="foundry-portal__programming-language-rest" value="programming-language-rest" options={[{"id": "foundry-portal", "title": "Foundry Portal"}, {"id": "programming-language-rest", "title": "REST"}]} values={["foundry-portal", "programming-language-rest"]} defaultValue="foundry-portal">
