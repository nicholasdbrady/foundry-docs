...
sidebarTitle: "Quickstart: Multi-turn conversational language understanding (CLU) models with entity slot filling"
---
...
<Frame>
<img src="/images/add-connection.png" alt="Screenshot of the connection window in Foundry." />
</Frame>
...
<Frame>
<img src="/images/models-endpoints.png" alt="Screenshot of the Models and endpoints page in Foundry." />
</Frame>
...
<Frame>
<img src="/images/deploy-model-button.png" alt="Screenshot of the Deploy base model dropdown menu in Foundry." />
</Frame>

1. In the **Select a model** window, choose a model. The **gpt-4** base model is recommended for this project.

<Frame>
<img src="/images/gpt-4-selection.png" alt="Screenshot of the select a model selection in Foundry." />
</Frame>
...
<Frame>
<img src="/images/deploy-gpt-4.png" alt="Screenshot of the gpt-4 deployment window in Foundry." />
</Frame>
...
<Frame>
<img src="/images/add-intent.png" alt="Screenshot of the Add Intent fields." />
</Frame>
...
<Frame>
<img src="/images/add-entity.png" alt="Screenshot of the Add Entities fields." />
</Frame>
...
<Frame>
<img src="/images/add-prebuilt.png" alt="Screenshot of the Add Prebuilt components section." />
</Frame>
...
<Frame>
<img src="/images/model-response.png" alt="Screenshot of the model response in test and json formats." />
</Frame>

1. In the **Details** panel on the right, review the **Top Intent** and detected **Entities**.

<Frame>
<img src="/images/details.png" alt="Screenshot of the Details response window." />
</Frame>
