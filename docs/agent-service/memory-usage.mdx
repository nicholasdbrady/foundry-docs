...
- [Chat model deployment](/foundry-models/create-model-deployments), such as `gpt-5.2`, in your project.
- [Embedding model deployment](/foundry-models/embeddings), such as `text-embedding-3-small`, in your project.
...
- [Chat model deployment](/foundry-models/create-model-deployments), such as `gpt-5.2`, in your project.
- [Embedding model deployment](/foundry-models/embeddings), such as `text-embedding-3-small`, in your project.
- Node.js LTS with a [configured environment](/get-started/get-started-code). The TypeScript samples in this article use the [Azure AI Projects client library for JavaScript](https://learn.microsoft.com/javascript/api/overview/azure/ai-projects-readme).
...
- [Chat model deployment](/foundry-models/create-model-deployments), such as `gpt-5.2`, in your project.
- [Embedding model deployment](/foundry-models/embeddings), such as `text-embedding-3-small`, in your project.
- Azure CLI [authenticated to your subscription](https://learn.microsoft.com/cli/azure/authenticate-azure-cli).
- [Environment variables](#set-environment-variables) configured for your project endpoint and model deployments.
