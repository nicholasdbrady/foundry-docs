...
To evaluate agent interactions that already occurred using traces from Application Insights, see [Trace evaluation](/observability/cloud-evaluation#trace-evaluation-preview) in the cloud evaluation guide.
...
- [Trace evaluation in the cloud](/observability/cloud-evaluation#trace-evaluation-preview)
