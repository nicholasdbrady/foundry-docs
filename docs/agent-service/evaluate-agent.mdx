...
In this article, you learn how to run an agent-targeted evaluation against a [Foundry agent](/agent-service/overview) using built-in evaluators for quality, safety, and agent behavior. Specifically, you:
...
- A [Foundry project](/setup/create-projects) with an [agent](/agent-service/overview).
