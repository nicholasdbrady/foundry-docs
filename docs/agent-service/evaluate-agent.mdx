...
In this article, you learn how to run an agent-targeted evaluation against a [Foundry agent](/agent-service/overview) or [hosted agent](/agent-service/hosted-agents) using built-in evaluators for quality, safety, and agent behavior. Specifically, you:
...
- A [Foundry project](/setup/create-projects) with an [agent](/agent-service/overview) or [hosted agent](/agent-service/hosted-agents).
...
- [Quality evaluators](/observability/general-purpose-evaluators) — Measure the overall quality of generated responses.
- [Text similarity evaluators](/observability/textual-similarity-evaluators) — Compare generated text against reference answers using NLP metrics.
- [Safety evaluators](/observability/risk-safety-evaluators) — Identify potential content and security risks in generated output.
...
This sample works for both prompt agents and hosted agents that use the responses protocol. For hosted agents that use the invocations protocol, the `input_messages` format is different — provide a freeform JSON object instead of the structured template. For details and code samples, see [Hosted agent invocations protocol](/observability/cloud-evaluation#hosted-agent-invocations-protocol) in the cloud evaluation guide.

</Tip>

<Tip>

To evaluate agent interactions that already occurred using traces from Application Insights, see [Trace evaluation](/observability/cloud-evaluation#trace-evaluation) in the cloud evaluation guide.
...
- **Production monitoring**: Monitor your agent in production by using continuous evaluation. For setup instructions, see [Set up continuous evaluation](/agent-service/how-to-monitor-agents-dashboard#set-up-continuous-evaluation).
...
- [Agent Monitoring Dashboard](/agent-service/how-to-monitor-agents-dashboard)
...
- [Trace evaluation in the cloud](/observability/cloud-evaluation#trace-evaluation)
- [Set up tracing in Microsoft Foundry](/agent-service/trace-agent-setup)
