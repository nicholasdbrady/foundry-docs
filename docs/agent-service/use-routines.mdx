...
- An active [Microsoft Foundry project](/setup/create-projects) with at least one agent deployed.
...
<ZoneContent group="azd__programming-language-javascript__programming-language-python__programming-language-rest" value="azd" options={[{"id": "programming-language-python", "title": "Python"}, {"id": "programming-language-javascript", "title": "JavaScript"}, {"id": "programming-language-rest", "title": "REST"}, {"id": "azd", "title": "Azure Developer CLI"}]} values={["programming-language-python", "programming-language-javascript", "programming-language-rest", "azd"]} defaultValue="programming-language-python">
...
- [Create and configure agents](/agent-service/configure-agent)
