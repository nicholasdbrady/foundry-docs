...
- Trace data collected for the target agent. If you haven't set up tracing yet, see [Set up tracing in Microsoft Foundry](/agent-service/trace-agent-setup).
...
| Symptom | Resolution |
|---------|------------|
| Conversation ID or Trace ID isn't visible| Tracing isn't configured for this agent. See [Set up tracing in Microsoft Foundry](/agent-service/trace-agent-setup). |
