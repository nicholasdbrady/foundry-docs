...
<Note>
Start with the [web search tool (preview)](/agent-service/web-search). Learn more about the differences between web search and Grounding with Bing Search (or Grounding with Bing Custom Search) in the [web grounding overview](/agent-service/web-overview).
</Note>
...
<Note>
- You need the latest SDK package. C# and Java require the prerelease version. See the [quickstart](/get-started/get-started-code) for details.
...
- [Web search tool (preview)](/agent-service/web-search) - Use web search without configuring Bing tool parameters
