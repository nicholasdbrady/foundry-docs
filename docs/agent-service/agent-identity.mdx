...
* **Model Context Protocol (MCP)**: Use your agent's identity to authenticate with MCP servers that support agent identity authentication. For details, see [Model Context Protocol (preview)](/agent-service/model-context-protocol) and [MCP server authentication](/agent-service/mcp-authentication).
* **Agent-to-Agent (A2A)**: Enable secure communication between agents by using agent identities. For details, see [Agent-to-Agent tool (preview)](/agent-service/agent-to-agent) and [Agent2Agent (A2A) authentication](/agent-service/agent-to-agent-authentication).
...
- [Model Context Protocol (preview)](/agent-service/model-context-protocol)
- [Agent-to-Agent tool (preview)](/agent-service/agent-to-agent)
