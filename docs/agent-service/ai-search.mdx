...
- Install the SDK package for your preferred language. C# requires the prerelease version. See the [quickstart](/get-started/get-started-code) for details.
...
<Note>
- You need the latest SDK package. C# requires the prerelease version. For more information, see the [quickstart](/get-started/get-started-code).
