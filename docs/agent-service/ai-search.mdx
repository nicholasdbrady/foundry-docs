...
- Install the SDK package for your preferred language. C# and Java require the prerelease version. See the [quickstart](/get-started/get-started-code) for details.
...
<Note>
- You need the latest SDK package. C# and Java require the prerelease version. For more information, see the [quickstart](/get-started/get-started-code).
