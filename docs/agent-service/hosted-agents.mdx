...
Hosted agents support deployment within network-isolated Foundry resources. For more information, see [Configure virtual networks](/setup/virtual-networks).
...
| Publish to Teams, M365, or custom apps | [Publish and share agents](/agent-service/publish-agent) |
