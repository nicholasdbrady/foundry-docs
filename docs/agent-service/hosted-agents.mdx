...
For more information, see [Connect to Model Context Protocol servers](/agent-service/model-context-protocol).
...
If you use the Foundry SDK, you need to perform these steps independently. For more information, see [Enable tracing in your project](/agent-service/trace-agent-concept).
...
For more information about evaluating agents, see [Evaluate your AI agents](/agent-service/trace-agent-concept) and [Agent evaluators](/observability/agent-evaluators).
...
For detailed publishing instructions, see [Publish and share agents](/agent-service/publish-agent).
...
- [Agent identity concepts in Microsoft Foundry](/agent-service/agent-identity)
