...
sidebarTitle: "Azure Language in Foundry Tools - tools and agents"
---
...
* **Language processing**: Access to Azure Language natural language processing (NLP) capabilities, including [Named Entity Recognition](../named-entity-recognition/overview), [Text Analytics for health](../text-analytics-for-health/overview), [Conversational Language Understanding](../conversational-language-understanding/overview), [Custom Question Answering](../question-answering/overview), [Language Detection](../language-detection/overview), [Sentiment Analysis](../sentiment-opinion-mining/overview), [Summarization](../summarization/overview), [Key Phrase Extraction](../key-phrase-extraction/overview), and [PII redaction](../personally-identifiable-information/overview).
...
For connection setup details, see [Create a connection](https://learn.microsoft.com/en-us/azure/ai-foundry/how-to/connections-add).
...
Some Foundry configurations restrict which MCP servers you can use. For example, network-secured Foundry projects can require publicly accessible MCP servers. For details, see [Connect to Model Context Protocol servers (preview)](/agent-service/model-context-protocol).
...
* **Project deployments**: Deploy the following required projects:
  ...
  * Custom Question Answering (CQA) deployment. See [CQA Overview](../question-answering/overview).
  * Conversational Language Understanding (CLU) deployment. See [CLU Overview](../conversational-language-understanding/overview).
...
* **Intent classification**: [**Conversational Language Understanding (CLU)**](../conversational-language-understanding/overview) analyzes user utterances to identify intents and extract entities. The system recognizes conversation patterns and understands context.

* **Response delivery**: [**Custom Question Answering (CQA)**](../question-answering/overview) provides responses drawn from curated knowledge sources. This capability ensures users receive consistent information that aligns with organizational standards.
...
The agent combines Foundry Agent Service capabilities with [**Custom Question Answering**](../question-answering/overview) technology. This integration creates a solution with minimal setup while delivering performance and oversight.
...
In addition to creating the agent from the exact question answering agent template in Agent Catalog, you can also create the agent directly from your CQA project in the Foundry portal. For more information, see [Create and deploy a CQA agent](../question-answering/how-to/deploy-agent).
...
* **Agent Service integration**: The agent integrates Agent Service with [**Custom Question Answering**](../question-answering/overview) capabilities within Azure Language services. This integration eliminates complex configuration requirements and provides access to enterprise security and monitoring features.
...
For detailed connection instructions, see [Create a connection](https://learn.microsoft.com/en-us/azure/ai-foundry/how-to/connections-add).
...
* **The `azd ai agent init` command fails**: Make sure you have the latest version of the [Azure Developer CLI](https://learn.microsoft.com/azure/developer/azure-developer-cli/install-azd) installed and that you're signed in with `azd auth login`.

## Related content

* [Configure Azure resources for Foundry](configure-azure-resources)
* [Create and deploy a CQA agent](../question-answering/how-to/deploy-agent)
* [Connect to Model Context Protocol servers (preview)](/agent-service/model-context-protocol)
