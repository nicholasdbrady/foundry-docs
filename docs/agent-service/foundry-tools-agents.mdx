...
For connection setup details, see [Create a connection](../../../ai-foundry/how-to/connections-add.md).
...
For detailed connection instructions, see [Create a connection](../../../ai-foundry/how-to/connections-add.md).
