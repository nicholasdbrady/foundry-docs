...
For connection setup details, see [Create a connection](/setup/connections-add).
...
For detailed connection instructions, see [Create a connection](/setup/connections-add).
