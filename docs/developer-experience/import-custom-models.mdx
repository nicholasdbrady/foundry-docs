...
Support for deploying custom models is available in all public [Azure regions](https://learn.microsoft.com/azure/reliability/regions-list) with the exception of Azure Government cloud environments.
...
For additional troubleshooting guidance, see [Troubleshoot Fireworks on Foundry](/developer-experience/enable-fireworks-models#troubleshoot-fireworks-on-foundry).
