...
For a full list of features available in the extension, use the Command Palette. Select <kbd>F1</kbd> to open the command palette and search **Foundry**. The following screenshot shows some of the actions for Foundry.
    ![A screenshot of the Visual Studio Code command palette for Foundry.](/images/visual-studio-command-palette-small.png)
</Note>
...
![A screenshot of the Foundry Extension with highlighted sections.](/images/initial-view.png)
...
1. The **Model Catalog** page is displayed.
    ...
    ![Screenshot of the **Model Catalog** page in VS Code.](/images/display-model-catalog.png)
...
![Screenshot of generated sample code file.](/images/sample-code-file.png)
