...
sidebarTitle: "Work with the Microsoft Foundry for Visual Studio Code extension"
---
# Work with the Microsoft Foundry for Visual Studio Code extension (Preview)

[Microsoft Foundry](https://learn.microsoft.com/azure/ai-foundry/what-is-foundry) provides a unified platform for enterprise AI operations, model builders, and application development. This foundation combines production-grade infrastructure with friendly interfaces, ensuring organizations can build and operate AI applications with confidence.
...
- Your subscription needs to be below your [quota limit](/setup/quota) to [deploy a new model in this quickstart](#deploy-a-model-from-the-model-catalog). Otherwise you already need to have a [deployed chat model](/models/capabilities/deploy-foundry-models).

- Set the appropriate RBAC permissions to create and manage Foundry resources with the Visual Studio Code extension. For more information, see [Role-based access control for Foundry](https://learn.microsoft.com/azure/ai-foundry/concepts/rbac-foundry).
...
For a full list of features available in the extension, use the Command Palette. Select <kbd>F1</kbd> to open the command palette and search **Foundry**. The following screenshot shows some of the actions for Foundry.
    <Frame>
  <img src="/images/visual-studio-command-palette-small.png" alt="A screenshot of the Visual Studio Code command palette for Foundry." />
</Frame>
</Note>
...
<Frame>
  <img src="/images/initial-view.png" alt="A screenshot of the Foundry Extension with highlighted sections." />
</Frame>
...
<Note>
To learn more about working with Agents in the Foundry Extension, see the [Work with Agent Service in Visual Studio Code](/developer-experience/vs-code-agents) article.
</Note>
...
The [model catalog](https://learn.microsoft.com/azure/ai-foundry/how-to/model-catalog-overview) in Foundry portal is the hub to discover and use a wide range of models for building generative AI applications.
...
<Frame>
<img src="/images/display-model-catalog.png" alt="Screenshot of the **Model Catalog** page in VS Code." />
</Frame>
...
<Frame>
  <img src="/images/sample-code-file.png" alt="Screenshot of generated sample code file." />
</Frame>
...
- Learn about [working with the Agent Service](/developer-experience/vs-code-agents) using this Visual Studio Code extension.
