...
1. Select the plus (**+**) icon next to the **Agents** subsection to create a new AI agent.
    ...
    ![Screenshot of the plus sign next to the Agents subsection.](/images/select-agent-plus.png)
...
1. The extension generates the **Id** value. Configure the following fields:
   ...
   ![Screenshot of the agent designer for editing and interacting with an AI agent.](/images/agent-designer.png)
...
1. In the designer, in the upper-right corner of the **TOOL** section, select **Add tool**. In the dropdown list, select the tool that you want to add.
    ...
    ![Screenshot of selections in the agent designer for adding a tool.](/images/agent-tool-plus.png)

1. The designer displays the appropriate pane to configure the tool, as shown in the following images:

    - Grounding with Bing search:

      ![Screenshot of the pane for the Grounding with Bing search tool.](/images/agent-bing-tool-dialog.png)

    - File search:

      ![Screenshot of the pane for the file upload tool.](/images/agent-file-search-tool-dialog.png)

    - Code interpreter:

      ![Screenshot of the pane for the code interpreter tool.](/images/agent-ci-tool-dialog.png)

    - OpenAPI 3.0 specified tools:

      ![Screenshot of the pane for the OpenAPI 3.0 specified tools.](/images/agent-openapi-tool-dialog.png)
...
1. In the designer, select the **Create Agent on Foundry** button.
    ...
    ![Screenshot of the agent designer with the button for creating an agent on Foundry highlighted.](/images/agent-deploy.png)

1. In VS Code, refresh the **Azure Resources** view. The deployed agent appears in the **Agents** subsection.

    ![Screenshot of a deployed agent in the Azure Resources view.](/images/agent-deployed.png)
...
![Screenshot of the pane for agent preferences, with the Edit Agent, Open Code File, and Open Playground buttons highlighted.](/images/deployed-agent-view.png)
...
![Screenshot of the pane for agent preferences, with the Update Agent on Foundry button highlighted.](/images/update-agent.png)
...
1. Right-click your deployed agent, and then select the **Open Code File** option. Or, on the **AGENT PREFERENCES** pane, select the **Open Code File** button.
    ...
    ![Screenshot of the agent shortcut menu with the Open Code File option highlighted.](/images/open-agent-code-file.png)
...
1. In the **Choose your preferred SDK** dropdown list, select your preferred SDK for the agent code file, and then select the <kbd>Enter</kbd> key.
    ...
    ![Screenshot of the dropdown list for selecting an SDK as part of agent code file selection.](/images/choose-agent-preferred-sdk.png)
...
1. In the **Choose a language** dropdown list, select your preferred language for the agent code file, and then select the <kbd>Enter</kbd> key.
    ...
    ![Screenshot of the dropdown list for choosing a language as part of agent code file selection.](/images/choose-agent-language.png)
...
1. In the **Choose an auth method** dropdown list, select your preferred authentication method for the agent code file, and then select the <kbd>Enter</kbd> key.
    ...
    ![Screenshot of the dropdown list for choosing an authentication method as part of agent code file selection.](/images/choose-agent-authn-method.png)
...
![Screenshot of a generated agent sample code file.](/images/sample-agent-code-file.png)
...
1. Right-click your deployed agent, and then select the **Open Playground** option.
   ...
   This step opens the **Agent Playground** pane and starts a thread with your agent so that you can send messages.
    ...
    ![Screenshot of the agent playground in Visual Studio Code.](/images/agent-display-playground.png)
...
1. Enter your prompt and view the outputs.
   ...
   This example uses **Bing Grounding** to illustrate a web search for information. The agent uses the model and tools that you configured in the agent designer. The source of the information appears in the section for agent annotations.
    ...
    ![Screenshot of the Agent Playground pane with agent annotations highlighted in VS Code.](/images/agent-playground-run.png)
...
![Screenshot of the threads in the Threads subsection.](/images/thread-list.png)
...
![Screenshot of the pane for thread details.](/images/thread-view.png)
...
![Screenshot of an example JSON file of run details.](/images/run-file.png)
...
1. Right-click the deployed model that you want to delete, and then select **Delete**.
    ...
    ![Screenshot of the shortcut menu with the Delete command for a selected model.](/images/delete-model.png)
