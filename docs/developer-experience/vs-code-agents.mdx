...
sidebarTitle: "Work with Foundry Agent Service in Visual Studio Code"
---
# Work with Foundry Agent Service in Visual Studio Code (preview)

After you [get started with the Microsoft Foundry for Visual Studio Code extension](/developer-experience/get-started-projects-vs-code), use [Foundry Agent Service](https://learn.microsoft.com/azure/ai-services/agents/overview) to build agents. Agents are microservices that:
...
1. [Sign in to your Azure resources](/developer-experience/get-started-projects-vs-code#sign-in-to-your-resources).

1. [Set your default project](/developer-experience/get-started-projects-vs-code#create-a-project).

1. [Deploy a model](/developer-experience/get-started-projects-vs-code#deploy-a-model-from-the-model-catalog) to use with your agent.
...
1. Select the plus (**+**) icon next to the **Agents** subsection to create a new AI agent.
    ...
    <Frame>
  <img src="/images/select-agent-plus.png" alt="Screenshot of the plus sign next to the Agents subsection." />
</Frame>
...
1. The extension generates the **Id** value. Configure the following fields:
   ...
   <Frame>
  <img src="/images/agent-designer.png" alt="Screenshot of the agent designer for editing and interacting with an AI agent." />
</Frame>
...
- [Code interpreter](https://learn.microsoft.com/azure/ai-foundry/agents/how-to/tools/code-interpreter)
- [OpenAPI specified tools](https://learn.microsoft.com/azure/ai-foundry/agents/how-to/tools/openapi-spec)
- [Model Context Protocol (MCP)](https://learn.microsoft.com/azure/ai-foundry/agents/how-to/tools/model-context-protocol)

For more information about using MCP tools, see [Work with Agent Service and MCP server tools in Visual Studio Code (preview)](/developer-experience/vs-code-agents-mcp).
...
1. In the designer, in the upper-right corner of the **TOOL** section, select **Add tool**. In the dropdown list, select the tool that you want to add.
    ...
    <Frame>
  <img src="/images/agent-tool-plus.png" alt="Screenshot of selections in the agent designer for adding a tool." />
</Frame>
...
1. The designer displays the appropriate pane to configure the tool, as shown in the following images:
    ...
    - Grounding with Bing search:
      ...
      <Frame>
  <img src="/images/agent-bing-tool-dialog.png" alt="Screenshot of the pane for the Grounding with Bing search tool." />
</Frame>

    - File search:

      <Frame>
  <img src="/images/agent-file-search-tool-dialog.png" alt="Screenshot of the pane for the file upload tool." />
</Frame>

    - Code interpreter:

      <Frame>
  <img src="/images/agent-ci-tool-dialog.png" alt="Screenshot of the pane for the code interpreter tool." />
</Frame>

    - OpenAPI 3.0 specified tools:

      <Frame>
  <img src="/images/agent-openapi-tool-dialog.png" alt="Screenshot of the pane for the OpenAPI 3.0 specified tools." />
</Frame>
...
1. Right-click your deployed agent, and then select the **Open Code File** option. Or, on the **AGENT PREFERENCES** pane, select the **Open Code File** button.
    ...
    <Frame>
  <img src="/images/open-agent-code-file.png" alt="Screenshot of the agent shortcut menu with the Open Code File option highlighted." />
</Frame>
...
1. In the **Choose your preferred SDK** dropdown list, select your preferred SDK for the agent code file, and then select the <kbd>Enter</kbd> key.
    ...
    <Frame>
  <img src="/images/choose-agent-preferred-sdk.png" alt="Screenshot of the dropdown list for selecting an SDK as part of agent code file selection." />
</Frame>
...
1. In the **Choose a language** dropdown list, select your preferred language for the agent code file, and then select the <kbd>Enter</kbd> key.
    ...
    <Frame>
  <img src="/images/choose-agent-language.png" alt="Screenshot of the dropdown list for choosing a language as part of agent code file selection." />
</Frame>
...
1. In the **Choose an auth method** dropdown list, select your preferred authentication method for the agent code file, and then select the <kbd>Enter</kbd> key.
    ...
    <Frame>
  <img src="/images/choose-agent-authn-method.png" alt="Screenshot of the dropdown list for choosing an authentication method as part of agent code file selection." />
</Frame>
...
<Frame>
  <img src="/images/sample-agent-code-file.png" alt="Screenshot of a generated agent sample code file." />
</Frame>
...
1. Right-click your deployed agent, and then select the **Open Playground** option.
   ...
   This step opens the **Agent Playground** pane and starts a thread with your agent so that you can send messages.
    ...
    <Frame>
  <img src="/images/agent-display-playground.png" alt="Screenshot of the agent playground in Visual Studio Code." />
</Frame>
...
1. Enter your prompt and view the outputs.
   ...
   This example uses **Bing Grounding** to illustrate a web search for information. The agent uses the model and tools that you configured in the agent designer. The source of the information appears in the section for agent annotations.
    ...
    <Frame>
  <img src="/images/agent-playground-run.png" alt="Screenshot of the Agent Playground pane with agent annotations highlighted in VS Code." />
</Frame>
...
<Frame>
  <img src="/images/thread-list.png" alt="Screenshot of the threads in the Threads subsection." />
</Frame>
...
<Frame>
  <img src="/images/thread-view.png" alt="Screenshot of the pane for thread details." />
</Frame>
...
<Frame>
  <img src="/images/run-file.png" alt="Screenshot of an example JSON file of run details." />
</Frame>
