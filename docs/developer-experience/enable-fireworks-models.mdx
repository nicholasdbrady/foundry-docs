...
* To deploy models, you need the **Azure AI Developer** role or higher on the Foundry project. For more information, see [Azure built-in roles](https://learn.microsoft.com/azure/role-based-access-control/built-in-roles#privileged).
