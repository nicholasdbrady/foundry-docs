...
- Foundry project. If you don't have a project, create one with the [Microsoft Foundry SDK Quickstart](https://learn.microsoft.com/azure/ai-foundry/quickstarts/get-started-code).
...
<Frame>
<img src="/images/foundry-mcp-server-tools.png" alt="Screenshot of GitHub Copilot Agent Mode tools list showing Foundry MCP Server tool." />
</Frame>
...
<Frame>
<img src="/images/foundry-mcp-server-tools.png" alt="A screenshot showing Foundry MCP Server as GitHub Copilot tool." />
</Frame>
...
<Frame>
<img src="/images/foundry-mcp-server-run-tool.png" alt="Screenshot of options to run Foundry MCP Server operations." />
</Frame>
...
* [Foundry MCP Server security and best practices](/developer-experience/security-best-practices)
* [Foundry MCP Server tools and example prompts](/developer-experience/available-tools)
