...
---
Declarative agent workflows define predefined sequences of actions for your agents using configurations rather than explicit programming logic. In this article, you add [Foundry Agent workflows](/agent-service/workflow) to an agent and test them by using the [Microsoft Foundry for Visual Studio Code extension](https://aka.ms/foundrytk).
