...
Not all models support Grounding with Bing Search or Grounding with Bing Custom Search. For a full list of models that support these tools, see [Tool support by region and model](/agents/tool-best-practice#tool-support-by-region-and-model).
