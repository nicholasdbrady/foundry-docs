...
For information on optimizing tool usage, see [best practices](/tools-and-knowledge/tool-best-practice).
...
For the full toolbox creation workflow, see [Curate intent-based toolbox in Foundry](/tools-and-knowledge/toolbox#step-1-create-a-toolbox-version).
...
- [Connect to an A2A agent endpoint from Foundry Agent Service](/tools-and-knowledge/agent-to-agent)
