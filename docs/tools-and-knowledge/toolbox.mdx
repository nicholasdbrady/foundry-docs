...
| [Azure AI Search tool](/tools-and-knowledge/ai-search) | ✔️ | ✔️ | ✔️ | ✔️ | ✔️ | ✔️ |
| [Code Interpreter tool](/tools-and-knowledge/code-interpreter) | ✔️ | ✔️ | ✔️ | ✔️ | ✔️ | ✔️ |
| [File Search tool](/tools-and-knowledge/file-search) | ✔️ | ✔️ | ✔️ | ✔️ | ✔️ | ✔️ |
...
### [Azure AI Search](/tools-and-knowledge/ai-search)
...
### [Code Interpreter](/tools-and-knowledge/code-interpreter)
...
The returned file `id` is the value you supply as `<FILE_ID>` in the tool configuration. Files are mounted in the sandbox at `/mnt/data/{file-id}-{original-filename}`. See [Code Interpreter](/tools-and-knowledge/code-interpreter) for additional upload examples and language-specific samples.
...
### [File Search](/tools-and-knowledge/file-search)
...
The resulting vector store ID is the value you supply as `<VECTOR_STORE_ID>`. See [File Search](/tools-and-knowledge/file-search) for full examples in each language.
...
| [Azure AI Search](/tools-and-knowledge/ai-search) | ✅ Supported | Through private endpoint |
| [Code Interpreter](/tools-and-knowledge/code-interpreter) | ✅ Supported | Microsoft backbone network |
...
| [File Search](/tools-and-knowledge/file-search) | ❌ Not supported | Not yet available |
...
Before deploying a toolbox, verify that your target region supports the tool types you plan to use. For the full compatibility tables, see [Tool support by region and model](/tools-and-knowledge/tool-best-practice#tool-support-by-region-and-model).
...
- [Azure AI Search tool](/tools-and-knowledge/ai-search)
