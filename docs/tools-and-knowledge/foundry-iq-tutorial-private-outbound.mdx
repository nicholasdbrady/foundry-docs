...
- Completion of [Set up private inbound connectivity](/tools-and-knowledge/foundry-iq-tutorial-private-inbound).
...
<Card title="Validate end-to-end private agentic retrieval" icon="arrow-right" href="foundry-iq-tutorial-private-retrieval.md" />
