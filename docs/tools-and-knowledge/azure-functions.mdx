...
While [function calling](/agents/function-calling) enables you to define tools that run in-process with your agent code, hosting custom tools on Azure Functions provides extra enterprise capabilities when you need:
...
- [Use function calling with Foundry agents](/agents/function-calling)
