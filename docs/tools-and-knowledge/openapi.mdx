...
For more information about how agents authenticate with Microsoft Entra ID, see [Agent identity and authentication](../../concepts/agent-identity).
...
- [Agent identity and authentication](../../concepts/agent-identity)
