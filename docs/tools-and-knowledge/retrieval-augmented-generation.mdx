...
- **Use agent tools** when you're building an agent that needs retrieval as a tool. For example, see [File search tool for agents](/agents/file-search).
...
- **Agent with retrieval**: If you're building an agent, use retrieval as a tool. See [File search tool for agents](/agents/file-search).
...
- [File search tool for agents](/agents/file-search)
