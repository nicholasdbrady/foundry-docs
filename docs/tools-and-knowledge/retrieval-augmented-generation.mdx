...
- **Embeddings**: Numeric representations of content used for vector similarity search. See [Understand embeddings](/models/embeddings).
- **System message and prompts**: Instructions that guide how the model uses retrieved content. See [Prompt engineering](/models/prompt-engineering) and [Safety system messages](../openai/concepts/system-message).
...
- **Use agent tools** when you're building an agent that needs retrieval as a tool. For example, see [File search tool for agents](/tools-and-knowledge/file-search).
...
- **Agent with retrieval**: If you're building an agent, use retrieval as a tool. See [File search tool for agents](/tools-and-knowledge/file-search).
...
- [File search tool for agents](/tools-and-knowledge/file-search)
