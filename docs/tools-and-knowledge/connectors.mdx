...
For full toolbox configuration and deployment, see [Create and use a Foundry Toolbox](/agents/toolbox).
...
After the connection is created and consent is recorded, reference it from your agent the same way as any other managed MCP server. The simplest path is to add the connection to a [Foundry Toolbox](/agents/toolbox) and attach the toolbox to your agent:
...
For end-to-end agent scaffolding and deployment with `azd`, see [Create and use a Foundry Toolbox](/agents/toolbox).
