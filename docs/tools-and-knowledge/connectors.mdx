...
For other languages and runtime options, see [Connect agents to MCP servers](/tools-and-knowledge/model-context-protocol).
...
For full toolbox configuration and deployment, see [Create and use a Foundry Toolbox](/tools-and-knowledge/toolbox).
...
After the connection is created and consent is recorded, reference it from your agent the same way as any other managed MCP server. The simplest path is to add the connection to a [Foundry Toolbox](/tools-and-knowledge/toolbox) and attach the toolbox to your agent:
...
For end-to-end agent scaffolding and deployment with `azd`, see [Create and use a Foundry Toolbox](/tools-and-knowledge/toolbox).
...
- [Agent tools overview](/get-started/tool-catalog)
