...
sidebarTitle: "Validate End-to-End Private Agentic Retrieval"
---
...
- Completion of [Set up private inbound connectivity](/tools-and-knowledge/foundry-iq-tutorial-private-inbound) and [Set up private outbound connectivity](/tools-and-knowledge/foundry-iq-tutorial-private-outbound).
...
- [Create a blob knowledge source from Azure Blob Storage or ADLS Gen2](https://learn.microsoft.com/azure/search/agentic-knowledge-source-how-to-blob)
