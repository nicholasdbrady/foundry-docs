...
For a managed knowledge base experience, see [Foundry IQ](/tools-and-knowledge/foundry-iq-connect). For tool optimization, see [best practices](/tools-and-knowledge/tool-best-practice).
...
- [Connect a Foundry IQ knowledge base to Foundry Agent Service](/tools-and-knowledge/foundry-iq-connect)
