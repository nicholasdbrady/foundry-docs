...
- Use the [file search tool](/agents/file-search) to search user-provided documents during an interaction.
...
The following limitations and quotas apply to memory in Foundry Agent Service. For broader limitations and quotas, see [Foundry Agent Service limits, quotas, and regional support](/agents/limits-quotas-regions).
...
- Confirm model availability: [Azure OpenAI models and regions for Foundry Agent Service](/agents/limits-quotas-regions)
