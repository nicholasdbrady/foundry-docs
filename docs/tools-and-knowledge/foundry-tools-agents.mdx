...
For connection setup details, see [Create a connection](https://learn.microsoft.com/en-us/azure/foundry/how-to/connections-add).
...
Some Foundry configurations restrict which MCP servers you can use. For example, network-secured Foundry projects can require publicly accessible MCP servers. For details, see [Connect to Model Context Protocol servers (preview)](/tools-and-knowledge/model-context-protocol).
...
You can also create the agent directly from your CQA project in the Foundry portal. For more information, see [Create and deploy a CQA agent](../question-answering/how-to/deploy-agent).
...
For detailed connection instructions, see [Create a connection](https://learn.microsoft.com/en-us/azure/foundry/how-to/connections-add).
