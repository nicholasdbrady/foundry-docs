...
This article explains how to create, manage, and use memory stores. For conceptual information, see [Memory in Foundry Agent Service](/tools-and-knowledge/what-is-memory).
...
For more information about user profile and chat summary memories, see [Memory types](/tools-and-knowledge/what-is-memory#memory-types).
...
- [Memory in Foundry Agent Service](/tools-and-knowledge/what-is-memory)
- [Foundry Agent Service quotas and limits](../concepts/limits-quotas-regions)
