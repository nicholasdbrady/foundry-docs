...
For request-scoped discovery of deferred tool definitions, see [Use tool search with the Azure OpenAI Responses API](/models/tool-search).
...
- An existing or new toolbox with at least one tool. See [Curate intent-based toolbox in Foundry](/agents/toolbox).
...
<Frame>
  <img src="/images/toolbox-vscode-tool-search.png" alt="Screenshot of Foundry Toolkit in Visual Studio Code showing the Build a Custom Toolbox view with the Tool search checkbox selected." />
</Frame>

Publishing a new toolbox creates its first version. That version becomes the default version automatically. For the full toolbox creation workflow, see [Curate intent-based toolbox in Foundry](/agents/toolbox#step-1-create-a-toolbox-version).
...
<ZonePivot group="dotnet__javascript__python__rest-api" options={[{"id": "python", "title": "Python"}, {"id": "rest-api", "title": "REST API"}, {"id": "dotnet", "title": ".NET"}, {"id": "javascript", "title": "JavaScript"}]} defaultValue="python" />

<ZoneContent group="dotnet__javascript__python__rest-api" value="python" options={[{"id": "python", "title": "Python"}, {"id": "rest-api", "title": "REST API"}, {"id": "dotnet", "title": ".NET"}, {"id": "javascript", "title": "JavaScript"}]} values={["python", "rest-api", "dotnet", "javascript"]} defaultValue="python">
...
<ZoneContent group="dotnet__javascript__python__rest-api" value="rest-api" options={[{"id": "python", "title": "Python"}, {"id": "rest-api", "title": "REST API"}, {"id": "dotnet", "title": ".NET"}, {"id": "javascript", "title": "JavaScript"}]} values={["python", "rest-api", "dotnet", "javascript"]} defaultValue="python">
...
<ZoneContent group="dotnet__javascript__python__rest-api" value="dotnet" options={[{"id": "python", "title": "Python"}, {"id": "rest-api", "title": "REST API"}, {"id": "dotnet", "title": ".NET"}, {"id": "javascript", "title": "JavaScript"}]} values={["python", "rest-api", "dotnet", "javascript"]} defaultValue="python">
...
<ZoneContent group="dotnet__javascript__python__rest-api" value="javascript" options={[{"id": "python", "title": "Python"}, {"id": "rest-api", "title": "REST API"}, {"id": "dotnet", "title": ".NET"}, {"id": "javascript", "title": "JavaScript"}]} values={["python", "rest-api", "dotnet", "javascript"]} defaultValue="python">
...
- [Curate intent-based toolbox in Foundry (preview)](/agents/toolbox)
- [Model Context Protocol (MCP)](/tools-and-knowledge/model-context-protocol)
- [Tools overview](/get-started/tool-catalog)
