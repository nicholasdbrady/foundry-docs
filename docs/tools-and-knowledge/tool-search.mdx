...
- An existing or new toolbox with at least one tool. See [Curate intent-based toolbox in Foundry](/tools-and-knowledge/toolbox).
...
Publishing a new toolbox creates its first version. That version becomes the default version automatically. For the full toolbox creation workflow, see [Curate intent-based toolbox in Foundry](/tools-and-knowledge/toolbox#step-1-create-a-toolbox-version).
...
- [Curate intent-based toolbox in Foundry (preview)](/tools-and-knowledge/toolbox)
- [Model Context Protocol (MCP)](/tools-and-knowledge/model-context-protocol)
- [Tools overview](/get-started/tool-catalog)
- [Best practices for tools](/tools-and-knowledge/tool-best-practice)
