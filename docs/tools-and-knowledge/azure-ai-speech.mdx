...
The Speech MCP tool doesn't support [Network-secured Microsoft Foundry](../../../agents/how-to/virtual-networks). For more information, see [Connect to Model Context Protocol servers](/tools-and-knowledge/model-context-protocol).
...
- A [Microsoft Foundry resource](../../../../ai-services/multi-service-resource) created in a [supported region](../../../../ai-services/speech-service/regions). Your Foundry resource includes speech capabilities and is used by the Speech MCP server.
- Your Foundry resource must support MCP tools in Foundry Agent Service. MCP tools require the Agent Service Enterprise tier. For the list of regions and models that support MCP tools, see [Tool support by region and model](/tools-and-knowledge/tool-best-practice#tool-support-by-region-and-model).
...
If you want to work with code, see [Connect to Model Context Protocol servers](/tools-and-knowledge/model-context-protocol) for SDK examples in Python, C#, and JavaScript.
...
1. [Create an Azure Storage account](https://learn.microsoft.com/azure/storage/common/storage-account-create) if you don't already have one.
...
- Learn more about MCP connections: [Connect to Model Context Protocol servers](/tools-and-knowledge/model-context-protocol).
- Review tool usage guidance: [Tool best practices](/tools-and-knowledge/tool-best-practice).
