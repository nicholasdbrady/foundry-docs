...
You're responsible for carefully reviewing and testing applications you build in the context of your specific use cases, and making all appropriate decisions and customizations.  This responsibility includes implementing your own responsible AI mitigations, such as metaprompts, content filters, or other safety systems, and ensuring your applications meet appropriate quality, reliability, security, and trustworthiness standards. [Learn more](../../../responsible-ai/agents/transparency-note).
...
<ZonePivot group="azd__dotnet__javascript__python__rest-api__vscode" options={[{"id": "rest-api", "title": "REST API"}, {"id": "python", "title": "Python"}, {"id": "dotnet", "title": ".NET"}, {"id": "javascript", "title": "JavaScript"}, {"id": "azd", "title": "Azure Developer CLI"}, {"id": "vscode", "title": "VS Code"}]} defaultValue="rest-api" />

<ZoneContent group="azd__dotnet__javascript__python__rest-api__vscode" value="rest-api" options={[{"id": "rest-api", "title": "REST API"}, {"id": "python", "title": "Python"}, {"id": "dotnet", "title": ".NET"}, {"id": "javascript", "title": "JavaScript"}, {"id": "azd", "title": "Azure Developer CLI"}, {"id": "vscode", "title": "VS Code"}]} values={["rest-api", "python", "dotnet", "javascript", "azd", "vscode"]} defaultValue="rest-api">
...
<ZoneContent group="azd__dotnet__javascript__python__rest-api__vscode" value="python" options={[{"id": "rest-api", "title": "REST API"}, {"id": "python", "title": "Python"}, {"id": "dotnet", "title": ".NET"}, {"id": "javascript", "title": "JavaScript"}, {"id": "azd", "title": "Azure Developer CLI"}, {"id": "vscode", "title": "VS Code"}]} values={["rest-api", "python", "dotnet", "javascript", "azd", "vscode"]} defaultValue="rest-api">
...
<ZoneContent group="azd__dotnet__javascript__python__rest-api__vscode" value="azd" options={[{"id": "rest-api", "title": "REST API"}, {"id": "python", "title": "Python"}, {"id": "dotnet", "title": ".NET"}, {"id": "javascript", "title": "JavaScript"}, {"id": "azd", "title": "Azure Developer CLI"}, {"id": "vscode", "title": "VS Code"}]} values={["rest-api", "python", "dotnet", "javascript", "azd", "vscode"]} defaultValue="rest-api">
...
<ZoneContent group="azd__dotnet__javascript__python__rest-api__vscode" value="vscode" options={[{"id": "rest-api", "title": "REST API"}, {"id": "python", "title": "Python"}, {"id": "dotnet", "title": ".NET"}, {"id": "javascript", "title": "JavaScript"}, {"id": "azd", "title": "Azure Developer CLI"}, {"id": "vscode", "title": "VS Code"}]} values={["rest-api", "python", "dotnet", "javascript", "azd", "vscode"]} defaultValue="rest-api">
...
<Frame>
<img src="/images/skills-vs-code-toolbox-add-skills.png" alt="Screenshot of the Build a Custom Toolbox view in the Foundry Toolkit with the Add menu open and Add skills highlighted." />
</Frame>

<Frame>
<img src="/images/skills-vs-code-toolbox-select-skills.png" alt="Screenshot of the Select skills dialog in the Foundry Toolkit showing a configured skill that's ready to add to a toolbox." />
</Frame>
...
For the full toolbox workflow — including connections, versioning, and the `azd ai toolbox skill add`, `azd ai toolbox skill list`, and `azd ai toolbox skill remove` commands — see the [Attach skills to a toolbox](/agents/toolbox#attach-skills-to-a-toolbox) section in the toolbox article. Changes from the imperative `azd` skill commands don't take effect for MCP clients until you promote the new version with `azd ai toolbox publish`.
...
Use the `azd ai skill` commands from the [Azure Developer CLI Foundry extensions](/developer-tools-and-integrations/install-cli-foundry-extensions).
...
<Frame>
  <img src="/images/skills-vs-code-catalog.png" alt="Screenshot of the Tool Catalog in the Foundry Toolkit showing the Skills section with prebuilt skill cards and Add buttons." />
</Frame>
...
<Frame>
  <img src="/images/skills-vs-code-create.png" alt="Screenshot of the Create skill authoring panel in the Foundry Toolkit showing an editable SKILL.md template with name, description, and body." />
</Frame>
...
<Frame>
  <img src="/images/skills-vs-code-upload.png" alt="Screenshot of the Upload a skill dialog in the Foundry Toolkit with a file picker for a SKILL.md file or a zip folder." />
</Frame>
...
<Frame>
  <img src="/images/skills-vs-code-list.png" alt="Screenshot of the Skills tab in the Foundry Toolkit Tools view listing a skill with its name, description, default version, and actions." />
</Frame>
...
<Frame>
  <img src="/images/skills-vs-code-replace-delete.png" alt="Screenshot of the more actions menu in the Skills tab showing the Replace and Delete options for a skill." />
</Frame>
...
<ZonePivot group="dotnet__javascript__python__rest-api__vscode" options={[{"id": "rest-api", "title": "REST API"}, {"id": "python", "title": "Python"}, {"id": "dotnet", "title": ".NET"}, {"id": "javascript", "title": "JavaScript"}, {"id": "vscode", "title": "VS Code"}]} defaultValue="rest-api" />

<ZoneContent group="dotnet__javascript__python__rest-api__vscode" value="rest-api" options={[{"id": "rest-api", "title": "REST API"}, {"id": "python", "title": "Python"}, {"id": "dotnet", "title": ".NET"}, {"id": "javascript", "title": "JavaScript"}, {"id": "vscode", "title": "VS Code"}]} values={["rest-api", "python", "dotnet", "javascript", "vscode"]} defaultValue="rest-api">
...
<ZoneContent group="dotnet__javascript__python__rest-api__vscode" value="python" options={[{"id": "rest-api", "title": "REST API"}, {"id": "python", "title": "Python"}, {"id": "dotnet", "title": ".NET"}, {"id": "javascript", "title": "JavaScript"}, {"id": "vscode", "title": "VS Code"}]} values={["rest-api", "python", "dotnet", "javascript", "vscode"]} defaultValue="rest-api">
...
<ZoneContent group="dotnet__javascript__python__rest-api__vscode" value="dotnet" options={[{"id": "rest-api", "title": "REST API"}, {"id": "python", "title": "Python"}, {"id": "dotnet", "title": ".NET"}, {"id": "javascript", "title": "JavaScript"}, {"id": "vscode", "title": "VS Code"}]} values={["rest-api", "python", "dotnet", "javascript", "vscode"]} defaultValue="rest-api">
...
<ZoneContent group="dotnet__javascript__python__rest-api__vscode" value="javascript" options={[{"id": "rest-api", "title": "REST API"}, {"id": "python", "title": "Python"}, {"id": "dotnet", "title": ".NET"}, {"id": "javascript", "title": "JavaScript"}, {"id": "vscode", "title": "VS Code"}]} values={["rest-api", "python", "dotnet", "javascript", "vscode"]} defaultValue="rest-api">
...
<ZoneContent group="dotnet__javascript__python__rest-api__vscode" value="vscode" options={[{"id": "rest-api", "title": "REST API"}, {"id": "python", "title": "Python"}, {"id": "dotnet", "title": ".NET"}, {"id": "javascript", "title": "JavaScript"}, {"id": "vscode", "title": "VS Code"}]} values={["rest-api", "python", "dotnet", "javascript", "vscode"]} defaultValue="rest-api">
...
- [Curate intent-based toolbox in Foundry](/agents/toolbox)
