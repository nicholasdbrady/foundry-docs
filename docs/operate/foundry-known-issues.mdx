...
* To set up outage notifications and alerts, visit the [Azure Service Health Portal](https://learn.microsoft.com/azure/service-health/service-health-portal-update).
