...
<Tip>
To learn how to use protected material detection in your applications, see [Quickstart: Protected material for text](../../../ai-services/content-safety/quickstart-protected-material.md) and [Quickstart: Protected material for code](/guardrails/quickstart-protected-material-code).
</Tip>
