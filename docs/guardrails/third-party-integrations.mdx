...
- **Key Vault**: Create at least one [Key Vault with the Key Vault Administrator role assigned to you](https://learn.microsoft.com/azure/key-vault/).
...
1. Select a [**Keyvault**](https://learn.microsoft.com/azure/key-vault/) and [**Managed Identity**](/entra/identity/managed-identities-azure-resources/overview). 
...
1. Follow the main Foundry Guardrail flow to [assign a custom guardrail](/guardrails/guardrails-overview) with an active third-party integration to a model or agent.
