...
sidebarTitle: "Limited access to Azure OpenAI in Microsoft Foundry Models"
---
...
Frequently asked questions about Limited Access can be found on the [Foundry Tools Limited Access](https://learn.microsoft.com/azure/ai-services/cognitive-services-limited-access) page. If you need help with Azure OpenAI, see the [Foundry Tools support options](https://learn.microsoft.com/azure/ai-services/cognitive-services-support-options) page. Report abuse of Azure OpenAI [here](https://aka.ms/reportabuse).

## See also

- [Code of conduct for Azure OpenAI Service integrations](/legal/ai-code-of-conduct)
- [Transparency note for Azure OpenAI Service](/responsible-ai/transparency-note)
- [Data, privacy, and security for Azure OpenAI Service](/responsible-ai/data-privacy)
