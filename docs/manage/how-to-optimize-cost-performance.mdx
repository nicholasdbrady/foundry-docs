...
1. Deploy the new model. Ask AI can initiate the deployment for you directly in the chat or provide a link to the deployment page. You can also deploy manually. For detailed deployment steps, see [Deploy models as serverless API deployments](../../foundry-classic/how-to/deploy-models-serverless.md) or [Deploy models with managed compute](/foundry-models/deploy-models-managed).
