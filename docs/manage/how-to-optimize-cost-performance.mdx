...
- The Ask AI agent enabled in your Foundry project. It's available in preview on the toolbar of the Foundry portal. If you don't see it, verify that your project is in a [supported region](/manage/overview) and that your administrator hasn't disabled the feature.
