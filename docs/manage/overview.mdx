...
![Diagram that depicts Foundry Control Plane unified fleet visibility with agents, models, and tools listed across projects in a subscription.](/images/control-plane-overall.png)
...
![Screenshot that shows the Operate toolbar button and the Overview pane in the Foundry workspace.](/images/control-plane-operate.png)

### Overview

Use the **Overview** pane to understand fleet health, performance, and compliance at a glance.

![Animation of the Overview pane that displays trend-based health scores, alert summaries, and aggregated compliance metrics for a fleet.](/images/control-plane-overview.gif)
...
![Screenshot of an agent inventory table with filters and sort options applied to display metadata and health indicators for AI assets.](/images/assets-view.png)
...
![Screenshot of the Compliance pane that shows options to define, apply, and monitor AI compliance policies with Azure Policy, Microsoft Defender, and Microsoft Purview integrations.](/images/compliance.png)
...
![Screenshot of the Quota pane that shows model deployments, their quota usage, and usage patterns with options to adjust or request additional quotas.](/images/quota-view.png)
...
![Screenshot of the Admin pane that shows a list of projects with details like owners, region, connected services, and compliance status.](/images/admin-tab-overview.png)
