...
![Diagram of the logical flow of client requests passing through Azure API Management as an AI gateway before reaching model deployments within a project.](/images/..\media\enable-ai-api-management-gateway-portal\gateway-architecture-diagram.png)
...
![Screenshot of the project settings pane that shows input boxes for tokens per minute and total token quota limits.](/images/..\media\enable-ai-api-management-gateway-portal\set-token-limits.png)
