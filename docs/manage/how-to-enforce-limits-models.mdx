...
<Frame>
  <img src="/images/gateway-architecture-diagram.png" alt="Diagram of the logical flow of client requests passing through Azure API Management as an AI gateway before reaching model deployments within a project." />
</Frame>
...
<Frame>
  <img src="/images/set-token-limits.png" alt="Screenshot of the project settings pane that shows input boxes for tokens per minute and total token quota limits." />
</Frame>
