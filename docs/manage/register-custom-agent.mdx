...
Send traces to the Application Insights resource of your project by using its instrumentation key. To get the instrumentation key associated with your project, follow the instructions at [Connect Application Insights to your Foundry project](/agent-service/trace-agent-setup#connect-application-insights-to-your-foundry-project).
