...
1. Select **Add AI Gateway**.
    ...
    ![A screenshot showing how to add an AI Gateway to a given Foundry resource.](/images/..\media\enable-ai-api-management-gateway-portal\foundry-add-ai-gateway.png)
...
1. Select **Create new** or **Use existing** APIM.
    ...
    ![Screenshot of AI Gateway tab in the Admin console showing options to create or select an API Management instance.](/images/..\media\enable-ai-api-management-gateway-portal\create-ai-gateway-portal.png)
...
1. Select **Add project to gateway**. The **Gateway status** column updates to **Enabled**.
    ...
    ![A screenshot showing how to enable a given project by adding it to the gateway.](/images/..\control-plane\media\register-custom-agent\verify-ai-gateway-project.png)
...
![Logical flow showing client requests passing through AI Gateway (APIM) before reaching model deployments within a project.](/images/..\media\enable-ai-api-management-gateway-portal\gateway-architecture-diagram.png)
