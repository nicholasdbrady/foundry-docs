...
- [**Stop** and **Start**](/manage/how-to-manage-agents#start-and-stop-agents) operate on individual deployments by deallocating or provisioning compute. They affect the underlying Azure infrastructure, not just how an agent is used in your organization.
