...
- Foundry agents, including [prompt-based agents](/agents/development/overview), [workflows](/agents/development/workflow), and [hosted agents](/agents/development/hosted-agents)
