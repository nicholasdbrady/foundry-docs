...
</Tip>    > Custom agents require extra configuration to show details, including tools and LLM spans. Learn more at [Instrument custom code agents](/manage/register-custom-agent#instrument-custom-code-agents).
