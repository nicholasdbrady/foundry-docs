...
| **Published as** | Indicates if the agent was [published as an agent application](/agent-service/publish-agent). Published agents in Foundry have their own endpoint for invocation. | Foundry |
...
* Versions [published as agent applications](/agent-service/publish-agent).
