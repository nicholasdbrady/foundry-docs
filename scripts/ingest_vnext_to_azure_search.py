#!/usr/bin/env python3
"""Chunk docs-vnext and ingest into Azure AI Search with embeddings.

Mirrors ingest_to_azure_search.py but targets the docs-vnext content set
and a separate Azure Search index (default: 'foundry-docs-vnext').
"""
...
DOCS_DIR = Path(os.environ.get("FOUNDRY_VNEXT_DOCS_DIR", PROJECT_ROOT / "docs-vnext"))
...
def _parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Incrementally sync docs-vnext chunks to Azure AI Search")
...
def main():
    ...
    search_index_name = os.environ.get("AZURE_SEARCH_VNEXT_INDEX_NAME", "foundry-docs-vnext")
