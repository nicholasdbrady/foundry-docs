...
<Tabs>
  ...
  <Tab title="JavaScript">
    ...
    const apiKey = process.env.AZURE_INFERENCE_CREDENTIAL;
    ...
    Pass the deployment name as `model` in the `client.chat.completions.create()` call, not in the constructor.
