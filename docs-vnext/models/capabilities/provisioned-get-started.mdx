...
* [Foundry Provisioned Throughput Onboarding Guide](/models/capabilities/provisioned-throughput-onboarding)
* [Foundry Provisioned Throughput Concepts](/models/capabilities/provisioned-throughput) 

## Prerequisites

- An Azure subscription - [Create one for free](https://azure.microsoft.com/pricing/purchase-options/azure-account?cid=msft_learn)
- Azure Contributor or Cognitive Services Contributor role
- A [Foundry resource](https://learn.microsoft.com/en-us/azure/foundry-classic/openai/how-to/create-resource) in a region with available PTU quota
- Azure CLI - [Install the Azure CLI](https://learn.microsoft.com/cli/azure/install-azure-cli) (required only for CLI-based deployment)
...
You can view the quota available to you in a region by visiting the **Quota** pane in the [Microsoft Foundry](https://ai.azure.com/?cid=learnDocs) **Operate** section and selecting the desired subscription and region. 
...
REST, ARM template, Bicep, and Terraform can also be used to create deployments. See the section on automating deployments in the [Managing Quota](https://learn.microsoft.com/en-us/azure/foundry-classic/openai/how-to/quota) how-to guide and replace the `sku.name` with `GlobalProvisionedManaged`, `DataZoneProvisionedManaged`, or `ProvisionedManaged` rather than `Standard`.
...
* [Foundry provisioned throughput onboarding guide](/models/capabilities/provisioned-throughput-onboarding) 
* [Guide for Foundry provisioned throughput reservations](/models/capabilities/provisioned-throughput) 
...
The inferencing code for provisioned deployments is the same as a standard deployment type. The following code snippet shows a chat completions call to a GPT-4 model. For your first time using these models programmatically, we recommend starting with our [quickstart guide](/models/capabilities/responses). Our recommendation is to use the OpenAI library with version 1.0 or greater since this includes retry logic within the library.
...
<Info>
For production, use a secure way of storing and accessing your credentials like [Azure Key Vault](https://learn.microsoft.com/azure/key-vault/general/overview). For more information about credential security, see this [security](../../../ai-services/security-features) article.
</Info>
...
<Frame>
  <img src="/images/azure-monitor-utilization.jpg" alt="Screenshot of the provisioned managed utilization on the resource's metrics blade in the Azure portal." />
</Frame>
...
* For more information on provisioned deployments, check out [What is provisioned throughput?](/models/capabilities/provisioned-throughput)
* For more information on retry logic within each SDK, check out:
    ...
    * [.NET reference documentation](https://learn.microsoft.com/dotnet/api/overview/azure/ai.openai-readme)
    * [Java reference documentation](https://learn.microsoft.com/java/api/com.azure.ai.openai.openaiclientbuilder))
    * [JavaScript reference documentation](https://learn.microsoft.com/azure/ai-foundry/openai/supported-languages)
