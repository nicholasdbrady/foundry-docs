...
- A Foundry project with a `model-router` deployment. See [Deploy model router](/models/catalog/model-router#deploy-a-model-router-model).
...
- Familiarity with the [Responses API](/models/capabilities/responses).
- Python 3.9+
- The Foundry SDK:
...
Use `model-router` as your default. Customize your model router deployment with optional settings. See [Model router deployment options](/models/catalog/model-router#optional-customize-deployment-settings).
...
- [Use model router for Microsoft Foundry](/models/catalog/model-router) — deployment, routing modes, model subsets
- [Use the Azure OpenAI Responses API](/models/capabilities/responses) — streaming, tools, stored responses
- [Microsoft Foundry SDKs and endpoints](/api-sdk/sdk-overview#foundry-sdk) — client setup and endpoint patterns
