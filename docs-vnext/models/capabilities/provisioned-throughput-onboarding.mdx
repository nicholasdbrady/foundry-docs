...
Microsoft Foundry [Regional Provisioned Throughput](/models/capabilities/deployment-types#regional-provisioned), [Data Zone Provisioned Throughput](/models/capabilities/deployment-types#data-zone-provisioned), and [Global Provisioned Throughput](/models/capabilities/deployment-types#global-provisioned) are billed hourly based on the number of deployed PTUs, with substantial term discount available via the purchase of Azure reservations.  
...
<Frame>
  <img src="/images/model-independent-quota.png" alt="Diagram of model independent quota with one pool of PTUs available to multiple Azure OpenAI models." />
</Frame>
...
|---------|---------|
|[Regional Provisioned](/models/capabilities/deployment-types#regional-provisioned)     |  Regional Provisioned Throughput Unit       |
|[Global Provisioned](/models/capabilities/deployment-types#global-provisioned)     | Global Provisioned Throughput Unit        |
|[Data zone Provisioned](/models/capabilities/deployment-types#data-zone-provisioned)    | Data Zone Provisioned Throughput Unit        |

You can find details about quota for provisioned deployments in the [Microsoft Foundry](https://ai.azure.com/?cid=learnDocs) portal **Operate** section > **Quota** pane.
...
<Frame>
  <img src="/images/hourly-billing.png" alt="A diagram showing hourly billing." />
</Frame>
...
1. Delete the deployment in the [Microsoft Foundry](https://ai.azure.com/?cid=learnDocs) portal.
...
If more quotas are required, you also need to request quota via the link in the [Microsoft Foundry](https://ai.azure.com/?cid=learnDocs) **Operate** section > **Quota** pane. The form allows the customer to request an increase in the specified PTU quota for a given region. The customer receives an email at the included address once the request is approved, typically within two business days.
...
* [View Azure reservation utilization](https://learn.microsoft.com/azure/cost-management-billing/reservations/reservation-utilization) 
* [View Azure Reservation purchase and refund transactions](https://learn.microsoft.com/azure/cost-management-billing/reservations/view-purchase-refunds) 
* [View amortized benefit costs](https://learn.microsoft.com/azure/cost-management-billing/reservations/view-amortized-costs) 
* [Charge back Azure Reservation costs](https://learn.microsoft.com/azure/cost-management-billing/reservations/charge-back-usage)
* [Automatically renew Azure reservations](https://learn.microsoft.com/azure/cost-management-billing/reservations/reservation-renew)

## Related content

- [Provisioned Throughput Units (PTU) getting started guide](/models/capabilities/provisioned-get-started)
- [Provisioned Throughput Units (PTU) concepts](/models/capabilities/provisioned-throughput)
...
- [Azure OpenAI provisioned Managed offering updates](https://learn.microsoft.com/en-us/azure/foundry-classic/openai/concepts/provisioned-migration)
