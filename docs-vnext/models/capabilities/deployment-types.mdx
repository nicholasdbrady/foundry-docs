...
Learn more in the "Model region availability by deployment type" section of [Foundry Models sold directly by Azure](/models/catalog/models-sold-directly-by-azure).
...
- [Model region availability by deployment type](/models/catalog/models-sold-directly-by-azure)
