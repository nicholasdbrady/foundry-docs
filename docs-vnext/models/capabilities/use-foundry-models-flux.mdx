...
For more details about model capabilities, see [Foundry Models sold by Azure](/models/catalog/models-sold-directly-by-azure).
...
- [Models sold by Azure](/models/catalog/models-sold-directly-by-azure)
