...
To get started with the agents playground, see [Understanding the agent development lifecycle](/agents/development/development-lifecycle).
...
| Model not available in deployment list | Check [model regional availability](/operate/region-support) for your Foundry resource region. |
...
- [Understanding the agent development lifecycle](/agents/development/development-lifecycle)
