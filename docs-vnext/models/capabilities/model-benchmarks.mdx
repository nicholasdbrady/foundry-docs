...
Model leaderboards (preview) in Foundry portal help you compare models in the Foundry [model catalog](https://learn.microsoft.com/en-us/azure/foundry-classic/concepts/foundry-models-overview) using industry-standard model benchmarks.

To get started, [compare and select models using the model leaderboard](/models/capabilities/benchmark-model-in-catalog) in Foundry portal.
...
<Tip>
Leaderboard benchmarks provide standardized comparisons across models using public datasets. To evaluate model performance on your specific data and use case, see [Evaluate your generative AI apps](/observability/evaluate-generative-ai-app).
</Tip>
...
Performance metrics are aggregated over 14 days using 24 trials per day, with two requests per trial sent at one-hour intervals. Unless otherwise noted, the following default parameters apply to both [serverless API deployments](https://learn.microsoft.com/en-us/azure/foundry-classic/concepts/foundry-models-overview) and [Azure OpenAI](https://learn.microsoft.com/azure/ai-foundry/openai/overview):

| Parameter | Value | Applicable for |
|--|--|--|
| Region | East US/East US2 | [serverless API deployments](https://learn.microsoft.com/en-us/azure/foundry-classic/concepts/foundry-models-overview) and [Azure OpenAI](https://learn.microsoft.com/azure/ai-foundry/openai/overview) |
...
| Streaming | True | Applies to serverless API deployments and Azure OpenAI. For models deployed via [managed compute](https://learn.microsoft.com/en-us/azure/foundry-classic/concepts/foundry-models-overview), or for endpoints when streaming isn't supported TTFT is represented as P50 of latency metric. |
...
- [Compare and select models using the model leaderboard in Foundry portal](/models/capabilities/benchmark-model-in-catalog)
- [Model catalog and collections in Foundry portal](https://learn.microsoft.com/en-us/azure/foundry-classic/concepts/foundry-models-overview)
- [Evaluate your generative AI apps](/observability/evaluate-generative-ai-app)
- [Deploy models with serverless API](https://learn.microsoft.com/en-us/azure/foundry-classic/how-to/deploy-models-serverless)
