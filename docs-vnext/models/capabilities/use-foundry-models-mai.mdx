...
- A [Microsoft Foundry project](/setup/create-projects). MAI image models are available for **global standard deployment** (West Central US, East US, West US, West Europe, Sweden Central, South India, and UAE North).
...
To deploy an MAI image model, follow the instructions in [Deploy Microsoft Foundry Models in the Foundry portal](/models/capabilities/deploy-foundry-models).
...
<Tabs>
  ...
  <Tab title="REST API">
    ...
    **Expected output:** A JSON response containing the generated image data in base64 format.
...
<Tabs>
  ...
  <Tab title="REST API">
    ...
    **Expected output:** A JSON response containing the edited image data in base64 format.
...
For more details about the model capabilities, see capabilities of Microsoft models in [Foundry Models sold by Azure](/models/catalog/models-sold-directly-by-azure).
...
- [Explore available models in Foundry](/models/catalog/models-sold-directly-by-azure)
