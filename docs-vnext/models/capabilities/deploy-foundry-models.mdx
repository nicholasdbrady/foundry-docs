...
For more information about quota, see [Microsoft Foundry Models quotas and limits](/setup/quotas-limits) and [Manage Azure OpenAI quota](https://learn.microsoft.com/en-us/azure/foundry-classic/openai/how-to/quota).
