...
- An Azure subscription with a valid payment method. If you don't have an Azure subscription, create a [paid Azure account](https://azure.microsoft.com/pricing/purchase-options/pay-as-you-go) to begin. If you're using GitHub Models, you can [upgrade to Foundry Models](/models/capabilities/quickstart-github-models) and create an Azure subscription in the process.
...
For more information about quota, see [Microsoft Foundry Models quotas and limits](/setup/quotas-limits) and [Manage Azure OpenAI quota](../../../foundry-classic/openai/how-to/quota.md).
