...
To check which regions currently support fine-tuning, consult the [article about models](../foundry-models/concepts/models-sold-directly-by-azure#fine-tuning-models).
