...
FLUX models are available for [global standard deployment](/models/capabilities/deployment-types#global-standard) in all regions. To deploy a FLUX model, follow the instructions in [Deploy Microsoft Foundry Models in the Foundry portal](/models/capabilities/deploy-foundry-models).

After deployment, use the [Foundry playground](/models/capabilities/concept-playgrounds) to interactively test the model with text prompts.
...
For more details about model capabilities, see [Models sold directly by Azure](/models/catalog/models-sold-directly-by-azure).
...
- [Models sold directly by Azure](/models/catalog/models-sold-directly-by-azure)
