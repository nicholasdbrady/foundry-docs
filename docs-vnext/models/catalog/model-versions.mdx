...
* Read [what's new](https://learn.microsoft.com/en-us/azure/foundry-classic/openai/whats-new) and [models](/models/catalog/models-sold-directly-by-azure) to understand the changes and new features.
* Read the documentation on [model deployments](https://learn.microsoft.com/en-us/azure/foundry-classic/openai/how-to/create-resource) and [version upgrades](/models/catalog/working-with-models) to understand how to work with model versions.
