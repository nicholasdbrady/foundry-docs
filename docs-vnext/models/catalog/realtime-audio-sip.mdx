...
1. Create a webhook for incoming calls using the [Azure OpenAI Webhook Service REST API](https://learn.microsoft.com/en-us/azure/ai-foundry/openai/how-to/webhooks).
