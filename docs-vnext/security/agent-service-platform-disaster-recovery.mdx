...
- [Resource and data loss recovery strategies](/security/agent-service-operator-disaster-recovery) - Account for human-caused and automation-caused failures in your recovery design.
- [Foundry Agent Service disaster recovery overview](/security/agent-service-disaster-recovery) - Review prerequisites, platform limitations, and baseline configuration.
- [High availability and resiliency guidance](/security/high-availability-resiliency) - Design your workload for continuous availability.
