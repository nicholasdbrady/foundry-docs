...
---
This article explains how to configure keyless authentication with Microsoft Entra ID for Microsoft Foundry Models. Keyless authentication eliminates the need for API keys, uses role-based access control (RBAC), and reduces operational complexity.
...
For code examples in Python, C#, JavaScript, Java, and REST, see [Use Microsoft Entra ID in your code](#use-microsoft-entra-id-in-your-code).
