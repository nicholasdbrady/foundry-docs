...
---
<Tip>
An alternate hub-focused version of this article is available: [How to configure a private link for a Microsoft Foundry hub](https://learn.microsoft.com/en-us/azure/foundry-classic/how-to/hub-configure-private-link).
</Tip>
...
<Frame>
  <img src="/images/network-diagram-agents.png" alt="Diagram of the firewall configuration for egress traffic from Foundry projects and agents." />
</Frame>
