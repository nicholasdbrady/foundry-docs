...
When Microsoft Agent 365 (A365) is enabled for your organization, Foundry resources can send agent activity data to the Agent 365 control plane. This data powers agent registry, analytics, and security features in Agent 365. For an overview of how Foundry integrates with Agent 365 and how data flows between the two platforms, see [Microsoft Agent 365 integration with Foundry](/agent-service/agent-365-integration).
...
- [Microsoft Agent 365 integration with Foundry](/agent-service/agent-365-integration)
