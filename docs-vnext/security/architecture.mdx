...
- **Model Hosting Architecture** is provided by standard deployment in Foundry resources.   For an overview of data, privacy, and security considerations with deployment, see [Data, privacy, and security for use of models](https://learn.microsoft.com/en-us/azure/foundry-classic/how-to/concept-data-privacy).
