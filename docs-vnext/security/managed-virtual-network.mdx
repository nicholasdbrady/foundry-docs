...
<Frame>
  <img src="/images/diagram-managed-network.png" alt="Diagram of managed virtual network configuration." />
</Frame>
...
<Frame>
  <img src="/images/diagram-allow-internet-outbound-managed-network.png" alt="Diagram of managed virtual network configuration in allow internet outbound mode." />
</Frame>

The following architecture diagram shows a managed network in `allow only approved outbound` mode. 

<Frame>
  <img src="/images/diagram-allow-only-approved-outbound-managed-network.png" alt="Diagram of managed virtual network configuration in allow only approved outbound mode." />
</Frame>
...
1. If you require private access to on-premises resources for your Foundry resource, use [Application Gateway](https://learn.microsoft.com/en-us/azure/foundry-classic/how-to/access-on-premises-resources) to configure on-premises access. The same set-up with a private endpoint to Application Gateway and setting up backend pools is supported. Both L4 and L7 traffic are now supported with the Application Gateway in GA.
...
For more details on the parameters required for managed virtual network deployment, see [Microsoft.CognitiveServices/accounts/managedNetworks](https://learn.microsoft.com/azure/templates/microsoft.cognitiveservices/accounts/managednetworks).
...
For more details on the parameters required for managed virtual network outbound rules, see [Microsoft.CognitiveServices/accounts/managedNetworks/outboundRules](https://learn.microsoft.com/azure/templates/microsoft.cognitiveservices/accounts/managednetworks/outboundrules).
...
- [Configure a custom virtual network for Agents](/setup/virtual-networks)
- [Configure a managed network for Azure AI Foundry hubs](https://learn.microsoft.com/en-us/azure/foundry-classic/how-to/configure-managed-network)
- [Configure private link for Azure AI Foundry hubs](https://learn.microsoft.com/en-us/azure/foundry-classic/how-to/hub-configure-private-link)
- [Create a secure Azure AI Foundry hub](https://learn.microsoft.com/en-us/azure/foundry-classic/how-to/create-secure-ai-hub)
- [Troubleshoot secure project connectivity](https://learn.microsoft.com/en-us/azure/foundry-classic/how-to/troubleshoot-secure-connection-project)
- [Access on-premises resources](https://learn.microsoft.com/en-us/azure/foundry-classic/how-to/access-on-premises-resources)
