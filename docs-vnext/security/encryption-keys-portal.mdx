...
- An existing key vault to store your keys. These requirements also apply:
  ...
  To create a key vault, see [Quickstart: Create a key vault by using the Azure portal](https://learn.microsoft.com/azure/key-vault/general/quick-create-portal).
...
To configure trusted services access on your key vault, see [Configure Azure Key Vault firewalls and virtual networks](https://learn.microsoft.com/azure/key-vault/general/network-security).
