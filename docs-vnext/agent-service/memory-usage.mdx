...
This article explains how to create, manage, and use memory stores. For conceptual information, see [Memory in Foundry Agent Service](/agent-service/what-is-memory).
...
- A [Microsoft Foundry project](/setup/create-projects) with configured [authorization and permissions](#authorization-and-permissions).
- A [chat model deployment](/foundry-models/create-model-deployments), such as `gpt-5.2`, in your project.
- An [embedding model deployment](/foundry-models/embeddings), such as `text-embedding-3-small`, in your project.
- A [configured local environment](#set-up-your-environment) with required packages and environment variables.

### Authorization and permissions

We recommend [role-based access control](/security/rbac-foundry) for production deployments. If roles aren't feasible, skip this section and use key-based authentication instead.
...
<ZonePivot group="csharp__python__python-csharp-typescript__rest__typescript" options={[{"id": "python", "title": "Python"}, {"id": "csharp", "title": "C#"}, {"id": "typescript", "title": "TypeScript"}, {"id": "python,csharp,typescript", "title": "Python,Csharp,Typescript"}, {"id": "rest", "title": "REST"}]} defaultValue="python" />

<ZoneContent group="csharp__python__python-csharp-typescript__rest__typescript" value="python" options={[{"id": "python", "title": "Python"}, {"id": "csharp", "title": "C#"}, {"id": "typescript", "title": "TypeScript"}, {"id": "python,csharp,typescript", "title": "Python,Csharp,Typescript"}, {"id": "rest", "title": "REST"}]} values={["python", "csharp", "typescript", "python,csharp,typescript", "rest"]} defaultValue="python">
...
<ZoneContent group="csharp__python__python-csharp-typescript__rest__typescript" value="csharp" options={[{"id": "python", "title": "Python"}, {"id": "csharp", "title": "C#"}, {"id": "typescript", "title": "TypeScript"}, {"id": "python,csharp,typescript", "title": "Python,Csharp,Typescript"}, {"id": "rest", "title": "REST"}]} values={["python", "csharp", "typescript", "python,csharp,typescript", "rest"]} defaultValue="python">
...
<ZoneContent group="csharp__python__python-csharp-typescript__rest__typescript" value="typescript" options={[{"id": "python", "title": "Python"}, {"id": "csharp", "title": "C#"}, {"id": "typescript", "title": "TypeScript"}, {"id": "python,csharp,typescript", "title": "Python,Csharp,Typescript"}, {"id": "rest", "title": "REST"}]} values={["python", "csharp", "typescript", "python,csharp,typescript", "rest"]} defaultValue="python">
...
<ZoneContent group="csharp__python__python-csharp-typescript__rest__typescript" value="python,csharp,typescript" options={[{"id": "python", "title": "Python"}, {"id": "csharp", "title": "C#"}, {"id": "typescript", "title": "TypeScript"}, {"id": "python,csharp,typescript", "title": "Python,Csharp,Typescript"}, {"id": "rest", "title": "REST"}]} values={["python", "csharp", "typescript", "python,csharp,typescript", "rest"]} defaultValue="python">
...
<ZoneContent group="csharp__python__python-csharp-typescript__rest__typescript" value="rest" options={[{"id": "python", "title": "Python"}, {"id": "csharp", "title": "C#"}, {"id": "typescript", "title": "TypeScript"}, {"id": "python,csharp,typescript", "title": "Python,Csharp,Typescript"}, {"id": "rest", "title": "REST"}]} values={["python", "csharp", "typescript", "python,csharp,typescript", "rest"]} defaultValue="python">
...
<ZonePivot group="csharp__python__rest__typescript" options={[{"id": "python", "title": "Python"}, {"id": "csharp", "title": "C#"}, {"id": "typescript", "title": "TypeScript"}, {"id": "rest", "title": "REST"}]} defaultValue="python" />

<ZoneContent group="csharp__python__rest__typescript" value="python" options={[{"id": "python", "title": "Python"}, {"id": "csharp", "title": "C#"}, {"id": "typescript", "title": "TypeScript"}, {"id": "rest", "title": "REST"}]} values={["python", "csharp", "typescript", "rest"]} defaultValue="python">
...
<ZoneContent group="csharp__python__rest__typescript" value="csharp" options={[{"id": "python", "title": "Python"}, {"id": "csharp", "title": "C#"}, {"id": "typescript", "title": "TypeScript"}, {"id": "rest", "title": "REST"}]} values={["python", "csharp", "typescript", "rest"]} defaultValue="python">
...
<ZoneContent group="csharp__python__rest__typescript" value="typescript" options={[{"id": "python", "title": "Python"}, {"id": "csharp", "title": "C#"}, {"id": "typescript", "title": "TypeScript"}, {"id": "rest", "title": "REST"}]} values={["python", "csharp", "typescript", "rest"]} defaultValue="python">
...
<ZoneContent group="csharp__python__rest__typescript" value="rest" options={[{"id": "python", "title": "Python"}, {"id": "csharp", "title": "C#"}, {"id": "typescript", "title": "TypeScript"}, {"id": "rest", "title": "REST"}]} values={["python", "csharp", "typescript", "rest"]} defaultValue="python">
...
For more information about user profile and chat summary memories, see [Memory types](/agent-service/what-is-memory#memory-types).
...
- [Memory in Foundry Agent Service](/agent-service/what-is-memory)
- [Foundry Agent Service quotas and limits](/agent-service/limits-quotas-regions)
- [Build an agent with Microsoft Foundry](/get-started/get-started-code)
