...
- A Foundry project with tracing enabled. To set it up, see [How to set up tracing in Microsoft Foundry](/agent-service/trace-agent-setup).
...
Tracing stores telemetry data in Azure Monitor Application Insights, which may incur costs based on data volume and retention settings. For pricing details, see [Application Insights pricing](https://learn.microsoft.com/azure/azure-monitor/cost-usage#application-insights-billing).
...
| Trace exporters     | Trace exporters send trace data to backend systems for storage and analysis. In Foundry, traces are stored in Azure Monitor Application Insights. To learn how to enable and view traces, see [How to set up tracing in Microsoft Foundry](/agent-service/trace-agent-setup). |
...
Once tracing is enabled for your project, you can inspect traces in the Foundry portal and in Azure Monitor Application Insights. For the step-by-step setup and viewing options, see [How to set up tracing in Microsoft Foundry](/agent-service/trace-agent-setup).
...
To learn more, see [tracing integrations](/agent-service/trace-agent-framework).
...
- Ensure your agent code includes the necessary instrumentation. For framework-specific setup, see [Tracing integrations](/agent-service/trace-agent-framework).
