...
- An existing or new toolbox with at least one tool. See [Curate intent-based toolbox in Foundry](/agent-service/toolbox).
...
Publishing a new toolbox creates its first version. That version becomes the default version automatically. For the full toolbox creation workflow, see [Curate intent-based toolbox in Foundry](/agent-service/toolbox#step-1-create-a-toolbox-version).
...
- [Tools overview](/agent-service/tool-catalog)
- [Best practices for tools](/agent-service/tool-best-practice)
