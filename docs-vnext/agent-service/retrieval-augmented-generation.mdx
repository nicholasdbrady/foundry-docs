...
- **System message and prompts**: Instructions that guide how the model uses retrieved content. See [Prompt engineering](/best-practices/prompt-engineering) and [Safety system messages](/best-practices/system-message).
...
- **Treat retrieved content as untrusted input**. Your system message and application logic should reduce the risk of prompt injection from documents and retrieved passages. See [Safety system messages](/best-practices/system-message).
