...
Choose your protocol based on your agent's interaction pattern. See [What are Hosted agents — Protocols](/agent-service/hosted-agents#protocols-responses-invocations-and-invocations-websocket) for guidance on which protocol to use.
