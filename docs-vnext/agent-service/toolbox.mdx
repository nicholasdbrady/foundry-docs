...
| [MCP tool](/agent-service/model-context-protocol) | ✔️ | ✔️ | ✔️ | ✔️ | ✔️ | ✔️ |
| [Web Search tool](/agent-service/web-search) | ✔️ | ✔️ | ✔️ | ✔️ | ✔️ | ✔️ |
| [Azure AI Search tool](/agent-service/ai-search) | ✔️ | ✔️ | ✔️ | ✔️ | ✔️ | ✔️ |
| [Code Interpreter tool](/agent-service/code-interpreter) | ✔️ | ✔️ | ✔️ | ✔️ | ✔️ | ✔️ |
| [File Search tool](/agent-service/file-search) | ✔️ | ✔️ | ✔️ | ✔️ | ✔️ | ✔️ |
| [OpenAPI tool](/agent-service/openapi) | ✔️ | ✔️ | ✔️ | ✔️ | ✔️ | No |
| [Agent-to-Agent (A2A) tool](/agent-service/agent-to-agent) | ✔️ | ✔️ | ✔️ | ✔️ | ✔️ | No |
| [Fabric IQ tool](/agent-service/fabric-iq) | ✔️ | ✔️ | ✔️ | ✔️ | ✔️ | ✔️ |
| Guardrail (RAI policy) | ✔️ | ✔️ | ✔️ | ✔️ | ✔️ | ✔️ |
| [Skill references](/agent-service/skills) | ✔️ | ✔️ | ✔️ | ✔️ | ✔️ | No |
| [Tool Search tool](/agent-service/tool-search) | ✔️ | ✔️ | ✔️ | ✔️ | ✔️ | ✔️ |
| [Work IQ tool](/agent-service/work-iq) | ✔️ | ✔️ | ✔️ | ✔️ | ✔️ | ✔️ |
| [Browser Automation tool](/agent-service/browser-automation) | ✔️ | ✔️ | ✔️ | ✔️ | ✔️ | No |

## Prerequisites

- An active [Microsoft Foundry project](/setup/create-projects).
...
- **Azure Developer CLI**: [Install the Azure Developer CLI](https://learn.microsoft.com/azure/developer/azure-developer-cli/install-azd) (`azd`, 1.25 or later) and the unified Foundry CLI extension bundle:
...
1. To add Work IQ or Fabric IQ tools, select **+ Add tool** and choose the corresponding tool type. Provide the required project connection when prompted. For end-to-end setup details, see [Use the Work IQ tool](/agent-service/work-iq) and [Use the Fabric IQ tool](/agent-service/fabric-iq).
1. Select **Publish**.

Publishing a new toolbox creates its first version. That version becomes the default version automatically.

<Frame>
  <img src="/images/toolbox-vscode-create.png" alt="Screenshot of the Microsoft Foundry Toolkit for Visual Studio Code extension showing the Build a Custom Toolbox view with fields for the toolbox name, description, and tools, plus the Publish action." />
</Frame>
...
3. Author a toolbox YAML that references one or more existing connections by name. The YAML never embeds credentials:
   ...
   At least one of `connections`, `skills`, or `tools` must be non-empty. Skill references must point to skills that already exist in the same Foundry project; see [Use skills in Foundry](/agent-service/skills) to create them with `azd ai skill create`. For end-to-end Tool Search, Work IQ, and Fabric IQ setup details, see [Use tool search](/agent-service/tool-search), [Use the Work IQ tool](/agent-service/work-iq), and [Use the Fabric IQ tool](/agent-service/fabric-iq).
...
<Frame>
  <img src="/images/toolbox-vscode-list.png" alt="Screenshot of the Microsoft Foundry Toolkit for Visual Studio Code extension showing the Toolboxes view with the toolbox endpoint URL and the Scaffold code template action." />
</Frame>
...
### [Model Context Protocol (MCP)](/agent-service/model-context-protocol)

<ZonePivot group="azd__dotnet__javascript__python__rest-api" options={[{"id": "rest-api", "title": "REST API"}, {"id": "python", "title": "Python"}, {"id": "dotnet", "title": ".NET"}, {"id": "javascript", "title": "JavaScript"}, {"id": "azd", "title": "Azure Developer CLI"}]} defaultValue="rest-api" />

<ZoneContent group="azd__dotnet__javascript__python__rest-api" value="rest-api" options={[{"id": "rest-api", "title": "REST API"}, {"id": "python", "title": "Python"}, {"id": "dotnet", "title": ".NET"}, {"id": "javascript", "title": "JavaScript"}, {"id": "azd", "title": "Azure Developer CLI"}]} values={["rest-api", "python", "dotnet", "javascript", "azd"]} defaultValue="rest-api">
...
<ZoneContent group="azd__dotnet__javascript__python__rest-api" value="python" options={[{"id": "rest-api", "title": "REST API"}, {"id": "python", "title": "Python"}, {"id": "dotnet", "title": ".NET"}, {"id": "javascript", "title": "JavaScript"}, {"id": "azd", "title": "Azure Developer CLI"}]} values={["rest-api", "python", "dotnet", "javascript", "azd"]} defaultValue="rest-api">
...
<ZoneContent group="azd__dotnet__javascript__python__rest-api" value="dotnet" options={[{"id": "rest-api", "title": "REST API"}, {"id": "python", "title": "Python"}, {"id": "dotnet", "title": ".NET"}, {"id": "javascript", "title": "JavaScript"}, {"id": "azd", "title": "Azure Developer CLI"}]} values={["rest-api", "python", "dotnet", "javascript", "azd"]} defaultValue="rest-api">
...
<ZoneContent group="azd__dotnet__javascript__python__rest-api" value="javascript" options={[{"id": "rest-api", "title": "REST API"}, {"id": "python", "title": "Python"}, {"id": "dotnet", "title": ".NET"}, {"id": "javascript", "title": "JavaScript"}, {"id": "azd", "title": "Azure Developer CLI"}]} values={["rest-api", "python", "dotnet", "javascript", "azd"]} defaultValue="rest-api">
...
<ZoneContent group="azd__dotnet__javascript__python__rest-api" value="azd" options={[{"id": "rest-api", "title": "REST API"}, {"id": "python", "title": "Python"}, {"id": "dotnet", "title": ".NET"}, {"id": "javascript", "title": "JavaScript"}, {"id": "azd", "title": "Azure Developer CLI"}]} values={["rest-api", "python", "dotnet", "javascript", "azd"]} defaultValue="rest-api">
...
### [Web Search](/agent-service/web-search)
...
- See the [management section](/agent-service/web-search#administrator-control-for-the-web-search-tool) for information about how Azure admins can manage access to use of web search.
...
The returned file `id` is the value you supply as `<FILE_ID>` in the tool configuration. Files are mounted in the sandbox at `/mnt/data/{file-id}-{original-filename}`. See [Code Interpreter](/agent-service/code-interpreter) for additional upload examples and language-specific samples.
...
Use the file name returned from Step 1 to download the file via the [File API download endpoint](https://learn.microsoft.com/azure/foundry/openai/latest#download-file).
...
The resulting vector store ID is the value you supply as `<VECTOR_STORE_ID>`. See [File Search](/agent-service/file-search) for full examples in each language.
...
### [Agent-to-Agent (A2A)](/agent-service/agent-to-agent)
...
### [Fabric IQ](/agent-service/fabric-iq)
...
<ZonePivot group="azd__python__rest-api" options={[{"id": "rest-api", "title": "REST API"}, {"id": "python", "title": "Python"}, {"id": "azd", "title": "Azure Developer CLI"}]} defaultValue="rest-api" />

<ZoneContent group="azd__python__rest-api" value="rest-api" options={[{"id": "rest-api", "title": "REST API"}, {"id": "python", "title": "Python"}, {"id": "azd", "title": "Azure Developer CLI"}]} values={["rest-api", "python", "azd"]} defaultValue="rest-api">
...
<ZoneContent group="azd__python__rest-api" value="python" options={[{"id": "rest-api", "title": "REST API"}, {"id": "python", "title": "Python"}, {"id": "azd", "title": "Azure Developer CLI"}]} values={["rest-api", "python", "azd"]} defaultValue="rest-api">
...
<ZoneContent group="azd__python__rest-api" value="azd" options={[{"id": "rest-api", "title": "REST API"}, {"id": "python", "title": "Python"}, {"id": "azd", "title": "Azure Developer CLI"}]} values={["rest-api", "python", "azd"]} defaultValue="rest-api">
...
For `server_url` patterns by Fabric item type, see [Find your Fabric IQ server details](/agent-service/fabric-iq#find-your-fabric-iq-server-details).
...
### [Tool Search](/agent-service/tool-search)
...
In Foundry Toolkit for Visual Studio Code, select **Tool search** on the **Build a Custom Toolbox** tab when you create or edit a toolbox. For more information, see [Enable tool search in a toolbox](/agent-service/tool-search#enable-tool-search).

### [Work IQ](/agent-service/work-iq)
...
### [Browser Automation](/agent-service/browser-automation)
...
Apply a named [guardrail policy](/guardrails/guardrails-overview) to a toolbox version to enforce responsible AI content filtering on tool inputs and outputs. The guardrail runs at the toolbox layer, independently of any model-level content filter.
...
Attach [skills](/agent-service/skills) to a toolbox version to make them available to agents through the toolbox MCP endpoint. Each skill reference specifies the skill name and an optional version. Omit `version` to use the skill's `default_version`; pin a `version` string to use an immutable snapshot.
...
<ZonePivot group="dotnet__python" options={[{"id": "python", "title": "Python"}, {"id": "dotnet", "title": ".NET"}]} defaultValue="python" />

<ZoneContent group="dotnet__python" value="python" options={[{"id": "python", "title": "Python"}, {"id": "dotnet", "title": ".NET"}]} values={["python", "dotnet"]} defaultValue="python">
...
<ZoneContent group="dotnet__python" value="dotnet" options={[{"id": "python", "title": "Python"}, {"id": "dotnet", "title": ".NET"}]} values={["python", "dotnet"]} defaultValue="python">
...
When your Foundry project uses [network isolation (private link)](/security/configure-private-link), not all toolbox tool types are supported. The following table shows the support status for each tool type and how traffic flows in a network-isolated environment.

| Tool type | VNet support | Traffic flow |
| --------- | ------------ | ------------ |
| [MCP](/agent-service/model-context-protocol) | ✅ Supported | Through your VNet subnet |
| [Azure AI Search](/agent-service/ai-search) | ✅ Supported | Through private endpoint |
| [Code Interpreter](/agent-service/code-interpreter) | ✅ Supported | Microsoft backbone network |
| [Web Search](/agent-service/web-search) | ✅ Supported | Public endpoint |
| [OpenAPI](/agent-service/openapi) | ✅ Supported | Depends on target API network configuration |
| [File Search](/agent-service/file-search) | ❌ Not supported | Not yet available |
| [Agent-to-Agent (A2A)](/agent-service/agent-to-agent) | ✅ Supported | Through private endpoint |
| [Fabric IQ](/agent-service/fabric-iq) | ❌ Not supported | Not yet available |
| [Work IQ](/agent-service/work-iq) | ❌ Not supported | Not yet available |
| [Browser Automation](/agent-service/browser-automation) | ❌ Not supported | Not yet available |

For full network isolation setup instructions, including VNet injection for the agent client, DNS configuration, and private endpoint requirements, see [Configure network isolation for Microsoft Foundry](/security/configure-private-link).
...
Before deploying a toolbox, verify that your target region supports the tool types you plan to use. For the full compatibility tables, see [Tool support by region and model](/agent-service/tool-best-practice#tool-support-by-region-and-model).

## Related content

- [Connect agents to Model Context Protocol servers](/agent-service/model-context-protocol)
- [Add MCP server authentication](/agent-service/mcp-authentication)
- [Web search tool](/agent-service/web-search)
- [Azure AI Search tool](/agent-service/ai-search)
- [Guardrails overview](/guardrails/guardrails-overview)
- [Manage skills](/agent-service/skills)
- [Deploy a Hosted agent](/agent-service/deploy-hosted-agent)
- [Add a connection to your project](/setup/connections-add)
- [Configure network isolation for Microsoft Foundry](/security/configure-private-link)
