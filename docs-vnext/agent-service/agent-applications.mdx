...
- [Foundry Project Manager role](/security/rbac-foundry) on the Foundry resource scope to publish agents
- [Foundry User role](/security/rbac-foundry) on the Agent Application scope to chat with a published agent using the Responses API protocol
...
- [Foundry User role](/security/rbac-foundry) on the Agent Application scope
