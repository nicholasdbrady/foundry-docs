...
* [Foundry Dev Pack](/developer-experience/install-cli-sdk#install-foundry-devpack).
  The Foundry Dev Pack installs Azure Developer CLI (`azd`) and the Foundry extensions used in this quickstart.
