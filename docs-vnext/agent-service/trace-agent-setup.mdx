...
- The [Log Analytics Reader role](https://learn.microsoft.com/azure/azure-monitor/logs/manage-access) on the connected Application Insights resource (required to query telemetry).
...
<Frame>
<img src="/images/project-details.png" alt="Screenshot of project name menu with project details highlighted." />
</Frame>

1. Navigate to the **Connected resources** tab then select **Add connection**.

<Frame>
<img src="/images/connected-resources-add-connection.png" alt="Screenshot of project details with connected resources tab select highlighting add connection." />
</Frame>
...
- Foundry also allows for easy [integration](/agent-service/trace-agent-framework) with top agent frameworks.
...
For more guidance, see [Security and privacy](/agent-service/trace-agent-concept#security-and-privacy).
...
- [Monitor AI agents with the Agent Monitoring Dashboard](/agent-service/how-to-monitor-agents-dashboard)
