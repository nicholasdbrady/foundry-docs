...
- A [Foundry project](/setup/create-projects) with an [Application Insights resource connected](/agent-service/trace-agent-setup#connect-application-insights-to-your-foundry-project).
...
- [Agent tracing overview (preview)](/agent-service/trace-agent-concept)
- [Set up tracing in Microsoft Foundry](/agent-service/trace-agent-setup)
- [Configure tracing for agent frameworks](/agent-service/trace-agent-framework)
