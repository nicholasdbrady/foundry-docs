...
To restrict agent traffic to your private network, configure Foundry Agent Service with a virtual network. See [Private networking for agents](/setup/virtual-networks) for setup instructions.
...
- [Tool best practices](/agent-service/tool-best-practice)
