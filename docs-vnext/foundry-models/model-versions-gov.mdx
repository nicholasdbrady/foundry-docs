...
Azure notifies you of upcoming retirements through email to subscription owners and contributors, Azure Service Health alerts, and the upcoming retirement tables in [Foundry Models lifecycle and support policy in Azure Government](/foundry-models/model-retirements-gov). 

## Related content

- [Foundry Models sold directly by Azure in Azure Government](/foundry-models/models-sold-directly-by-azure-gov)
- [Foundry Models lifecycle and support policy in Azure Government](/foundry-models/model-retirements-gov)
- [Deploy Foundry Models](/foundry-models/deploy-foundry-models)
- [Deployment types in Foundry Models in Azure Government](/foundry-models/deployment-types-gov)
