...
This article explains the capabilities, routing modes, and best practices that power model router. For supported models and version information, see the [model router overview](/foundry-models/model-router). For deployment and usage steps, see [Use model router](/foundry-models/model-router).
...
Model router exposes three routing modes that control the cost-quality tradeoff. For the mode descriptions and configuration steps, see the [model router overview](/foundry-models/model-router#routing-mode) and the [how-to guide](/foundry-models/model-router#optional-change-the-routing-mode).
