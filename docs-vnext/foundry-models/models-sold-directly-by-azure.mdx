...
|`gpt-realtime-2.1` (2026-07-07)<br />`gpt-realtime-2.1-mini` (2026-07-07) | Audio models for real-time audio processing. `gpt-realtime-2.1` improves silence and noise handling over `gpt-realtime-2`; `gpt-realtime-2.1-mini` is a smaller variant. |Input: 32,000  <br /> Output: 4,096 | September 2024 |
