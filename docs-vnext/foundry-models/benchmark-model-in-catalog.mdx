...
- [Run evaluations from the Foundry portal](/observability/evaluate-generative-ai-app) - Run evaluations on your own data to measure model performance for your scenario.
- [See Evaluation Results in Foundry portal](/observability/evaluate-results) - Interpret and compare evaluation results across runs.
