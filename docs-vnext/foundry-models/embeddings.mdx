...
This tutorial shows you how to use the Azure OpenAI [embeddings](https://learn.microsoft.com/en-us/azure/foundry-classic/openai/concepts/understand-embeddings) API to perform **document search**. You query a knowledge base to find the most relevant document.
...
- Use [cosine similarity](https://learn.microsoft.com/en-us/azure/foundry-classic/openai/concepts/understand-embeddings) to rank search results.
## Prerequisites

* An Azure subscription - [Create one for free](https://azure.microsoft.com/pricing/purchase-options/azure-account?cid=msft_learn)
* A Microsoft Foundry or Azure OpenAI resource with the **text-embedding-ada-002 (Version 2)** model deployed. This model is currently only available in [certain regions](/foundry-models/models-sold-directly-by-azure-region-availability).
