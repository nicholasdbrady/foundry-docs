...
- A [Microsoft Foundry project](/setup/create-projects). MAI-Image-2 and MAI-Image-2e are available for **global standard deployment** (West Central US, East US, West US, West Europe, Sweden Central, and South India).
...
For more details about the model capabilities, see capabilities of Microsoft models in [Foundry Models sold directly by Azure](/foundry-models/models-sold-directly-by-azure).
