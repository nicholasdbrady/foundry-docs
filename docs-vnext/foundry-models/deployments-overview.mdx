...
| **Billing** | Token usage or [provisioned throughput units (PTU)](/foundry-models/provisioned-throughput) | Hourly per accelerator SKU |
...
- [Deploy open-source models with managed compute](/foundry-models/deploy-models-managed)
...
|---|---|---|
| Which models can be deployed? | All Foundry Models, including [Foundry Models sold by Azure](/foundry-models/models-sold-directly-by-azure) and [select Models from partners and community](/foundry-models/models-from-partners) | Open-source and partner models from the model catalog, NVIDIA NIM, and industry models |
...
| Billing | Token usage or [provisioned throughput units](/foundry-models/provisioned-throughput) | Hourly per accelerator SKU |

<Tip>

For detailed pricing information, see [Plan and manage costs for Microsoft Foundry](/foundry-models/manage-costs).
