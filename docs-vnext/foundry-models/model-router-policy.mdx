...
- A Foundry resource in a region that supports model router. To learn more, see [Use model router for Microsoft Foundry](/foundry-models/model-router).
...
For the full deployment walkthrough that doesn't include policy steps, see [Use model router for Microsoft Foundry](/foundry-models/model-router).
...
1. Submit the deployment by using the REST API examples in [Use model router for Microsoft Foundry](/foundry-models/model-router#configure-custom-settings-with-the-rest-api).
...
- [Use model router for Microsoft Foundry](/foundry-models/model-router)
