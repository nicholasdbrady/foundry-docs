...
- Azure CLI installed and signed in. For example: `az --version` and `az login`. See [How to install the Azure CLI](https://learn.microsoft.com/cli/azure/install-azure-cli).
