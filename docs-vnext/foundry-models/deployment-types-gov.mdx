...
Customers with high consistent volume might experience greater latency variability. The threshold is set per model. To learn more about Azure OpenAI quotas in Azure Government, see the [Quotas and limits in Azure OpenAI](/foundry-models/quotas-limits-gov). For workloads that require low latency variance at large volume, consider provisioned deployment types.
...
For Azure OpenAI quota limits by deployment type in Azure Government, see [Quotas and limits in Azure OpenAI](/foundry-models/quotas-limits-gov).
...
- [Azure OpenAI in Azure Government quotas and limits](/foundry-models/quotas-limits-gov)
