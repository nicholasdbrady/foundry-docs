...
Not all models support all deployment types. Check [Foundry Models sold by Azure](/foundry-models/models-sold-directly-by-azure-gov) for model availability by deployment type and region.
...
Learn more in the "Model region availability by deployment type" section of [Foundry Models sold by Azure](/foundry-models/models-sold-directly-by-azure-gov).
...
- [Foundry Models sold by Azure in Azure Government](/foundry-models/models-sold-directly-by-azure-gov)
