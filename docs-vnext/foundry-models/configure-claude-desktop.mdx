...
- A Microsoft Foundry resource with one or more Claude models deployed. See [Deploy and use Claude models in Microsoft Foundry (preview)](/foundry-models/use-foundry-models-claude).
...
Claude models in Microsoft Foundry are currently in preview. Model availability might change. Check the [Foundry Models from partners](/foundry-models/models-from-partners) page for the latest list of available models.
...
- [Deploy and use Claude models in Microsoft Foundry (preview)](/foundry-models/use-foundry-models-claude)
