...
| Regional Provisioned Throughput | [SLA](https://www.microsoft.com/licensing/docs/view/Service-Level-Agreements-SLA-for-Online-Services)       | [PTU](https://learn.microsoft.com/azure/ai-foundry/openai/concepts/provisioned-throughput) | None         | PTU/hour        |
...
- Get started with the [Foundry Models fine-tuning tutorial](https://learn.microsoft.com/en-us/azure/foundry-classic/openai/tutorials/fine-tune).
- Review fine-tuning [model regional availability](/foundry-models/models-sold-directly-by-azure).
- Learn more about [Foundry Models quotas and limits](/foundry-models/quotas-limits).
