...
Use the [Realtime API via WebSockets](/foundry-models/realtime-audio-websockets) if you need to:
...
You can access the GPT real-time models for global deployments in the [East US 2 and Sweden Central regions](/foundry-models/models-sold-directly-by-azure#global-standard-model-availability).
...
If you're a current customer using Preview endpoints, [migrate to the GA Protocol](/foundry-models/realtime-audio-preview-api-migration-guide). 
...
For migration details, see [Migration from Preview to GA version of Realtime API](/foundry-models/realtime-audio-preview-api-migration-guide#update-webrtc-endpoints).
...
For the complete list of Realtime API events, see the [API reference](/api-sdk/realtime-audio-reference#server-events).
...
**Reference:** [RTCPeerConnection](https://developer.mozilla.org/en-US/docs/Web/API/RTCPeerConnection), [Realtime API events](/api-sdk/realtime-audio-reference)
...
**Reference:** [DefaultAzureCredential](https://learn.microsoft.com/python/api/azure-identity/azure.identity.defaultazurecredential), [Flask documentation](https://flask.palletsprojects.com/)
