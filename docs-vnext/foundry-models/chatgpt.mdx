...
For new apps, consider building on the [Responses API](/foundry-models/responses) instead of Chat Completions. To upgrade an existing app, see [Azure OpenAI To Responses](https://aka.ms/azure-openai-to-responses).
