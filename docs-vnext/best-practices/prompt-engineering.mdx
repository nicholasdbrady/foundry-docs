...
<Note>
For current API guidance and examples, see [Responses API](/models/capabilities/responses) and [Azure OpenAI in Microsoft Foundry Models API reference](/api-sdk/latest).
</Note>
