...
While Microsoft has conducted red teaming exercises and implemented safety systems (including [content filters](../../../foundry-classic/openai/how-to/content-filters.md) and other [mitigation strategies](/best-practices/prompt-engineering)) for its Azure OpenAI in Microsoft Foundry Models (see this [Overview of responsible AI practices](https://learn.microsoft.com/azure/ai-foundry/responsible-ai/openai/overview)), the context of each LLM application will be unique and you also should conduct red teaming to:
