...
While Microsoft has conducted red teaming exercises and implemented safety systems (including [content filters](https://learn.microsoft.com/en-us/azure/foundry-classic/openai/how-to/content-filters) and other [mitigation strategies](/best-practices/prompt-engineering)) for its Azure OpenAI in Microsoft Foundry Models (see this [Overview of responsible AI practices](https://learn.microsoft.com/azure/ai-foundry/responsible-ai/openai/overview)), the context of each LLM application will be unique and you also should conduct red teaming to:
...
- Review [content filters](https://learn.microsoft.com/en-us/azure/foundry-classic/openai/how-to/content-filters) and ensure your testing plan covers scenarios that might bypass them.
- Use [prompt engineering](/best-practices/prompt-engineering) techniques to reduce risk, then retest to validate improvements.
- Read [Overview of responsible AI practices](https://learn.microsoft.com/azure/ai-foundry/responsible-ai/openai/overview) to align testing with a broader RAI workflow.
