...
For guidance and templates designed for safety, see [Safety system messages](/best-practices/system-message) and [Safety system message templates](/guardrails/safety-system-message-templates).
...
- For broader prompt patterns, see [Prompt engineering techniques](/best-practices/prompt-engineering).
- If you need safety-focused frameworks, see [Safety system messages](/best-practices/system-message).
- For a ready-made baseline, see [Safety system message templates](/guardrails/safety-system-message-templates).
