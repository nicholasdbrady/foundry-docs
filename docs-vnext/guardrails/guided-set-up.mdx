...
- An active agent in Microsoft Foundry. To create one, see [create a prompt agent quickstart](/agents/development/prompt-agent).
...
See [Monitor agents](/agents/development/how-to-monitor-agents-dashboard) to track agent performance and safety metrics after deploying guardrails.
