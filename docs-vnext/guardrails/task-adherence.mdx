...
<ZonePivot group="programming-language-foundry-portal__programming-language-rest" options={[{"id": "programming-language-rest", "title": "REST"}, {"id": "programming-language-foundry-portal", "title": "Foundry portal"}]} defaultValue="programming-language-rest" />

<ZoneContent group="programming-language-foundry-portal__programming-language-rest" value="programming-language-rest" options={[{"id": "programming-language-rest", "title": "REST"}, {"id": "programming-language-foundry-portal", "title": "Foundry portal"}]} values={["programming-language-rest", "programming-language-foundry-portal"]} defaultValue="programming-language-rest">
