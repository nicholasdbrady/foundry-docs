...
<Card title="Azure AI Content Safety documentation" icon="arrow-right" href="/azure/ai-services/content-safety/" />
<Card title="Guardrails and controls overview" icon="arrow-right" href="guardrails-overview.md" />
