...
For more information on how Task Adherence works, see the [Task Adherence concepts page](/guardrails/task-adherence).
...
## Set up and use Task Adherence in the Foundry portal
