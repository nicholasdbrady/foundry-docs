---
title: "How to Use Task Adherence for Agentic Workflows"
...
|------|----------|-------------|------|
| Endpoint | Yes | The base URL for the Content Safety API. Replace `<YOUR-ENDPOINT>` with the endpoint provided for your Azure service. | String |
| API Version | Yes | The version of the API to use. For this feature, the version is `2024-12-15-preview`. Example: `<YOUR-ENDPOINT>/contentsafety/agent:analyzeTaskAdherence?api-version=2024-12-15-preview` | String |
...
- [Task Adherence concepts](/guardrails/task-adherence)
