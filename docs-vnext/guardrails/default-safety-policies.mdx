...
Azure OpenAI in Microsoft Foundry Models includes default safety policies applied to all models (excluding Whisper models). These configurations provide you with a responsible experience by default, including [content filtering models](https://learn.microsoft.com/azure/ai-foundry/openai/concepts/content-filter), blocklists, prompt transformation, [content credentials](https://learn.microsoft.com/azure/ai-foundry/openai/concepts/content-credentials), and other features.
...
All safety policies are configurable. To learn more about configurability, see [configuring Guardrails](https://learn.microsoft.com/azure/ai-foundry/openai/how-to/content-filters).
...
- [Prompt transformation for image generation](/foundry-models/prompt-transformation)
