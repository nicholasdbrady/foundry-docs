...
| ![Foundry icon](/images/ai-services/ai-foundry.svg) [Azure Model Inference](https://learn.microsoft.com/en-us/azure/ai-foundry/model-inference/index.yml) | Performs model inference for flagship models in the Foundry model catalog. |
| ![Azure OpenAI in Foundry Models icon](/images/ai-services/azure-openai.svg) [Azure OpenAI](https://learn.microsoft.com/en-us/azure/ai-foundry/openai/index.yml) | Perform a wide variety of natural language tasks. | 
