...
| Build | [Agents](/agents/development/overview) (core) | GA |
| Build | Agents — Voice Live | Preview |
| Build | Agents — traces in agent builder | Preview |
| Build | [Workflows](/agents/development/overview) | Preview |
| Build | [Models](/foundry-models/foundry-models-overview) | GA |
| Build | [Tracing](/observability/trace-data) (including Trace Replay) | Partial GA (GA for prompt agents; Preview for hosted, workflow and external agents) |
...
| Build | [Knowledge (Foundry IQ)](/agents/development/overview) | Partial GA (API-level GA; portal access remains Preview) |
| Build | Data (core) | GA |
...
- Migrating assistants or AOAI workflows without a documented fallback path in Foundry (classic) portal. See [Migrate to the new Foundry Agent Service](/setup/migrate).
