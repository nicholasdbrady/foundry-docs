...
* Use the following tabs to select the method you want to use to create a Foundry project:
    ...
    - Complete these steps to start your Python script:
        ...
        1. Start your script with the following code to create the `client` connection and variables used throughout this article. This example creates the project in East US:
            ...
            # Create it if needed: az group create --name your-resource-group-name --location eastus
            ...
            # </create_resource_project>
            # Assign the "Azure AI Project Manager" role to allow users to manage projects.
            # Use the Azure portal or: az role assignment create --role "Azure AI Project Manager" \
            #   --assignee YOUR_USER_EMAIL --scope /subscriptions/YOUR_SUBSCRIPTION_ID/resourceGroups/YOUR_RESOURCE_GROUP/providers/Microsoft.CognitiveServices/accounts/YOUR_FOUNDRY_RESOURCE
...
Especially for getting started, create a new resource group for your project. The resource group makes it easy to manage the project and all its resources together.
  ...
  <Tab title="Python SDK">
    ...
    Using the `client` connection and variables from the [Prerequisites](#prerequisites), create the Foundry resource and default project:
...
<Frame>
  <img src="/images/projects-multi-setup.png" alt="Diagram shows how a team could share resource access with multiple projects on a Foundry resource." />
</Frame>
...
* To add a project to a Foundry resource:
    ...
    */}
    ...
    Using the `client` and variables from the [Prerequisites](#prerequisites), add this code to create a new project on your existing resource:
...
<Tabs>
  ...
  <Tab title="Python SDK">
    ...
    Using the `client` and variables from the [Prerequisites](#prerequisites):
