...
* Foundry model and feature availability [differs by region](/operate/region-support). For example, Agent service is [available](/agents/development/limits-quotas-regions) in select regions compared to Azure OpenAI service.
...
* [Choose an Azure resource type for AI foundry](https://learn.microsoft.com/en-us/azure/foundry-classic/concepts/resource-types)
