...
Create your project in the **West US 3** region if you want to try an [instant model (preview)](/foundry-models/instant-models).
...
<Frame>
<img src="/images/initial-foundry.png" alt="Screenshot of the Foundry portal showing the project selection dropdown with the Create new project option highlighted." />
</Frame>

        * If you already have a project loaded, select its name in the upper-left corner, and then select **Create new project**.

<Frame>
<img src="/images/create-from-project.png" alt="Screenshot of Foundry portal showing the Create a new project dropdown selected and project creation form fields visible." />
</Frame>
...
You can skip this step altogether if you want to try an [instant model (preview)](/foundry-models/instant-models).
...
<Card title="Microsoft Foundry quickstart" icon="arrow-right" href="/get-started/get-started-code" />
