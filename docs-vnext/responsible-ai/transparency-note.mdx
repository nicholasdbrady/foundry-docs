...
Agent samples have specific intended uses that are configurable by developers to carefully build upon, implement, and deploy agents. See the [agent manifests](https://learn.microsoft.com/azure/ai-foundry/agents/concepts/agent-catalog).
