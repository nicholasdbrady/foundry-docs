...
<Tip>
If you receive a permissions error when creating a policy, verify that you have the [Owner](https://learn.microsoft.com/azure/role-based-access-control/built-in-roles#owner) or [Resource Policy Contributor](https://learn.microsoft.com/azure/role-based-access-control/built-in-roles#resource-policy-contributor) role at the subscription or resource group level.
</Tip>
...
- [Manage compliance and security in Microsoft Foundry](/manage/how-to-manage-compliance-security)
- [What is Microsoft Foundry Control Plane?](/manage/overview)
- [Enforce token limits for models](/manage/how-to-enforce-limits-models)
