...
- A Foundry project. For more information, see [Create a project](/setup/create-projects).
...
- [Continuously evaluate your AI agents (preview)](/agent-service/how-to-monitor-agents-dashboard#set-up-continuous-evaluation): Monitor agent performance, quality, and risk dimensions automatically.
