...
|---|---|---|
| View | [Foundry User]<br />(**Reader** isn't sufficient) | [Reader](https://learn.microsoft.com/azure/role-based-access-control/built-in-roles/general#reader) |
