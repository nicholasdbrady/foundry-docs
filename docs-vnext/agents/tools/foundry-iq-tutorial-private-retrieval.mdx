...
- Completion of [Set up private inbound connectivity](/agents/tools/foundry-iq-tutorial-private-inbound) and [Set up private outbound connectivity](/agents/tools/foundry-iq-tutorial-private-outbound).
