...
For guidance on optimizing tool usage, see [Best practices for using tools in Microsoft Foundry Agent Service](/agents/tools/tool-best-practice).
...
The .NET and Java SDKs are currently in preview. For more information, see the [quickstart](/get-started/get-started-code).
...
After you run a sample, verify the tool was called by using tracing in Microsoft Foundry. For guidance on validating tool invocation, see [Best practices for using tools in Microsoft Foundry Agent Service](/agents/tools/tool-best-practice). If you use streaming, you can also look for `browser_automation_preview_call` events.
...
- Use tracing in Microsoft Foundry to confirm whether a tool call occurred. For guidance, see [Best practices for using tools in Microsoft Foundry Agent Service](/agents/tools/tool-best-practice).
...
- [Computer use tool for agents](/agents/tools/computer-use)
