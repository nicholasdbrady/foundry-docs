...
agent = client.agents.create_version(
    ...
    definition=PromptAgentDefinition(
        ...
        tools=[FileSearchTool(vector_store_ids=["YOUR_VECTOR_STORE_ID"])],
    ),
)
```
...
| -------- | ---------------- |
| Search existing Azure AI Search indexes | [Azure AI Search tool](/agents/tools/ai-search) |
| Search the public web for current information | [Web search tool](/agents/tools/web-search) |
...
For background concepts and lifecycle guidance (readiness, deletion behavior, and expiration policies), see [Vector stores for file search](/agents/tools/vector-stores).
...
- Features and availability vary by region. See [Azure AI Foundry region support](/operate/region-support).
...
- [Azure AI Search tool](/agents/tools/ai-search) - Search existing Azure AI Search indexes from your agents
- [Web search tool](/agents/tools/web-search) - Enable agents to search the public web
- [Vector stores for file search](/agents/tools/vector-stores) - Understand vector store lifecycle and expiration
