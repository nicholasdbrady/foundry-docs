...
If you use tracing in Microsoft Foundry, confirm the tool invocation occurred. For guidance on validating tool invocation and controlling tool usage, see [Best practices for using tools in Microsoft Foundry Agent Service](/agents/tools/tool-best-practice).
...
- [Connect OpenAPI tools to Microsoft Foundry agents](/agents/tools/openapi)
