...
* **Intent classification**: Conversational Language Understanding (CLU) analyzes user utterances to identify intents and extract entities.

* **Response delivery**: Custom Question Answering (CQA) provides responses drawn from curated knowledge sources.

* **Knowledge management**: You can manage your intent definitions in CLU projects and manage pairs of question-answers in CQA projects.
...
* **Agent Service integration**: The agent integrates Agent Service with Custom Question Answering capabilities within Azure Language services.

* **No-code deployment**: Organizations can deploy and configure the agent through the Foundry visual interface without writing custom code.
