...
To run this code, you need the latest prerelease package. See the [quickstart](/get-started/get-started-code#install-and-authenticate) for details.
...
The following table lists some of the differences between the computer use tool and [browser automation](/agents/tools/browser-automation) tool.
...
To use the computer use tool, you need a [computer use model](/models/catalog/models-sold-directly-by-azure#computer-use-preview) deployment. The computer use model is available in the following regions:
...
- [Tool best practices for agents](/agents/tools/tool-best-practice)
- [Browser automation tool](/agents/tools/browser-automation)
