...
- The latest prerelease package. See the [quickstart](/get-started/get-started-code#install-and-authenticate) for details.
...
| Tool not available for deployment | Regional or model limitations | Confirm web search is available in your region and with your model deployment. Check [tool best practices](/agents/tools/tool-best-practice). |
