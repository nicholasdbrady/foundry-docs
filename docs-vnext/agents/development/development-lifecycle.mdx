...
1. **Monitor and iterate**: Monitor performance and quality in production, then update and republish as needed. For guidance, see [Monitor agents](/agents/development/how-to-monitor-agents-dashboard).
...
- For a code-first workflow you can automate, see [Evaluate your AI agents](/agents/development/trace-agent-concept).
...
For guidance, see [Trace agents](/agents/development/trace-agent-concept).
...
- [Monitor agents](/agents/development/how-to-monitor-agents-dashboard)
