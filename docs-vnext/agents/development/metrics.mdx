...
To learn about Foundry hubs and projects, see [What is Microsoft Foundry?](/overview/what-is-foundry) and [Migrate from hub-based to Foundry projects](../../../foundry-classic/how-to/migrate-project.md).
</Info>
