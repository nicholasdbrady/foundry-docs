...
- [Invoke your Agent Application using the Responses API protocol](/agents/development/publish-responses)
- [Publish agents to Microsoft 365 Copilot and Microsoft Teams](/agents/development/publish-copilot) 

If you specifically want to build and publish an agent as a digital worker in Agent 365, see [Publish an agent as a digital worker in Agent 365](/agents/development/agent-365).
...
- A [Foundry project](/setup/create-projects) with at least one agent version created
- [Azure AI Project Manager role](/security/rbac-foundry) on the Foundry project scope to publish agents
- [Azure AI User role](/security/rbac-foundry) on the Agent Application scope to chat with a published agent using the Responses API protocol
...
- Familiarity with [Agent identity concepts in Foundry](/agents/development/agent-identity)
- Install the required language runtimes, global tools, and Visual Studio Code extensions as described in [Prepare your development environment](/developer-experience/install-cli-sdk)
...
<Frame>
  <img src="/images/azure-agent-identity-overview.png" alt="Diagram illustrating how Foundry projects organize agent versions, applications, and deployments, highlighting governance and RBAC roles." />
</Frame>
...
<Frame>
  <img src="/images/agent-application-routing-diagram.png" alt="Diagram of an Agent Application routing traffic to a deployment running a specific agent version, showing a stable entry point and traffic flow." />
</Frame>
...
For a full property reference and an infrastructure-as-code (Bicep) example for Agent deployments, see the Azure Resource Manager template reference for [Microsoft.CognitiveServices/accounts/projects/applications/agentDeployments](https://learn.microsoft.com/azure/templates/microsoft.cognitiveservices/accounts/projects/applications/agentdeployments).
...
To use your Agent Application with the Responses API protocol, see [Invoke your Agent Application using the Responses API protocol](/agents/development/publish-responses)

To use your Agent Application in Microsoft 365 Copilot and Teams, see [Publish agents to Microsoft 365 Copilot and Microsoft Teams](/agents/development/publish-copilot).

To publish your agent as a digital worker, see [Publish an agent as a digital worker in Agent 365](/agents/development/agent-365)
...
- Learn about [Agent identity concepts in Foundry](/agents/development/agent-identity)
- Learn about [Hosted agents](/agents/development/hosted-agents)
- Learn how to [publish agents to Microsoft 365 Copilot and Microsoft Teams](/agents/development/publish-copilot)

## Next steps

<Card title="Manage agents at scale" icon="arrow-right" href="../../control-plane/how-to-manage-agents.md" />
<Card title="Prepare your development environment" icon="arrow-right" href="../../how-to/develop/install-cli-sdk.md" />
<Card title="Get started with the SDK" icon="arrow-right" href="../../quickstarts/get-started-code.md" />
