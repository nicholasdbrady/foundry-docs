...
- For remote checks, an azd environment that resolves to a Foundry project endpoint. For context resolution, see [Understand azd project context](/developer-experience/cli-project-context).
...
- [Run a hosted agent locally with the Azure Developer CLI](/agent-service/run-hosted-agent-locally) to validate local startup.
- [Understand azd project context](/developer-experience/cli-project-context) for endpoint resolution used by remote checks.
