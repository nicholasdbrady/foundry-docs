...
If you use the Foundry SDK, you need to perform these steps independently. For more information, see [Enable tracing in your project](/agents/development/trace-agent-concept).
...
For more information about evaluating agents, see [Evaluate your AI agents](/agents/development/trace-agent-concept) and [Agent evaluators](/observability/agent-evaluators).
