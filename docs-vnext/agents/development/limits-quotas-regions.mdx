...
- Try a different region that supports the model and version. See the [model and region support table](/agents/development/limits-quotas-regions).
...
To view or request more model quota, see [Manage and increase quotas for resources with Microsoft Foundry (Foundry projects)](https://learn.microsoft.com/en-us/azure/foundry-classic/openai/how-to/quota).

## Request a limit increase

The limits in this article are default values for Foundry Agent Service. If your workload requires higher limits:

- **Model quotas.** You can request increases for model deployment quotas. See [Manage and increase quotas for resources with Microsoft Foundry](https://learn.microsoft.com/en-us/azure/foundry-classic/openai/how-to/quota).
...
- [Azure OpenAI quotas and limits](/setup/quotas-limits)
- [Manage and increase quotas for resources with Microsoft Foundry](https://learn.microsoft.com/en-us/azure/foundry-classic/openai/how-to/quota)
