...
- Set up tracing for a deployed agent that emits traces. Foundry agents emit traces automatically, and OpenTelemetry-instrumented third-party agents are also supported. For setup steps, see [Set up tracing for your agent](/agent-service/trace-agent-setup).
...
- [Agent tracing in Microsoft Foundry](/agent-service/trace-agent-concept)
