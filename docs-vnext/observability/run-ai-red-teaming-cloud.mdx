...
1. **Create a connection**: Follow the instructions in [Configure project connections](../../../foundry-classic/foundry-models/how-to/configure-project-connection.md) to connect your Azure OpenAI or AI Services resource to your Foundry project.
