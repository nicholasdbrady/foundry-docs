...
- An Azure OpenAI model deployment that supports the Responses API. The `simple_qna` recipe uses this model to synthesize question-and-answer pairs.
...
For the full evaluation flow, including selecting evaluators and reviewing results, see [Run cloud evaluations](/observability/cloud-evaluation) and [Evaluate your agent](/observability/evaluate-agent).
...
- [Evaluate your agent](/observability/evaluate-agent)
