...
For the full evaluation flow, including selecting evaluators and reviewing results, see [Run cloud evaluations](/observability/cloud-evaluation) and [Evaluate your agent](/agent-service/evaluate-agent).
...
- [Evaluate your agent](/agent-service/evaluate-agent)
- [Run cloud evaluations](/observability/cloud-evaluation)
- [Set up tracing for your agent](/agent-service/trace-agent-setup)
