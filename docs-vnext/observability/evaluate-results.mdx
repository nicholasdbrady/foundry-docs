...
- An evaluation run.
    ...
    - To learn how to run evaluations from the SDK see, [Run evaluations from the SDK](/observability/cloud-evaluation) or [Evaluate your AI agents](/agent-service/evaluate-agent).
...
<Frame>
  <img src="/images/evaluation-runs-hover.png" alt="Screenshot of the evaluation details page showing evaluation runs hovered over token usage." />
</Frame>
