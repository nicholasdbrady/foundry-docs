...
For setup steps, see [Monitor agents in the dashboard](/agent-service/how-to-monitor-agents-dashboard).

## Related content

- [Run evaluations from the SDK](/observability/cloud-evaluation)
- [Monitor agents in the dashboard](/agent-service/how-to-monitor-agents-dashboard)
- [Set up tracing](/agent-service/trace-agent-setup)
