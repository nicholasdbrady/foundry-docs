...
For guidance on implementing tracing, see [Trace agent overview](/agent-service/trace-agent-concept).
...
| What data should you use? | Upload or generate relevant dataset | [Select data source](/observability/evaluate-generative-ai-app#step-3-select-data-source) |
