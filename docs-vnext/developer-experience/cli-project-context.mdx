...
- The [Azure Developer CLI Foundry extensions](/developer-experience/install-cli-foundry-extensions) installed.
...
```bash
azd ai project set https://YOUR_PROJECT.services.ai.azure.com/api/projects/YOUR_PROJECT
```
...
```bash
azd ai project set https://YOUR_PROJECT.services.ai.azure.com/api/projects/YOUR_PROJECT --no-prompt
```
...
- [Install the Azure Developer CLI Foundry extensions](/developer-experience/install-cli-foundry-extensions)
- [Initialize a hosted agent project with the Azure Developer CLI](/agents/development/init-agent-project)
