...
Set the following environment variables for the tutorial:
...
to view traces. See [View traces in Foundry Control Plane](/developer-experience/langchain-traces#view-traces-in-foundry-control-plane).
...
- [Set up tracing integrations for agent frameworks](/agent-service/trace-agent-framework)
- [Foundry Agent Service quickstart](/agent-service/quickstart-hosted-agent)
