...
<Tabs>
  <Tab title="VS Code">
    ...
    The [Foundry Toolkit extension for VS Code](https://aka.ms/foundrytk) comes with the Foundry Skill. To install the extension, see [Work with the Microsoft Foundry for Visual Studio Code extension](/developer-experience/get-started-projects-vs-code).
    ...
    and [Get started with Foundry MCP Server](/developer-experience/get-started).
