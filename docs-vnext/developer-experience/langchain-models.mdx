...
<Card title="Use Foundry Content Safety with LangGraph" icon="arrow-right" href="/developer-experience/langchain-middleware" />
## Related content

- [Foundry models overview](/foundry-models/foundry-models-overview)
