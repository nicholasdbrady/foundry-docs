...
which uses Azure AI Inference SDK (legacy). [Learn more](https://learn.microsoft.com/en-us/azure/foundry-classic/how-to/develop/langchain).
</Info>
...
<Card title="Use Foundry Content Safety with LangGraph" icon="arrow-right" href="langchain-middleware.md" />
## Related content

- [Foundry models overview](https://learn.microsoft.com/azure/ai-foundry/foundry-models/overview)
- [Microsoft Foundry SDK overview](/api-sdk/sdk-overview)
- [Use LangChain with memory in Foundry](/developer-experience/langchain-memory)
- [Use LangChain with Foundry Agent Service](/developer-experience/langchain-agents)
