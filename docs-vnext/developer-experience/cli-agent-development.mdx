...
| ----- | ----------- | ------------------- |
| Install | Install `azd` and the Foundry extensions. | [Set up your developer environment](/developer-experience/install-cli-sdk) |
...
| Evaluate | Measure agent quality and improve the prompt. | [Run agent evaluations with the azd CLI](/observability/azure-developer-cli-evaluation) |
...
For details, see [Run agent evaluations with the azd CLI](/observability/azure-developer-cli-evaluation) and [Optimize agent prompts](/agents/prompt-optimizer).
