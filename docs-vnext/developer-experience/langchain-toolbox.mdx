...
os.environ["FOUNDRY_PROJECT_ENDPOINT"] = (
    "https://YOUR_RESOURCE.services.ai.azure.com/api/projects/YOUR_PROJECT"
)

# Name of the toolbox configured in your Foundry project
os.environ["FOUNDRY_AGENT_TOOLBOX_NAME"] = "YOUR_TOOLBOX_NAME"
```
...
about human-in-the-loop approvals, see [Use Foundry Agent Service with LangGraph](/developer-experience/langchain-agents).
...
<Frame>
  <img src="/images/toolbox-oauth.png" alt="Screenshot of how to configure an MCP server with an on-behalf-of workflow." />
</Frame>
