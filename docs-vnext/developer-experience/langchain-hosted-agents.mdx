...
[hosted agents](/agent-service/overview#hosted-agents-preview). The hosting
...
For background on protocol behavior and sessions, see [Hosted agents](/agent-service/hosted-agents) and [Manage Hosted agent sessions](/agent-service/manage-hosted-sessions).
...
project. For details, see [Deploy a Hosted agent](/agent-service/deploy-hosted-agent#required-permissions).
...
[Deploy a Hosted agent](/agent-service/deploy-hosted-agent) and
[Manage Hosted agent lifecycle](/agent-service/manage-hosted-agent).

### Deploy with Foundry Toolkit Visual Studio Code extension

For extension-based deployment, see [Quickstart: Deploy your first hosted agent](/agent-service/quickstart-hosted-agent).
...
<Card title="Deploy a Hosted agent" icon="arrow-right" href="/agents/development/deploy-hosted-agent" />
## Related content
