...
- A [Foundry project](/get-started/get-started-code) with Contributor or higher role.
...
- [Azure CLI](https://learn.microsoft.com/cli/azure/install-azure-cli) (required only for the `az ad sp create` command).
...
For more information on role assignments, see [Role-based access control for Microsoft Foundry](/security/rbac-foundry).
...
<Frame>
<img src="/images/foundry-find-mcp-app.png" alt="Screenshot of MCP app in Entra ID." />
</Frame>
...
<Frame>
<img src="/images/foundry-conditional-access.png" alt="Screenshot of conditional access options for the app configuration." />
</Frame>

<Frame>
<img src="/images/foundry-new-access-policy.png" alt="Screenshot of creating a new conditional access policy for the app." />
</Frame>

1. Select **Grant**, then choose **Block access**.

<Frame>
<img src="/images/foundry-block-access.png" alt="A screenshot showing how to block app access." />
</Frame>
...
If your Foundry resources use Azure Private Links, the hosted Foundry MCP Server can't reach them through the public endpoint. Disable Private Link, use SDKs/REST APIs, or use a [custom MCP server with private networking](/agent-service/model-context-protocol#public-and-private-mcp-server-endpoints) through Foundry Agent Service.
...
- Review [available tools and example prompts](/developer-experience/available-tools) for Foundry MCP Server
