...
- A [Microsoft Foundry project](/setup/create-projects) created in one of the [supported regions](https://learn.microsoft.com/en-us/azure/foundry-classic/how-to/deploy-models-serverless-availability#region-availability) for Claude models. Claude models are currently available in **East US 2** and **Sweden Central** only.
