...
- The **Foundry User** role on the Foundry project (least-privilege role for development). If you also create or manage resources, use **Contributor** or **Owner** as needed. For details, see [Role-based access control for Microsoft Foundry](/security/rbac-foundry).
...
| LangGraph hosting | `langchain_azure_ai.agents.hosting` | Host compiled LangGraph agents on Foundry Agent Service with Responses or Invocations protocols. [See detailed examples](/developer-experience/langchain-hosted-agents). |
...
- [Host LangGraph agents as Foundry hosted agents](/developer-experience/langchain-hosted-agents)
...
<Card title="Use Foundry Models with LangChain" icon="arrow-right" href="/developer-experience/langchain-agents" />
