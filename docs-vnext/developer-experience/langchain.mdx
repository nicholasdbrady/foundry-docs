...
| Chat history stores | `langchain_azure_ai.chat_message_histories` | Persist and replay chat history across sessions. Use memory-powered histories to retrieve consolidated past chat history. |
...
This snippet shows the same model initialized from a Foundry project endpoint or from a direct service endpoint, and shows how to swap credentials.
...
- [Trace LangChain and LangGraph apps with Foundry](/developer-experience/langchain-traces)
