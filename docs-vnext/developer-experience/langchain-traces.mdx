...
If you deployed your LangGraph or LangChain solution, you can register that deployment into [Foundry Control Plane](/manage/overview)
to gain visibility and governance.

[Register your application into Foundry Control Plane](/manage/register-custom-agent) to view traces in the Foundry portal. 
...
2. Ensure that you have [observability configured in the project](/manage/monitoring-across-fleet).
